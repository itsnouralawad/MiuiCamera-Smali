...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lsb/j;->h:Ljava/util/concurrent/atomic/AtomicInteger;

    const/16 v0, 0x10

    iput v0, p0, Lsb/j;->i:I

    iput-boolean v1, p0, Lsb/j;->k:Z

    iput-boolean v1, p0, Lsb/j;->l:Z

    const/4 v0, 0x1

    iput-boolean v0, p0, Lsb/j;->m:Z

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v0, p0, Lsb/j;->o:Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-static {}, Lio/reactivex/subjects/PublishSubject;->create()Lio/reactivex/subjects/PublishSubject;

    move-result-object v0

    iput-object v0, p0, Lsb/j;->f:Lio/reactivex/subjects/PublishSubject;
    ...
    iput-object v1, p0, Lsb/j;->g:Lcom/android/camera/handgesture/HandGesture;
    ...
    invoke-direct {v1, p0}, Lsb/h;-><init>(Lsb/j;)V
    ...
    invoke-direct {v1, p0}, Lsb/i;-><init>(Lsb/j;)V
...
.method public static synthetic l(Lsb/j;Lrb/c;)Ljava/lang/Integer;
    .locals 0

    invoke-direct {p0, p1}, Lsb/j;->s(Lrb/c;)Ljava/lang/Integer;
...
.method public static synthetic m(Lsb/j;Ljava/lang/Integer;)V
    .locals 0

    invoke-direct {p0, p1}, Lsb/j;->t(Ljava/lang/Integer;)V
...
.method public static n(Landroid/content/Context;)V
    ...
    invoke-static {}, Lsb/j;->r()Ljava/lang/String;

    move-result-object v0

    const-string v1, "hand_gesture_model"

    invoke-static {p0, v1, v0}, Lcom/android/camera/z5;->Z4(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p0, v1, v0}, Lcom/android/camera/z5;->R(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
...
.method private synthetic s(Lrb/c;)Ljava/lang/Integer;
    .locals 5
    ...
    :cond_0
    :try_start_1
    iget-object p1, p0, Lsb/j;->o:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object p0, p0, Lsb/j;->g:Lcom/android/camera/handgesture/HandGesture;
    ...
    :cond_1
    iget-object v0, p0, Lsb/j;->o:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {p0, p1}, Lsb/j;->o(Lrb/c;)I
...
.method private synthetic t(Ljava/lang/Integer;)V
    ...
    iget-object p1, p0, Lsb/j;->h:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {p1, v1}, Ljava/util/concurrent/atomic/AtomicInteger;->set(I)V

    :goto_0
    iget-boolean p1, p0, Lsb/j;->k:Z
    ...
    iget-object v2, p0, Lsb/j;->h:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    check-cast v4, Lv8/l2;

    invoke-interface {v4}, Lv8/l2;->k0()Z
    ...
    check-cast v2, Lv8/l2;

    invoke-interface {v2}, Lv8/l2;->y3()Z
    ...
    invoke-interface {p1, v2}, Lv8/p;->B(I)Z

    iput-boolean v0, p0, Lsb/j;->k:Z
    ...
    iget-boolean v2, p0, Lsb/j;->k:Z

    xor-int/2addr v2, v0

    invoke-virtual {p1, v2}, Lm2/f1;->r1(Z)V

    iput-boolean v1, p0, Lsb/j;->m:Z

    const/16 p1, 0x10

    iput p1, p0, Lsb/j;->i:I

    :cond_4
    :goto_1
    iget-boolean p1, p0, Lsb/j;->m:Z

    if-nez p1, :cond_6

    iget p1, p0, Lsb/j;->i:I
    ...
    invoke-virtual {p1, v0}, Lm2/f1;->r1(Z)V
    ...
    invoke-interface {p1, v0}, Lv8/w2;->reInitAlert(Z)V
...
.method public c(I)V
    ...
    invoke-virtual {p0}, Lsb/j;->u()V

    invoke-static {}, Lcom/android/camera/CameraAppImpl;->o()Landroid/content/Context;

    move-result-object v0

    invoke-static {v0}, Lsb/j;->n(Landroid/content/Context;)V

    iput p1, p0, Lsb/j;->j:I

    invoke-static {p1}, Lcom/android/camera/z5;->O1(I)I

    move-result p1

    iput p1, p0, Lsb/j;->n:I
    ...
    invoke-virtual {p0, p1}, Lm2/f1;->r1(Z)V
...
.method public h(Lrb/c;)V
    ...
    iget-object p0, p0, Lsb/j;->f:Lio/reactivex/subjects/PublishSubject;
...
.method public i()V
    ...
    iget-object v1, p0, Lsb/j;->f:Lio/reactivex/subjects/PublishSubject;

    new-instance v3, Lrb/c;

    const/4 v4, 0x3

    iget v5, p0, Lsb/j;->j:I

    invoke-direct {v3, v4, v5}, Lrb/c;-><init>(II)V
...
.method public j()V
    ...
    iget-object v0, p0, Lsb/j;->f:Lio/reactivex/subjects/PublishSubject;

    new-instance v1, Lrb/c;

    const/4 v2, 0x1

    iget p0, p0, Lsb/j;->j:I

    invoke-direct {v1, v2, p0}, Lrb/c;-><init>(II)V
...
.method public o(Lrb/c;)I
    .locals 5

    invoke-virtual {p1}, Lrb/c;->f()I
    ...
    iget-object v0, p0, Lsb/j;->g:Lcom/android/camera/handgesture/HandGesture;
    ...
    sget-boolean v1, Lsb/j;->q:Z

    if-eqz v1, :cond_1

    invoke-virtual {p0, p1, v0}, Lsb/j;->p(Lrb/c;I)V

    :cond_1
    return v0
.end method

.method public final p(Lrb/c;I)V
    .locals 11
    ...
    invoke-static {v8}, Ly7/j6;->E(Ljava/lang/String;)Z
...
.method public u()V
    ...
    iget-object v1, p0, Lrb/a;->a:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v1, p0, Lsb/j;->h:Ljava/util/concurrent/atomic/AtomicInteger;
