...
.field public static final o:Ljava/lang/String; = "OCRDecoder"
...
.field public volatile i:Landroid/graphics/Point;

.field public volatile j:Landroid/util/Size;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lsb/w;->f:Lnb/e;
...
.method private synthetic C(Lio/reactivex/FlowableEmitter;)V
    .locals 0
    ...
    iput-object p1, p0, Lsb/w;->g:Lio/reactivex/FlowableEmitter;

    return-void
.end method

.method public static synthetic D(Lcom/xiaomi/ocr/sdk_ocr/OCRData$FocusPoint;)Ljava/util/Optional;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method public static synthetic E(Lcom/xiaomi/ocr/sdk_ocr/OCRData$Location;La9/b;)V
    .locals 0

    invoke-interface {p1, p0}, La9/b;->Ba(Lcom/xiaomi/ocr/sdk_ocr/OCRData$Location;)V

    return-void
.end method

.method private synthetic F(Ljava/util/Optional;)V
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    invoke-direct {v2, p1}, Lsb/k;-><init>(Lcom/xiaomi/ocr/sdk_ocr/OCRData$Location;)V

    invoke-virtual {v0, v2}, Ljava/util/Optional;->ifPresent(Ljava/util/function/Consumer;)V

    iput-boolean v1, p0, Lsb/w;->m:Z
...
.method public static synthetic H(Lcom/xiaomi/ocr/sdk_ocr/OCRData$RegionData;JLcom/xiaomi/ocr/sdk_ocr/OCRData$OCRResult;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    invoke-direct {v1, p0, p3, p1, p2}, Lsb/v;-><init>(Lcom/xiaomi/ocr/sdk_ocr/OCRData$RegionData;Lcom/xiaomi/ocr/sdk_ocr/OCRData$OCRResult;J)V
...
.method public static synthetic I(Lcom/xiaomi/ocr/sdk_ocr/OCRData$RegionData;)Lcom/xiaomi/ocr/sdk_ocr/OCRData$OCRResult;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method public static synthetic J(Lcom/xiaomi/ocr/sdk_ocr/OCRData$OCRResult;)Z
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method public static synthetic K(Lcom/xiaomi/ocr/sdk_ocr/OCRData$RegionData;JLa9/a;)V
    .locals 1

    const/4 v0, 0x0

    invoke-interface {p3, p0, v0, p1, p2}, La9/a;->n7(Lcom/xiaomi/ocr/sdk_ocr/OCRData$RegionData;Lcom/xiaomi/ocr/sdk_ocr/OCRData$OCRResult;J)V

    return-void
.end method

.method public static synthetic L(Lcom/xiaomi/ocr/sdk_ocr/OCRData$RegionData;J)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    invoke-direct {v1, p0, p1, p2}, Lsb/m;-><init>(Lcom/xiaomi/ocr/sdk_ocr/OCRData$RegionData;J)V
...
.method public static synthetic M(Lcom/xiaomi/ocr/sdk_ocr/OCRData$RegionData;Lcom/xiaomi/ocr/sdk_ocr/OCRData$OCRResult;JLa9/a;)V
    .locals 0

    invoke-interface {p4, p0, p1, p2, p3}, La9/a;->n7(Lcom/xiaomi/ocr/sdk_ocr/OCRData$RegionData;Lcom/xiaomi/ocr/sdk_ocr/OCRData$OCRResult;J)V
...
.method private synthetic N()V
    ...
    const-string p0, "startDecodeWithDelay: init OCR engine failed!"
    ...
    :cond_1
    invoke-virtual {p0}, Lsb/w;->O()Lio/reactivex/disposables/Disposable;

    iput-boolean v0, p0, Lrb/a;->b:Z

    const-string p0, "startDecodeWithDelay: real decode started"
...
.method public static synthetic l()V
    ...
    invoke-static {}, Lsb/w;->G()V

    return-void
.end method

.method public static synthetic m(Lcom/xiaomi/ocr/sdk_ocr/OCRData$OCRResult;)Z
    .locals 0

    invoke-static {p0}, Lsb/w;->J(Lcom/xiaomi/ocr/sdk_ocr/OCRData$OCRResult;)Z
...
.method public static synthetic n(Lcom/xiaomi/ocr/sdk_ocr/OCRData$RegionData;)Lcom/xiaomi/ocr/sdk_ocr/OCRData$OCRResult;
    .locals 0

    invoke-static {p0}, Lsb/w;->I(Lcom/xiaomi/ocr/sdk_ocr/OCRData$RegionData;)Lcom/xiaomi/ocr/sdk_ocr/OCRData$OCRResult;
...
.method public static synthetic o(Lcom/xiaomi/ocr/sdk_ocr/OCRData$RegionData;JLa9/a;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lsb/w;->K(Lcom/xiaomi/ocr/sdk_ocr/OCRData$RegionData;JLa9/a;)V
...
.method public static synthetic p(Lcom/xiaomi/ocr/sdk_ocr/OCRData$FocusPoint;)Ljava/util/Optional;
    ...
    invoke-static {p0}, Lsb/w;->D(Lcom/xiaomi/ocr/sdk_ocr/OCRData$FocusPoint;)Ljava/util/Optional;
...
.method public static synthetic q(Lsb/w;)V
    .locals 0

    invoke-direct {p0}, Lsb/w;->N()V

    return-void
.end method

.method public static synthetic r(Lcom/xiaomi/ocr/sdk_ocr/OCRData$RegionData;J)V
    .locals 0

    invoke-static {p0, p1, p2}, Lsb/w;->L(Lcom/xiaomi/ocr/sdk_ocr/OCRData$RegionData;J)V

    return-void
.end method

.method public static synthetic s(Lsb/w;Lio/reactivex/FlowableEmitter;)V
    .locals 0

    invoke-direct {p0, p1}, Lsb/w;->C(Lio/reactivex/FlowableEmitter;)V

    return-void
.end method

.method public static synthetic t(Lsb/w;Ljava/util/Optional;)V
    .locals 0

    invoke-direct {p0, p1}, Lsb/w;->F(Ljava/util/Optional;)V

    return-void
.end method

.method public static synthetic u(Lcom/xiaomi/ocr/sdk_ocr/OCRData$Location;La9/b;)V
    .locals 0

    invoke-static {p0, p1}, Lsb/w;->E(Lcom/xiaomi/ocr/sdk_ocr/OCRData$Location;La9/b;)V

    return-void
.end method

.method public static synthetic v(Lcom/xiaomi/ocr/sdk_ocr/OCRData$RegionData;JLcom/xiaomi/ocr/sdk_ocr/OCRData$OCRResult;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lsb/w;->H(Lcom/xiaomi/ocr/sdk_ocr/OCRData$RegionData;JLcom/xiaomi/ocr/sdk_ocr/OCRData$OCRResult;)V

    return-void
.end method

.method public static synthetic w(Lcom/xiaomi/ocr/sdk_ocr/OCRData$RegionData;Lcom/xiaomi/ocr/sdk_ocr/OCRData$OCRResult;JLa9/a;)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lsb/w;->M(Lcom/xiaomi/ocr/sdk_ocr/OCRData$RegionData;Lcom/xiaomi/ocr/sdk_ocr/OCRData$OCRResult;JLa9/a;)V
...
# virtual methods
.method public final A()Lcom/xiaomi/ocr/sdk_ocr/OCRData$FocusPoint;
    .locals 4
    ...
    iget-object p0, p0, Lsb/w;->i:Landroid/graphics/Point;
...
.method public B(I)Lcom/xiaomi/ocr/sdk_ocr/OCRData$RotateFlags;
    .locals 0
...
.method public final O()Lio/reactivex/disposables/Disposable;
    ...
    invoke-direct {v0, p0}, Lsb/n;-><init>(Lsb/w;)V
    ...
    invoke-direct {v1, p0}, Lsb/p;-><init>(Lsb/w;)V
...
.method public P(Lcom/xiaomi/ocr/sdk_ocr/OCRData$RegionData;J)Lio/reactivex/disposables/Disposable;
    .locals 1

    new-instance p0, Lsb/r;

    invoke-direct {p0, p1}, Lsb/r;-><init>(Lcom/xiaomi/ocr/sdk_ocr/OCRData$RegionData;)V
    ...
    invoke-direct {v0, p1, p2, p3}, Lsb/t;-><init>(Lcom/xiaomi/ocr/sdk_ocr/OCRData$RegionData;J)V
    ...
    invoke-direct {v0, p1, p2, p3}, Lsb/u;-><init>(Lcom/xiaomi/ocr/sdk_ocr/OCRData$RegionData;J)V
...
.method public Q(Landroid/graphics/Point;)V
    .locals 2

    iput-object p1, p0, Lsb/w;->i:Landroid/graphics/Point;
...
.method public R()V
    ...
    iget-object v0, p0, Lsb/w;->f:Lnb/e;
    ...
    invoke-direct {v2, p0}, Lsb/l;-><init>(Lsb/w;)V

    const-wide/16 v3, 0x3e8

    invoke-virtual {v0, v3, v4, v1, v2}, Lnb/e;->c(JLio/reactivex/Scheduler;Lio/reactivex/functions/Action;)V
...
.method public c(I)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Lsb/w;->B(I)Lcom/xiaomi/ocr/sdk_ocr/OCRData$RotateFlags;

    move-result-object p1

    iput-object p1, p0, Lsb/w;->h:Lcom/xiaomi/ocr/sdk_ocr/OCRData$RotateFlags;
...
.method public g(Landroid/media/Image;I)V
    ...
    iget-object v0, p0, Lsb/w;->g:Lio/reactivex/FlowableEmitter;
    ...
    sget-boolean v5, Lsb/w;->n:Z

    if-eqz v5, :cond_1

    new-instance v5, Lrb/c;

    invoke-direct {v5, p1, p2}, Lrb/c;-><init>(Landroid/media/Image;I)V

    invoke-virtual {v5}, Lrb/c;->c()[B
    ...
    invoke-static {p2, v5}, Lcom/android/camera/q3;->e([BLjava/lang/String;)V
    ...
    invoke-virtual {p0, v3, v4}, Lsb/w;->x(II)Landroid/graphics/Rect;
    ...
    iget-object v6, p0, Lsb/w;->h:Lcom/xiaomi/ocr/sdk_ocr/OCRData$RotateFlags;
    ...
    iget-object p1, p0, Lsb/w;->j:Landroid/util/Size;
    ...
    iput-object p1, p0, Lsb/w;->j:Landroid/util/Size;

    :cond_6
    invoke-virtual {p0}, Lsb/w;->A()Lcom/xiaomi/ocr/sdk_ocr/OCRData$FocusPoint;
...
.method public i()V
    ...
    iput-object v0, p0, Lsb/w;->g:Lio/reactivex/FlowableEmitter;

    :cond_0
    iget-boolean v0, p0, Lsb/w;->k:Z
...
.method public final x(II)Landroid/graphics/Rect;
    .locals 8

    invoke-static {}, Lul/i;->s()D
...
.method public y()Landroid/util/Size;
    ...
    iget-object p0, p0, Lsb/w;->j:Landroid/util/Size;
