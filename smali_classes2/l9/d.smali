...
.field public e:Lwe/w;

.field public f:Ll9/d$a;
...
# direct methods
.method public constructor <init>(Landroid/media/Image;Landroid/hardware/camera2/CaptureResult;Lwe/w;Ll9/d$a;Landroid/os/Handler;)V
    .locals 0
    ...
    iput-object p1, p0, Ll9/d;->c:Landroid/media/Image;

    iput-object p2, p0, Ll9/d;->d:Landroid/hardware/camera2/CaptureResult;

    iput-object p3, p0, Ll9/d;->e:Lwe/w;

    iput-object p4, p0, Ll9/d;->f:Ll9/d$a;

    iput-object p5, p0, Ll9/d;->g:Landroid/os/Handler;

    invoke-virtual {p3}, Lwe/w;->s()Lwe/x;
    ...
    :goto_0
    iget p1, p0, Ll9/d;->h:I

    iget p2, p0, Ll9/d;->i:I
...
.method public J()V
    ...
    iget-object v0, v14, Ll9/d;->e:Lwe/w;

    invoke-virtual {v0}, Lwe/w;->L()Ljava/lang/String;

    move-result-object v15

    invoke-static {v15}, Lcom/android/camera/z5;->d1(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v13

    iget-object v0, v14, Ll9/d;->e:Lwe/w;

    invoke-virtual {v0}, Lwe/w;->t()J
    ...
    iget-object v2, v14, Ll9/d;->d:Landroid/hardware/camera2/CaptureResult;

    iget v3, v14, Ll9/d;->h:I

    iget v4, v14, Ll9/d;->i:I
    ...
    invoke-virtual/range {v1 .. v8}, Ll9/d;->a(Landroid/hardware/camera2/CaptureResult;IIIJLandroid/location/Location;)[B
    ...
    invoke-virtual {v0, v15}, Lw2/c;->y(Ljava/lang/String;)Lu2/b;
    ...
    invoke-static {v13, v5}, Ll9/x;->m(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-virtual {v6}, Lu2/b;->g()Ljava/lang/Long;
    ...
    iget-object v4, v14, Ll9/b;->a:Landroid/content/Context;

    invoke-static {v4, v11, v15}, Ll9/x;->B(Landroid/content/Context;ZLjava/lang/String;)Landroid/net/Uri;
    ...
    invoke-static {v15}, Lm7/a;->y(Ljava/lang/String;)Z

    move-result v4

    iget-object v2, v14, Ll9/d;->c:Landroid/media/Image;

    iget v1, v14, Ll9/d;->h:I

    iget v11, v14, Ll9/d;->i:I
    ...
    invoke-virtual/range {v1 .. v13}, Ll9/d;->c(Landroid/media/Image;[BZLjava/lang/String;JILjava/lang/String;IILandroid/location/Location;I)Landroid/net/Uri;
    ...
    :try_start_0
    invoke-static {v0, v15}, Lcom/android/camera/g3;->j(Ljava/lang/String;Ljava/lang/String;)Z
    :try_end_0
    ...
    :goto_1
    iget-object v1, v13, Ll9/b;->a:Landroid/content/Context;

    iget v7, v13, Ll9/d;->h:I

    iget v8, v13, Ll9/d;->i:I
    ...
    invoke-static/range {v1 .. v8}, Ll9/x;->m0(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;Landroid/location/Location;III)Landroid/net/Uri;
    ...
    :goto_2
    iget-object v0, v13, Ll9/b;->a:Landroid/content/Context;

    move-object/from16 v6, v24

    invoke-static {v0, v6}, Lif/a;->k(Landroid/content/Context;Lu2/b;)V
    ...
    iget-object v2, v13, Ll9/d;->c:Landroid/media/Image;

    iget v0, v13, Ll9/d;->h:I

    iget v5, v13, Ll9/d;->i:I
    ...
    iget-object v0, v14, Ll9/b;->a:Landroid/content/Context;

    invoke-static {v0, v6, v15}, Lcom/android/camera/l5;->f(Landroid/content/Context;Landroid/net/Uri;Z)Lcom/android/camera/l5;

    move-result-object v0

    if-eqz v0, :cond_3

    iget-object v1, v14, Ll9/b;->b:Ll9/q;

    const/4 v2, 0x1

    invoke-interface {v1, v0, v2}, Ll9/q;->k(Lcom/android/camera/l5;Z)V

    goto :goto_4

    :cond_3
    iget-object v0, v14, Ll9/b;->b:Ll9/q;
    ...
    invoke-interface/range {v0 .. v5}, Ll9/q;->j(Landroid/net/Uri;ZLjava/lang/String;IZ)V
    ...
    invoke-static {v0, v1}, Lif/a;->k(Landroid/content/Context;Lu2/b;)V
...
.method public final a(Landroid/hardware/camera2/CaptureResult;IIIJLandroid/location/Location;)[B
    ...
    :try_start_0
    invoke-static/range {v1 .. v11}, Lcom/android/camera/f3;->d(IIIJLandroid/location/Location;Landroid/hardware/camera2/CaptureResult;JLkd/e;Z)V
    :try_end_0
    ...
    invoke-virtual {v0, v2}, Lkd/e;->v(Ljava/io/OutputStream;)Ljava/io/OutputStream;

    move-result-object v0

    instance-of v3, v0, Lkd/g;
...
.method public final b(Landroid/media/Image;Landroid/util/Size;)[B
    ...
    invoke-static {p1, p0}, Lcom/android/camera/z5;->W1(Landroid/media/Image;[I)[B
    ...
    invoke-static {v4, v1, v3}, Lul/g;->e(Landroid/media/Image$Plane;II)Ljava/nio/ByteBuffer;
    ...
    invoke-static {p0, v1, v3}, Lul/g;->e(Landroid/media/Image$Plane;II)Ljava/nio/ByteBuffer;
...
.method public final c(Landroid/media/Image;[BZLjava/lang/String;JILjava/lang/String;IILandroid/location/Location;I)Landroid/net/Uri;
    ...
    iget-object v5, v0, Ll9/d;->g:Landroid/os/Handler;
    ...
    invoke-virtual/range {v0 .. v8}, Ll9/d;->d(Landroid/media/Image;[BLjava/lang/String;Ljava/io/FileDescriptor;Landroid/os/Handler;III)Z
    ...
    iget-object v1, v0, Ll9/d;->e:Lwe/w;
    ...
    iget-object v6, v0, Ll9/d;->g:Landroid/os/Handler;
    ...
    invoke-virtual/range {v0 .. v9}, Ll9/d;->e(Landroid/media/Image;[BLjava/lang/String;Ljava/io/FileDescriptor;Landroid/util/Size;Landroid/os/Handler;III)Z

    move-result v0

    :goto_2
    invoke-static {v12}, Lip/g;->a(Ljava/io/Closeable;)V
...
.method public final d(Landroid/media/Image;[BLjava/lang/String;Ljava/io/FileDescriptor;Landroid/os/Handler;III)Z
    ...
    new-instance p3, Lmb/d$b;

    invoke-direct {p3, p4, p6, p7, v4}, Lmb/d$b;-><init>(Ljava/io/FileDescriptor;III)V

    goto :goto_0

    :cond_0
    new-instance p4, Lmb/d$b;

    invoke-direct {p4, p3, p6, p7, v4}, Lmb/d$b;-><init>(Ljava/lang/String;III)V

    move-object p3, p4

    :goto_0
    iget-object p4, p0, Ll9/d;->e:Lwe/w;

    invoke-virtual {p4}, Lwe/w;->s()Lwe/x;

    move-result-object p4

    invoke-virtual {p4}, Lwe/x;->i0()I

    move-result p4

    invoke-virtual {p3, p5}, Lmb/d$b;->e(Landroid/os/Handler;)Lmb/d$b;

    move-result-object p3

    invoke-virtual {p3, p8}, Lmb/d$b;->h(I)Lmb/d$b;

    move-result-object p3

    invoke-virtual {p3, p4}, Lmb/d$b;->i(I)Lmb/d$b;

    move-result-object p3

    invoke-virtual {p3}, Lmb/d$b;->a()Lmb/d;

    move-result-object p3

    invoke-virtual {p3}, Lmb/d;->i()Landroid/view/Surface;
    ...
    iput-object p4, p0, Ll9/d;->k:Landroid/media/ImageWriter;

    invoke-virtual {p3}, Lmb/d;->l()V
    ...
    iget-object p4, p0, Ll9/d;->k:Landroid/media/ImageWriter;
    ...
    invoke-virtual {p3, v3, p2, v3, p1}, Lmb/d;->b(I[BII)V
    ...
    invoke-virtual {p3, p4, p5}, Lmb/d;->m(J)V
    ...
    invoke-virtual {p3}, Lmb/d;->close()V
    ...
    :goto_2
    iget-object p2, p0, Ll9/d;->k:Landroid/media/ImageWriter;
    ...
    iput-object p2, p0, Ll9/d;->k:Landroid/media/ImageWriter;
...
.method public final e(Landroid/media/Image;[BLjava/lang/String;Ljava/io/FileDescriptor;Landroid/util/Size;Landroid/os/Handler;III)Z
    ...
    invoke-direct {p3, p4, p7, p8, v3}, Lmb/d$b;-><init>(Ljava/io/FileDescriptor;III)V
    ...
    invoke-direct {p4, p3, p7, p8, v3}, Lmb/d$b;-><init>(Ljava/lang/String;III)V
    ...
    invoke-virtual {p3, p6}, Lmb/d$b;->e(Landroid/os/Handler;)Lmb/d$b;

    move-result-object p3

    invoke-virtual {p3, p9}, Lmb/d$b;->h(I)Lmb/d$b;
    ...
    invoke-virtual {p0, p1, p5}, Ll9/d;->b(Landroid/media/Image;Landroid/util/Size;)[B
    ...
    invoke-virtual {p3, p1, p0}, Lmb/d;->c(I[B)V
    ...
    invoke-virtual {p3, v3, p2, v3, p4}, Lmb/d;->b(I[BII)V
...
.method public onFinish()V
    ...
    iget-object v0, p0, Ll9/d;->f:Ll9/d$a;

    iget-object v1, p0, Ll9/d;->c:Landroid/media/Image;

    iget-object v2, p0, Ll9/d;->e:Lwe/w;

    invoke-interface {v0, v1, v2}, Ll9/d$a;->a(Landroid/media/Image;Lwe/w;)V

    iget-object v0, p0, Ll9/d;->e:Lwe/w;
    ...
    iget-object v5, p0, Ll9/d;->e:Lwe/w;
    ...
    iget-object v1, p0, Ll9/d;->e:Lwe/w;
    ...
    invoke-virtual {v2, v3}, Lp8/m;->t([Ljava/lang/String;)V

    invoke-static {}, Lkd/d;->a()V

    const/4 v0, 0x0

    iput-object v0, p0, Ll9/d;->c:Landroid/media/Image;

    iput-object v0, p0, Ll9/d;->e:Lwe/w;

    iput-object v0, p0, Ll9/d;->f:Ll9/d$a;

    iput-object v0, p0, Ll9/d;->d:Landroid/hardware/camera2/CaptureResult;

    iput-object v0, p0, Ll9/d;->g:Landroid/os/Handler;

    iget-object v1, p0, Ll9/b;->b:Ll9/q;

    invoke-virtual {p0}, Ll9/d;->getSize()I

    move-result v2

    invoke-interface {v1, v2}, Ll9/q;->m(I)V

    iput-object v0, p0, Ll9/b;->b:Ll9/q;
...
.method public run()V
    ...
    invoke-virtual {p0}, Ll9/d;->J()V

    invoke-virtual {p0}, Ll9/d;->onFinish()V
