...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lo7/c;->a:Ljava/lang/String;
...
.method public static synthetic a(Lo7/d;)Z
    .locals 0

    invoke-static {p0}, Lo7/c;->p(Lo7/d;)Z
...
.method public static c(Lorg/xmlpull/v1/XmlPullParser;)Lo7/a;
    .locals 7
    ...
    invoke-virtual {v0, v4}, Lo7/a;->f(I)V
    ...
    invoke-virtual {v0, v4}, Lo7/a;->e(I)V
    ...
    invoke-virtual {v0, v4}, Lo7/a;->d(I)V
...
.method public static d(Ljava/lang/String;)Lo7/a;
    .locals 5
    ...
    :cond_0
    sget-object v0, Lo7/c;->a:Ljava/lang/String;
    ...
    :cond_5
    invoke-static {v0}, Lo7/c;->c(Lorg/xmlpull/v1/XmlPullParser;)Lo7/a;
...
.method public static e(Ld/g;)Lo7/a;
    .locals 2
    ...
    invoke-interface {p0, v0, v1}, Ld/g;->b0(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p0

    invoke-static {p0}, Lo7/c;->d(Ljava/lang/String;)Lo7/a;
...
.method public static g(Landroid/content/Context;Landroid/net/Uri;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, p1}, Lo7/c;->o(Landroid/content/Context;Landroid/net/Uri;)[B

    move-result-object v4

    if-nez v4, :cond_0

    sget-object p0, Lo7/c;->a:Ljava/lang/String;
    ...
    :cond_0
    invoke-static {v4}, Ld/h;->g([B)Ld/g;

    move-result-object v4

    if-eqz v4, :cond_1

    invoke-static {v4}, Lo7/c;->e(Ld/g;)Lo7/a;

    move-result-object v4

    invoke-static {p0, p1, v4}, Lo7/c;->m(Landroid/content/Context;Landroid/net/Uri;Lo7/a;)Landroid/graphics/Bitmap;
    ...
    :goto_0
    sget-object p1, Lo7/c;->a:Ljava/lang/String;
...
.method public static m(Landroid/content/Context;Landroid/net/Uri;Lo7/a;)Landroid/graphics/Bitmap;
    .locals 2
    ...
    :goto_1
    :try_start_3
    sget-object p2, Lo7/c;->a:Ljava/lang/String;
...
.method public static n(Ljava/util/List;)Lo7/d;
    .locals 1
...
.method public static o(Landroid/content/Context;Landroid/net/Uri;)[B
    ...
    invoke-static {p0}, Lo7/c;->k(Ljava/io/InputStream;)S

    move-result p1

    sget-object v2, Lo7/c;->a:Ljava/lang/String;
    ...
    invoke-static {v2, p1}, Lo7/c;->r([BI)Ljava/util/List;
    ...
    :cond_3
    invoke-virtual {v2}, Lo7/d;->a()I

    move-result p1

    sget-object v4, Lo7/c;->a:Ljava/lang/String;
...
.method public static synthetic p(Lo7/d;)Z
    .locals 1
...
.method public static q(Ljava/io/File;Lo7/d;[B[B)V
    .locals 17
    ...
    invoke-static {v6}, Lo7/c;->k(Ljava/io/InputStream;)S

    move-result v7

    sget-object v10, Lo7/c;->a:Ljava/lang/String;
    ...
    invoke-static {v13, v11}, Lo7/c;->r([BI)Ljava/util/List;
    ...
    check-cast v14, Lo7/d;

    invoke-virtual {v14}, Lo7/d;->a()I
    ...
    invoke-static {v13, v12, v9, v1}, Lo7/c;->t(Ljava/util/List;I[BLo7/d;)[B
    ...
    invoke-static {v13, v1}, Lo7/c;->s(Ljava/util/List;Lo7/d;)V
    ...
    invoke-static {v0}, Lo7/c;->l(S)[B

    move-result-object v0

    invoke-virtual {v1, v0}, Ljava/io/FileOutputStream;->write([B)V

    invoke-static {v1, v13}, Lo7/c;->u(Ljava/io/FileOutputStream;Ljava/util/List;)V
    ...
    :goto_2
    sget-object v1, Lo7/c;->a:Ljava/lang/String;
...
.method public static r([BI)Ljava/util/List;
    ...
    invoke-virtual {v2, v3}, Lo7/d;->h(I)V

    invoke-virtual {p0}, Ljava/nio/ByteBuffer;->getShort()S

    move-result v3

    invoke-virtual {v2, v3}, Lo7/d;->f(I)V

    invoke-virtual {p0}, Ljava/nio/ByteBuffer;->getInt()I

    move-result v3

    invoke-virtual {v2, v3}, Lo7/d;->g(I)V

    invoke-virtual {p0}, Ljava/nio/ByteBuffer;->getInt()I

    move-result v3

    invoke-virtual {v2, v3}, Lo7/d;->i(I)V
...
.method public static s(Ljava/util/List;Lo7/d;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v1}, Lo7/d;->e()I

    move-result v2

    invoke-virtual {p1}, Lo7/d;->a()I
    ...
    invoke-virtual {v1, v2}, Lo7/d;->i(I)V

    goto :goto_0

    :cond_1
    invoke-virtual {v1}, Lo7/d;->a()I
    ...
    invoke-virtual {p1, v1}, Lo7/d;->i(I)V
...
.method public static t(Ljava/util/List;I[BLo7/d;)[B
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0}, Lo7/c;->n(Ljava/util/List;)Lo7/d;

    move-result-object p0

    if-eqz p0, :cond_0

    invoke-virtual {p0}, Lo7/d;->a()I
...
.method public static u(Ljava/io/FileOutputStream;Ljava/util/List;)V
    ...
    invoke-virtual {v0}, Lo7/d;->d()I

    move-result v1

    int-to-short v1, v1

    invoke-static {v1}, Lo7/c;->l(S)[B

    move-result-object v1

    invoke-virtual {p0, v1}, Ljava/io/FileOutputStream;->write([B)V

    invoke-virtual {v0}, Lo7/d;->b()I
...
.method public static v(Landroid/graphics/Bitmap;Landroid/util/Size;Ljava/lang/String;)V
    ...
    sget-object p2, Lcom/android/camera/e3;->d:Lcom/android/camera/e3;

    invoke-virtual {p2, v0}, Lcom/android/camera/e3;->b(Z)I
    ...
    invoke-static {p2, v6, v7, v8, p1}, Lo7/c;->b(Lorg/xmlpull/v1/XmlSerializer;JII)V
    ...
    invoke-interface {p2, v5, v6, p1}, Ld/g;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, v5}, Lg/f;->O(Z)Lg/f;

    invoke-virtual {p1, v5}, Lg/f;->K(Z)Lg/f;

    invoke-static {p2, p1}, Ld/h;->n(Ld/g;Lg/f;)[B

    move-result-object p1

    new-instance p2, Lo7/d;

    invoke-direct {p2}, Lo7/d;-><init>()V

    const/16 v6, 0x2bc

    invoke-virtual {p2, v6}, Lo7/d;->h(I)V

    invoke-virtual {p2, v5}, Lo7/d;->f(I)V

    array-length v5, p1

    invoke-virtual {p2, v5}, Lo7/d;->g(I)V

    invoke-static {v4, p2, p1, p0}, Lo7/c;->q(Ljava/io/File;Lo7/d;[B[B)V
