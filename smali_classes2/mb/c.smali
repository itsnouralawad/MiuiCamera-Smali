...
# static fields
.field public static final F:Ljava/lang/String; = "HeifEncoder"
...
.field public static final J:D = 0.25
...
.field public z:Lmb/b;


# direct methods
.method public constructor <init>(IIZIIIILandroid/os/Handler;Lmb/c$c;)V
    .locals 20
    ...
    iput-object v9, v0, Lmb/c;->s:Ljava/util/ArrayList;

    new-instance v9, Ljava/util/ArrayList;

    invoke-direct {v9}, Ljava/util/ArrayList;-><init>()V

    iput-object v9, v0, Lmb/c;->t:Ljava/util/ArrayList;

    new-instance v9, Ljava/util/ArrayList;

    invoke-direct {v9}, Ljava/util/ArrayList;-><init>()V

    iput-object v9, v0, Lmb/c;->u:Ljava/util/ArrayList;

    const/16 v9, 0x10

    new-array v9, v9, [F

    iput-object v9, v0, Lmb/c;->D:[F
    ...
    iput-object v14, v0, Lmb/c;->a:Landroid/media/MediaCodec;
    ...
    :cond_2
    iget-object v14, v0, Lmb/c;->a:Landroid/media/MediaCodec;

    invoke-virtual {v14}, Landroid/media/MediaCodec;->release()V

    iput-object v13, v0, Lmb/c;->a:Landroid/media/MediaCodec;
    ...
    :goto_2
    iput v4, v0, Lmb/c;->e:I

    move-object/from16 v10, p9

    iput-object v10, v0, Lmb/c;->b:Lmb/c$c;
    ...
    iput-object v10, v0, Lmb/c;->c:Landroid/os/HandlerThread;
    ...
    :cond_4
    iput-object v13, v0, Lmb/c;->c:Landroid/os/HandlerThread;
    ...
    iput-object v9, v0, Lmb/c;->d:Landroid/os/Handler;
    ...
    iput v1, v0, Lmb/c;->f:I

    iput v2, v0, Lmb/c;->g:I

    iput-boolean v12, v0, Lmb/c;->m:Z
    ...
    iput v1, v0, Lmb/c;->h:I

    iput v2, v0, Lmb/c;->i:I

    const/4 v4, 0x1

    iput v4, v0, Lmb/c;->j:I

    iput v4, v0, Lmb/c;->k:I

    goto :goto_b

    :cond_d
    iput v4, v0, Lmb/c;->h:I

    iput v10, v0, Lmb/c;->i:I

    iput v9, v0, Lmb/c;->j:I

    iput v11, v0, Lmb/c;->k:I

    :goto_b
    iget v4, v0, Lmb/c;->j:I

    iget v5, v0, Lmb/c;->k:I

    mul-int/2addr v4, v5

    iput v4, v0, Lmb/c;->l:I
    ...
    :goto_d
    iget-object v3, v0, Lmb/c;->a:Landroid/media/MediaCodec;

    new-instance v4, Lmb/c$d;

    invoke-direct {v4, v0}, Lmb/c$d;-><init>(Lmb/c;)V
    ...
    iput-object v3, v0, Lmb/c;->y:Landroid/view/Surface;
    ...
    :goto_10
    new-instance v4, Lmb/c$f;

    invoke-direct {v4, v0, v11}, Lmb/c$f;-><init>(Lmb/c;Z)V

    iput-object v4, v0, Lmb/c;->v:Lmb/c$f;

    if-eqz v11, :cond_15

    new-instance v4, Lmb/b;

    iget-object v5, v0, Lmb/c;->y:Landroid/view/Surface;

    invoke-direct {v4, v5}, Lmb/b;-><init>(Landroid/view/Surface;)V

    iput-object v4, v0, Lmb/c;->z:Lmb/b;

    invoke-virtual {v4}, Lmb/b;->g()V
    ...
    :goto_11
    invoke-direct {v5, v11}, Lmb/e;-><init>(I)V

    invoke-direct {v4, v5, v1, v2}, Lmb/a;-><init>(Lmb/e;II)V

    iput-object v4, v0, Lmb/c;->A:Lmb/a;

    invoke-virtual {v4}, Lmb/a;->c()I

    move-result v4

    iput v4, v0, Lmb/c;->C:I
    ...
    iget v5, v0, Lmb/c;->C:I

    invoke-direct {v3, v5, v4}, Landroid/graphics/SurfaceTexture;-><init>(IZ)V

    iput-object v3, v0, Lmb/c;->w:Landroid/graphics/SurfaceTexture;
    ...
    iget-object v3, v0, Lmb/c;->w:Landroid/graphics/SurfaceTexture;

    invoke-virtual {v3, v1, v2}, Landroid/graphics/SurfaceTexture;->setDefaultBufferSize(II)V

    new-instance v1, Landroid/view/Surface;

    iget-object v2, v0, Lmb/c;->w:Landroid/graphics/SurfaceTexture;

    invoke-direct {v1, v2}, Landroid/view/Surface;-><init>(Landroid/graphics/SurfaceTexture;)V

    iput-object v1, v0, Lmb/c;->x:Landroid/view/Surface;

    :cond_14
    iget-object v1, v0, Lmb/c;->z:Lmb/b;
    ...
    :cond_15
    iget-object v1, v0, Lmb/c;->y:Landroid/view/Surface;
    ...
    iget-object v2, v0, Lmb/c;->s:Ljava/util/ArrayList;

    iget v3, v0, Lmb/c;->f:I

    iget v4, v0, Lmb/c;->g:I
    ...
    iget v2, v0, Lmb/c;->h:I

    iget v3, v0, Lmb/c;->i:I

    const/4 v4, 0x0

    invoke-direct {v1, v4, v4, v2, v3}, Landroid/graphics/Rect;-><init>(IIII)V

    iput-object v1, v0, Lmb/c;->q:Landroid/graphics/Rect;

    new-instance v1, Landroid/graphics/Rect;

    invoke-direct {v1}, Landroid/graphics/Rect;-><init>()V

    iput-object v1, v0, Lmb/c;->p:Landroid/graphics/Rect;
...
.method public static g(Ljava/nio/ByteBuffer;Landroid/media/Image;IILandroid/graphics/Rect;Landroid/graphics/Rect;)V
    .locals 17
...
.method public final a()Ljava/nio/ByteBuffer;
    ...
    iget-object v0, p0, Lmb/c;->s:Ljava/util/ArrayList;
    ...
    :goto_0
    :try_start_0
    iget-boolean v1, p0, Lmb/c;->o:Z

    if-nez v1, :cond_0

    iget-object v1, p0, Lmb/c;->s:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object p0, p0, Lmb/c;->s:Ljava/util/ArrayList;
...
.method public b(Landroid/graphics/Bitmap;)V
    ...
    iget v0, p0, Lmb/c;->e:I

    const/4 v1, 0x2

    if-ne v0, v1, :cond_2

    iget-object v0, p0, Lmb/c;->v:Lmb/c$f;

    iget v1, p0, Lmb/c;->n:I

    invoke-virtual {p0, v1}, Lmb/c;->e(I)J
    ...
    iget v3, p0, Lmb/c;->n:I

    iget v4, p0, Lmb/c;->l:I

    add-int/2addr v3, v4

    add-int/lit8 v3, v3, -0x1

    invoke-virtual {p0, v3}, Lmb/c;->e(I)J

    move-result-wide v3

    invoke-virtual {v0, v1, v2, v3, v4}, Lmb/c$f;->d(JJ)Z
    ...
    :try_start_0
    iget-object v0, p0, Lmb/c;->z:Lmb/b;
    ...
    :cond_1
    invoke-virtual {v0}, Lmb/b;->g()V

    iget-object v0, p0, Lmb/c;->A:Lmb/a;

    iget v1, p0, Lmb/c;->C:I

    invoke-virtual {v0, v1, p1}, Lmb/a;->d(ILandroid/graphics/Bitmap;)V

    invoke-virtual {p0}, Lmb/c;->h()V

    iget-object p1, p0, Lmb/c;->z:Lmb/b;

    invoke-virtual {p1}, Lmb/b;->h()V
...
.method public c(I[B)V
    ...
    iget v0, p0, Lmb/c;->f:I

    iget v1, p0, Lmb/c;->g:I
    ...
    invoke-virtual {p0, p2}, Lmb/c;->d([B)V
...
.method public close()V
    ...
    iget-object v0, p0, Lmb/c;->d:Landroid/os/Handler;

    new-instance v1, Lmb/c$b;

    invoke-direct {v1, p0}, Lmb/c$b;-><init>(Lmb/c;)V
...
.method public final d([B)V
    ...
    invoke-virtual {p0}, Lmb/c;->a()Ljava/nio/ByteBuffer;
    ...
    iget-object p1, p0, Lmb/c;->t:Ljava/util/ArrayList;

    monitor-enter p1

    :try_start_0
    iget-object v1, p0, Lmb/c;->t:Ljava/util/ArrayList;
    ...
    iget-object p1, p0, Lmb/c;->d:Landroid/os/Handler;
...
.method public final h()V
    ...
    iget v0, p0, Lmb/c;->h:I

    iget v1, p0, Lmb/c;->i:I
    ...
    iget v3, p0, Lmb/c;->h:I

    mul-int v4, v1, v3

    iget v5, p0, Lmb/c;->i:I

    mul-int v6, v0, v5

    iget-object v7, p0, Lmb/c;->p:Landroid/graphics/Rect;
    ...
    iget-object v3, p0, Lmb/c;->A:Lmb/a;

    iget v4, p0, Lmb/c;->C:I

    sget-object v5, Lmb/e;->k:[F

    iget-object v6, p0, Lmb/c;->p:Landroid/graphics/Rect;

    invoke-virtual {v3, v4, v5, v6}, Lmb/a;->a(I[FLandroid/graphics/Rect;)V

    iget-object v3, p0, Lmb/c;->z:Lmb/b;

    iget v4, p0, Lmb/c;->n:I

    add-int/lit8 v5, v4, 0x1

    iput v5, p0, Lmb/c;->n:I

    invoke-virtual {p0, v4}, Lmb/c;->e(I)J
    ...
    invoke-virtual {v3, v4, v5}, Lmb/b;->k(J)V

    iget-object v3, p0, Lmb/c;->z:Lmb/b;

    invoke-virtual {v3}, Lmb/b;->l()Z
...
.method public final i()Ljava/nio/ByteBuffer;
    ...
    iget-boolean v0, p0, Lmb/c;->o:Z

    const/4 v1, 0x0

    if-nez v0, :cond_1

    iget-object v0, p0, Lmb/c;->r:Ljava/nio/ByteBuffer;

    if-nez v0, :cond_1

    iget-object v0, p0, Lmb/c;->t:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v2, p0, Lmb/c;->t:Ljava/util/ArrayList;
    ...
    :goto_0
    iput-object v2, p0, Lmb/c;->r:Ljava/nio/ByteBuffer;
    ...
    :cond_2
    iget-object v1, p0, Lmb/c;->r:Ljava/nio/ByteBuffer;
...
.method public j()Landroid/view/Surface;
    ...
    iget-object p0, p0, Lmb/c;->x:Landroid/view/Surface;
...
.method public k()V
    ...
    :cond_0
    :goto_0
    invoke-virtual {p0}, Lmb/c;->i()Ljava/nio/ByteBuffer;

    move-result-object v0

    if-eqz v0, :cond_6

    iget-object v1, p0, Lmb/c;->u:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lmb/c;->a:Landroid/media/MediaCodec;

    invoke-virtual {v1, v8}, Landroid/media/MediaCodec;->getInputImage(I)Landroid/media/Image;

    move-result-object v1

    iget v2, p0, Lmb/c;->h:I

    iget v3, p0, Lmb/c;->n:I

    iget v4, p0, Lmb/c;->k:I

    rem-int v5, v3, v4

    mul-int/2addr v5, v2

    iget v7, p0, Lmb/c;->i:I

    div-int/2addr v3, v4

    iget v4, p0, Lmb/c;->j:I

    rem-int/2addr v3, v4

    mul-int/2addr v3, v7

    iget-object v4, p0, Lmb/c;->p:Landroid/graphics/Rect;
    ...
    iget v2, p0, Lmb/c;->f:I

    iget v3, p0, Lmb/c;->g:I

    iget-object v4, p0, Lmb/c;->p:Landroid/graphics/Rect;

    iget-object v5, p0, Lmb/c;->q:Landroid/graphics/Rect;

    invoke-static/range {v0 .. v5}, Lmb/c;->g(Ljava/nio/ByteBuffer;Landroid/media/Image;IILandroid/graphics/Rect;Landroid/graphics/Rect;)V

    :cond_2
    iget-object v7, p0, Lmb/c;->a:Landroid/media/MediaCodec;
    ...
    :goto_2
    iget v0, p0, Lmb/c;->n:I

    add-int/lit8 v1, v0, 0x1

    iput v1, p0, Lmb/c;->n:I

    invoke-virtual {p0, v0}, Lmb/c;->e(I)J
    ...
    :cond_5
    invoke-virtual {p0, v14}, Lmb/c;->l(Z)V
...
.method public final l(Z)V
    ...
    iput-boolean p1, p0, Lmb/c;->o:Z

    iget-object p1, p0, Lmb/c;->s:Ljava/util/ArrayList;
    ...
    iput-object p1, p0, Lmb/c;->r:Ljava/nio/ByteBuffer;
...
.method public m(J)V
    ...
    iget-object p0, p0, Lmb/c;->v:Lmb/c$f;

    if-eqz p0, :cond_0

    invoke-virtual {p0, p1, p2}, Lmb/c$f;->c(J)V
...
.method public o()V
    ...
    invoke-virtual {p0, v0, v1}, Lmb/c$f;->c(J)V
    ...
    invoke-virtual {p0, v0}, Lmb/c;->d([B)V
...
.method public onFrameAvailable(Landroid/graphics/SurfaceTexture;)V
    ...
    iget-object v2, p0, Lmb/c;->v:Lmb/c$f;
    ...
    invoke-virtual {v2, v0, v1, v3, v4}, Lmb/c$f;->d(JJ)Z
...
.method public r()V
    ...
    iget-object v0, p0, Lmb/c;->a:Landroid/media/MediaCodec;
    ...
    iput-object v1, p0, Lmb/c;->a:Landroid/media/MediaCodec;
    ...
    :try_start_0
    iput-boolean v2, p0, Lmb/c;->o:Z

    iget-object v2, p0, Lmb/c;->s:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v2}, Lmb/a;->e(Z)V

    iput-object v1, p0, Lmb/c;->A:Lmb/a;
    ...
    iput-object v1, p0, Lmb/c;->z:Lmb/b;

    :cond_2
    iget-object v0, p0, Lmb/c;->w:Landroid/graphics/SurfaceTexture;

    if-eqz v0, :cond_3

    invoke-virtual {v0}, Landroid/graphics/SurfaceTexture;->release()V

    iput-object v1, p0, Lmb/c;->w:Landroid/graphics/SurfaceTexture;
