...
.method public constructor <init>(Landroid/media/Image;I)V
    ...
    .line 15
    iput v0, p0, Lrb/c;->i:I

    .line 16
    invoke-virtual {p0, p1, p2}, Lrb/c;->j(Landroid/media/Image;I)V
...
.method public constructor <init>(Lrb/c;)V
    ...
    iput-object v0, p0, Lrb/c;->a:[B

    .line 7
    iget-wide v0, p1, Lrb/c;->c:J

    iput-wide v0, p0, Lrb/c;->c:J
...
.method public final a(Landroid/media/Image;)V
    ...
    iget v9, p0, Lrb/c;->d:I

    iget v11, p0, Lrb/c;->e:I
    ...
    iput-object v11, p0, Lrb/c;->a:[B

    :cond_1
    if-ne v5, v9, :cond_2

    iget-object v4, p0, Lrb/c;->a:[B

    invoke-virtual {v2, v4, v3, v7}, Ljava/nio/ByteBuffer;->get([BII)Ljava/nio/ByteBuffer;

    iget-object v2, p0, Lrb/c;->a:[B
    ...
    :goto_0
    iget v9, p0, Lrb/c;->e:I

    if-ge p1, v9, :cond_6

    iget-object v9, p0, Lrb/c;->b:[B

    iget-object v11, p0, Lrb/c;->a:[B

    iget v12, p0, Lrb/c;->d:I
    ...
    :cond_6
    :goto_2
    iget p1, p0, Lrb/c;->e:I

    div-int/2addr p1, v4

    if-ge v3, p1, :cond_7

    iget-object p1, p0, Lrb/c;->b:[B

    iget-object v5, p0, Lrb/c;->a:[B

    iget v7, p0, Lrb/c;->d:I
...
.method public j(Landroid/media/Image;I)V
    ...
    iput p2, p0, Lrb/c;->g:I

    const/16 p2, 0x23

    if-ne v0, p2, :cond_0

    invoke-virtual {p0, p1}, Lrb/c;->a(Landroid/media/Image;)V
    :try_end_0
