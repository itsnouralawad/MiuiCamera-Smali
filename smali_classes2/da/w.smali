...
.method public constructor <init>(Lda/t;)V
    ...
    iput-object p1, p0, Lda/w;->a:Lda/t;
...
.method public a(Landroid/graphics/SurfaceTexture;II)V
    ...
    iget-object p1, p0, Lda/w;->a:Lda/t;

    invoke-virtual {p1}, Lda/t;->u0()Lcom/android/camera/Camera;
    ...
    invoke-virtual {p1, v1}, Lcom/android/camera/Camera;->H0(I)V
    ...
    invoke-static {p1}, Lcom/android/camera/z5;->G1(I)I

    move-result p1

    iget-object v1, p0, Lda/w;->a:Lda/t;
    ...
    :goto_0
    invoke-virtual {v1, v2}, Lda/t;->g1(I)V

    iget-object v1, p0, Lda/w;->a:Lda/t;

    invoke-virtual {v1}, Lda/t;->W()Lcom/android/camera/s2;
    ...
    invoke-virtual {v1, p1}, Lcom/android/camera/f5;->z(I)V

    :cond_1
    iget-object p1, p0, Lda/w;->a:Lda/t;

    invoke-virtual {p1}, Lda/t;->C1()Lcom/android/gallery3d/ui/h;
    ...
    invoke-virtual {p1, v1}, Lda/t;->s(Lcom/android/gallery3d/ui/o;)V

    :cond_2
    iget-object p0, p0, Lda/w;->a:Lda/t;

    invoke-virtual {p0}, Lda/t;->C1()Lcom/android/gallery3d/ui/h;
...
.method public d([BIILsl/d;)V
    ...
    iget-object v0, p0, Lda/w;->a:Lda/t;

    invoke-virtual {v0}, Lda/t;->u0()Lcom/android/camera/Camera;
    ...
    sget-object v1, Lsl/d;->e:Lsl/d;

    if-ne p4, v1, :cond_0

    iget-object p0, p0, Lda/w;->a:Lda/t;

    invoke-virtual {p0}, Lda/t;->r1()Lda/e;
...
.method public onSurfaceCreated()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/camera/Camera;->H0(I)V
