...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lq8/a;->i:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lq8/a;->j:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lq8/a;->k:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lq8/a;->l:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lq8/a;->m:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lq8/a;->n:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lq8/a;->o:Ljava/util/List;

    sget-object v0, Lq8/a;->i:Ljava/util/List;

    const-string v1, "android.permission.CAMERA"

    invoke-interface {v0, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    sget-object v0, Lq8/a;->j:Ljava/util/List;
    ...
    sget-object v0, Lq8/a;->k:Ljava/util/List;
    ...
    sget-object v3, Lq8/a;->n:Ljava/util/List;

    const-string v4, "android.permission.READ_MEDIA_AUDIO"

    invoke-interface {v3, v4}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    sget-object v3, Lq8/a;->m:Ljava/util/List;
    ...
    sget-object v3, Lq8/a;->l:Ljava/util/List;
    ...
    :goto_0
    sget-object v3, Lq8/a;->o:Ljava/util/List;

    invoke-interface {v3, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    if-lt v0, v2, :cond_1

    sget-object v0, Lq8/a;->o:Ljava/util/List;

    sget-object v1, Lq8/a;->m:Ljava/util/List;

    invoke-interface {v0, v1}, Ljava/util/List;->addAll(Ljava/util/Collection;)Z

    sget-object v0, Lq8/a;->o:Ljava/util/List;

    sget-object v1, Lq8/a;->n:Ljava/util/List;
    ...
    sget-object v1, Lq8/a;->l:Ljava/util/List;
...
.method public static a(Ljava/util/List;Ljava/lang/String;)V
    ...
    :pswitch_3
    sget-object v2, Lq8/a;->m:Ljava/util/List;
    ...
    :pswitch_4
    sget-object v2, Lq8/a;->l:Ljava/util/List;
    ...
    :pswitch_5
    sget-object v2, Lq8/a;->k:Ljava/util/List;
    ...
    :pswitch_6
    sget-object v2, Lq8/a;->j:Ljava/util/List;
...
.method public static b()Z
    ...
    invoke-static {v0}, Lq8/a;->i(Ljava/util/List;)Ljava/util/List;
...
.method public static c()Z
    ...
    invoke-static {v0}, Lcom/android/camera/z5;->v3(Landroid/content/Context;)Z
...
.method public static f()Z
    ...
    sget-object v0, Lq8/a;->l:Ljava/util/List;
...
.method public static g(Z)Landroid/util/ArrayMap;
    ...
    sget-object v4, Lq8/a;->o:Ljava/util/List;

    invoke-static {v4}, Lq8/a;->i(Ljava/util/List;)Ljava/util/List;

    move-result-object v4

    invoke-static {}, Lq8/a;->q()Z
    ...
    invoke-static {v6}, Lq8/a;->j(Ljava/lang/String;)I
...
.method public static h(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {v0, v1}, Lq8/a;->a(Ljava/util/List;Ljava/lang/String;)V
...
.method public static n([Ljava/lang/String;)Z
    ...
    sget-object v5, Lq8/a;->i:Ljava/util/List;
...
.method public static o([Ljava/lang/String;)Z
    ...
    sget-object v5, Lq8/a;->j:Ljava/util/List;
...
.method public static p()Z
    ...
    invoke-static {v3}, Lq8/a;->j(Ljava/lang/String;)I
...
.method public static r(Ly6/a;Lw1/b;)Z
    .locals 7
    ...
    invoke-static {v5}, Lq8/a;->j(Ljava/lang/String;)I
    ...
    invoke-static {v0}, Lq8/a;->h(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-interface {p1, p0}, Lw1/b;->fa(Ljava/lang/String;)V
...
.method public static s(Ly6/a;Lw1/b;)Z
    .locals 7
    ...
    sget-object p0, Lq8/a;->j:Ljava/util/List;
...
.method public static t(Landroid/app/Activity;I)Z
    ...
    sget-object v5, Lp8/a$b;->y:Lp8/a$b;

    aput-object v5, v4, v3

    sget-object v5, Lp8/a$b;->z:Lp8/a$b;

    aput-object v5, v4, v1

    invoke-virtual {v2, v4}, Lp8/m;->m([Lp8/a$b;)V
...
.method public static u(Landroid/app/Activity;ILw1/b;)Z
    .locals 7
    ...
    new-array v1, v1, [Lp8/a$b;

    sget-object v4, Lp8/a$b;->y:Lp8/a$b;
    ...
    invoke-virtual {p2, v1}, Lp8/m;->m([Lp8/a$b;)V
    ...
    invoke-interface {p2, p0}, Lw1/b;->fa(Ljava/lang/String;)V
...
.method public static v(Landroid/app/Activity;I)Z
    ...
    :pswitch_0
    sget-object p1, Lq8/a;->k:Ljava/util/List;

    goto :goto_0

    :pswitch_1
    sget-object p1, Lq8/a;->o:Ljava/util/List;

    goto :goto_0

    :pswitch_2
    sget-object p1, Lq8/a;->j:Ljava/util/List;
