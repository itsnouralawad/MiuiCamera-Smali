...
# direct methods
.method public constructor <init>(Lua/c;Landroid/os/Looper;)V
    .locals 0

    iput-object p1, p0, Lua/c$b;->a:Lua/c;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    :cond_0
    iget-object v4, p0, Lua/c$b;->a:Lua/c;

    invoke-static {v4}, Lua/c;->c(Lua/c;)Ljava/lang/ref/WeakReference;
    ...
    check-cast v4, Lua/c$e;

    if-nez p1, :cond_d

    iget-object p1, p0, Lua/c$b;->a:Lua/c;

    invoke-static {p1}, Lua/c;->d(Lua/c;)I
    ...
    iget-object v6, p0, Lua/c$b;->a:Lua/c;

    invoke-static {v6}, Lua/c;->e(Lua/c;)Landroid/graphics/Rect;
    ...
    iget-object v7, p0, Lua/c$b;->a:Lua/c;

    invoke-static {v7}, Lua/c;->e(Lua/c;)Landroid/graphics/Rect;
    ...
    iget-object v8, p0, Lua/c$b;->a:Lua/c;

    invoke-static {v8}, Lua/c;->e(Lua/c;)Landroid/graphics/Rect;
    ...
    iget-object v9, p0, Lua/c$b;->a:Lua/c;

    invoke-static {v9}, Lua/c;->e(Lua/c;)Landroid/graphics/Rect;
    ...
    iget-object v5, p0, Lua/c$b;->a:Lua/c;

    invoke-static {v5}, Lua/c;->e(Lua/c;)Landroid/graphics/Rect;
    ...
    invoke-static {v5}, Lua/c;->f(Lua/c;)Z
    ...
    invoke-static {v5}, Lua/c;->d(Lua/c;)I
    ...
    invoke-interface/range {v5 .. v11}, Lua/c$e;->O7(Z[BIILandroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    iget-object p0, p0, Lua/c$b;->a:Lua/c;

    invoke-static {p0}, Lua/c;->f(Lua/c;)Z
    ...
    invoke-interface/range {v5 .. v11}, Lua/c$e;->W4(ZIILandroid/graphics/Point;Landroid/graphics/Point;Z)V
    ...
    invoke-static {p1, v1}, Lua/c;->g(Lua/c;I)I
    ...
    invoke-static {p0}, Lua/c;->h(Lua/c;)I

    move-result p0

    invoke-interface {v4, p1, v1, v0, p0}, Lua/c$e;->s3([BIII)V
