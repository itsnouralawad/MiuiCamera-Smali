...
# direct methods
.method public constructor <init>(Landroid/content/Context;ILua/c$e;)V
    .locals 4
    ...
    iput-object v0, p0, Lua/c;->a:Landroid/content/Context;

    const/16 v1, 0x5a

    iput v1, p0, Lua/c;->c:I
    ...
    iput-object v2, p0, Lua/c;->f:Ljava/util/concurrent/atomic/AtomicInteger;

    iput v1, p0, Lua/c;->g:I

    iput v1, p0, Lua/c;->h:I

    iput v1, p0, Lua/c;->i:I

    iput v1, p0, Lua/c;->j:I

    iput v1, p0, Lua/c;->l:I

    iput v1, p0, Lua/c;->m:I

    iput-boolean v1, p0, Lua/c;->s:Z

    iput-boolean v1, p0, Lua/c;->t:Z

    iput-boolean v1, p0, Lua/c;->u:Z

    new-instance v1, Lua/c$d;

    invoke-direct {v1, p0}, Lua/c$d;-><init>(Lua/c;)V

    iput-object v1, p0, Lua/c;->y:Lcom/arcsoft/camera/wideselfie/WideSelfieCallback;
    ...
    invoke-direct {v1, p0, v2}, Lua/c$b;-><init>(Lua/c;Landroid/os/Looper;)V

    iput-object v1, p0, Lua/c;->z:Landroid/os/Handler;

    new-instance v1, Lua/c$c;

    invoke-direct {v1, v0}, Lua/c$c;-><init>(Lua/c$a;)V

    iput-object v1, p0, Lua/c;->A:Landroid/hardware/SensorEventListener;
    ...
    iput-object p2, p0, Lua/c;->r:Ljava/lang/ref/WeakReference;
    ...
    iput-object p1, p0, Lua/c;->p:Landroid/hardware/SensorManager;
    ...
    iput-object p1, p0, Lua/c;->q:Landroid/hardware/Sensor;

    iget-object p1, p0, Lua/c;->a:Landroid/content/Context;
    ...
    iput-object p1, p0, Lua/c;->v:Landroid/os/HandlerThread;

    invoke-virtual {p1}, Ljava/lang/Thread;->start()V

    new-instance p1, Lua/c$a;

    iget-object p2, p0, Lua/c;->v:Landroid/os/HandlerThread;

    invoke-virtual {p2}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object p2

    invoke-direct {p1, p0, p2}, Lua/c$a;-><init>(Lua/c;Landroid/os/Looper;)V

    iput-object p1, p0, Lua/c;->w:Landroid/os/Handler;

    return-void
.end method

.method public static synthetic a(Lua/c;[B)V
    .locals 0

    invoke-virtual {p0, p1}, Lua/c;->n([B)V

    return-void
.end method

.method public static synthetic b(Lua/c;ILcom/arcsoft/camera/wideselfie/ProcessResult;)V
    .locals 0

    invoke-virtual {p0, p1, p2}, Lua/c;->k(ILcom/arcsoft/camera/wideselfie/ProcessResult;)V

    return-void
.end method

.method public static synthetic c(Lua/c;)Ljava/lang/ref/WeakReference;
    .locals 0

    iget-object p0, p0, Lua/c;->r:Ljava/lang/ref/WeakReference;

    return-object p0
.end method

.method public static synthetic d(Lua/c;)I
    .locals 0
...
.method public static synthetic e(Lua/c;)Landroid/graphics/Rect;
    .locals 0

    iget-object p0, p0, Lua/c;->o:Landroid/graphics/Rect;

    return-object p0
.end method

.method public static synthetic f(Lua/c;)Z
    .locals 0

    iget-boolean p0, p0, Lua/c;->x:Z

    return p0
.end method

.method public static synthetic g(Lua/c;I)I
    .locals 0
...
.method public static synthetic h(Lua/c;)I
    .locals 0
...
.method public final k(ILcom/arcsoft/camera/wideselfie/ProcessResult;)V
    ...
    iget-object v0, p0, Lua/c;->z:Landroid/os/Handler;
    ...
    :cond_0
    iget-object p0, p0, Lua/c;->z:Landroid/os/Handler;
...
.method public l()Z
    ...
    iget-object p0, p0, Lua/c;->f:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public m(Landroid/media/Image;)V
    ...
    iget-object v0, p0, Lua/c;->f:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object p0, p0, Lua/c;->w:Landroid/os/Handler;
...
.method public final n([B)V
    ...
    :goto_0
    iget-object v5, p0, Lua/c;->f:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-boolean p1, p0, Lua/c;->t:Z

    if-nez p1, :cond_4

    iput-boolean v3, p0, Lua/c;->t:Z

    goto/16 :goto_1

    :cond_2
    iget-object p1, p0, Lua/c;->f:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v0, p0, Lua/c;->r:Ljava/lang/ref/WeakReference;

    invoke-virtual {v0}, Ljava/lang/ref/Reference;->get()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lua/c$e;

    if-eqz v0, :cond_3

    invoke-interface {v0}, Lua/c$e;->Xa()V

    :cond_3
    iput v3, p0, Lua/c;->d:I
...
.method public o()V
    ...
    iget-object v1, p0, Lua/c;->z:Landroid/os/Handler;
    ...
    iget-object v0, p0, Lua/c;->v:Landroid/os/HandlerThread;
    ...
    iput-object v0, p0, Lua/c;->v:Landroid/os/HandlerThread;
...
.method public p()V
    ...
    iget-boolean v0, p0, Lua/c;->u:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lua/c;->p:Landroid/hardware/SensorManager;

    iget-object v1, p0, Lua/c;->A:Landroid/hardware/SensorEventListener;

    invoke-virtual {v0, v1}, Landroid/hardware/SensorManager;->unregisterListener(Landroid/hardware/SensorEventListener;)V

    const/4 v0, 0x0

    iput-boolean v0, p0, Lua/c;->u:Z
...
.method public q()V
    ...
    iget-object v2, p0, Lua/c;->q:Landroid/hardware/Sensor;

    const/16 v3, 0x2710

    iget-object v4, p0, Lua/c;->w:Landroid/os/Handler;
...
.method public r(Ljava/lang/String;IIII)V
    ...
    :cond_0
    iput p2, p0, Lua/c;->i:I

    iput p3, p0, Lua/c;->j:I

    iput p4, p0, Lua/c;->g:I

    iput p5, p0, Lua/c;->h:I

    iget-object p3, p0, Lua/c;->a:Landroid/content/Context;
    ...
    iput p3, p0, Lua/c;->l:I

    iget p3, p0, Lua/c;->j:I
    ...
    :try_start_0
    iget-object p2, p0, Lua/c;->a:Landroid/content/Context;
    ...
    invoke-virtual {p0, p1}, Lua/c;->j(Landroid/hardware/camera2/CameraCharacteristics;)Landroid/util/SizeF;

    move-result-object p1

    iput-object p1, p0, Lua/c;->k:Landroid/util/SizeF;
    :try_end_0
...
.method public t()I
    ...
    iget v0, p0, Lua/c;->g:I

    iget v2, p0, Lua/c;->h:I

    const/16 v4, 0x802

    iget v5, p0, Lua/c;->c:I
    ...
    :goto_1
    iput-boolean v2, p0, Lua/c;->x:Z

    iget-object v2, p0, Lua/c;->a:Landroid/content/Context;

    invoke-static {v2}, Lua/b;->a(Landroid/content/Context;)Lua/b;
    ...
    iget v5, p0, Lua/c;->h:I

    iget v8, p0, Lua/c;->n:I

    mul-int/2addr v5, v8

    invoke-virtual {v2}, Lua/b;->c()I

    move-result v2

    div-int/2addr v5, v2

    iget v2, p0, Lua/c;->n:I

    iget v8, p0, Lua/c;->m:I
    ...
    iget v9, p0, Lua/c;->l:I

    iget v10, p0, Lua/c;->m:I

    add-int/2addr v10, v2

    invoke-direct {v8, v1, v2, v9, v10}, Landroid/graphics/Rect;-><init>(IIII)V

    iput-object v8, p0, Lua/c;->o:Landroid/graphics/Rect;

    goto :goto_2

    :cond_2
    iget v5, p0, Lua/c;->g:I

    invoke-virtual {v2}, Lua/b;->e()I
    ...
    iget v2, p0, Lua/c;->l:I

    goto :goto_3

    :cond_4
    iget v2, p0, Lua/c;->m:I
    ...
    iget-object v2, p0, Lua/c;->k:Landroid/util/SizeF;
    ...
    iget-object v2, p0, Lua/c;->y:Lcom/arcsoft/camera/wideselfie/WideSelfieCallback;
