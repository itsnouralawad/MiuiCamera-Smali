...
.method public constructor <init>(Lcom/airbnb/lottie/LottieAnimationView;)V
    ...
    iput-object v0, p0, Lv7/c;->c:Landroid/graphics/RectF;

    const/4 v0, 0x1

    iput-boolean v0, p0, Lv7/c;->e:Z

    iput-object p1, p0, Lv7/c;->a:Lcom/airbnb/lottie/LottieAnimationView;
    ...
    invoke-direct {v0, p0}, Lv7/c$b;-><init>(Lv7/c;)V
...
.method public final a()F
    ...
    iget-object v0, p0, Lv7/c;->b:Landroid/graphics/RectF;

    invoke-virtual {v0}, Landroid/graphics/RectF;->height()F

    move-result v0

    iget-object v1, p0, Lv7/c;->b:Landroid/graphics/RectF;
    ...
    iget-object v1, p0, Lv7/c;->d:Landroid/util/Size;

    invoke-virtual {v1}, Landroid/util/Size;->getWidth()I

    move-result v1

    iget-object p0, p0, Lv7/c;->d:Landroid/util/Size;
...
.method public final b()Z
    ...
    iget-object p0, p0, Lv7/c;->b:Landroid/graphics/RectF;
...
.method public c()Z
    ...
    iget-object p0, p0, Lv7/c;->a:Lcom/airbnb/lottie/LottieAnimationView;
...
.method public final d([Lya/f3;Landroid/graphics/Rect;)V
    .locals 2
    ...
    iput-object v0, p0, Lv7/c;->b:Landroid/graphics/RectF;

    iget-object p1, p0, Lv7/c;->d:Landroid/util/Size;

    invoke-virtual {p1}, Landroid/util/Size;->getWidth()I

    move-result p1

    iget-object v0, p0, Lv7/c;->d:Landroid/util/Size;
    ...
    iget-object p1, p0, Lv7/c;->b:Landroid/graphics/RectF;
    ...
    iget-object p1, p0, Lv7/c;->c:Landroid/graphics/RectF;

    iget-object v0, p0, Lv7/c;->b:Landroid/graphics/RectF;

    invoke-virtual {p1, v0}, Landroid/graphics/RectF;->set(Landroid/graphics/RectF;)V

    iget-object p0, p0, Lv7/c;->c:Landroid/graphics/RectF;
...
.method public f()V
    ...
    iget-object v0, p0, Lv7/c;->a:Lcom/airbnb/lottie/LottieAnimationView;
    ...
    invoke-virtual {p0, v0}, Lv7/c;->g(I)V
...
.method public i([Lya/f3;Landroid/graphics/Rect;Lv7/e;Landroid/content/Context;)V
    .locals 0

    check-cast p4, Lcom/android/camera/ActivityBase;

    invoke-virtual {p4}, Lcom/android/camera/ActivityBase;->W()Lcom/android/camera/s2;

    move-result-object p4

    invoke-virtual {p4}, Lcom/android/camera/f5;->l()Landroid/util/Size;

    move-result-object p4

    iput-object p4, p0, Lv7/c;->d:Landroid/util/Size;

    invoke-virtual {p0, p1, p2}, Lv7/c;->d([Lya/f3;Landroid/graphics/Rect;)V

    invoke-virtual {p3}, Lv7/e;->a()I

    move-result p1

    invoke-virtual {p0, p1}, Lv7/c;->j(I)V
...
.method public final j(I)V
    ...
    iget-object v1, p0, Lv7/c;->c:Landroid/graphics/RectF;
    ...
    iget-object v1, p0, Lv7/c;->a:Lcom/airbnb/lottie/LottieAnimationView;
