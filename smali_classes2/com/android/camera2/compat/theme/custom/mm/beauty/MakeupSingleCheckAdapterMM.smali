...
# instance fields
.field private mComponentRunningShine:Lm2/t0;
...
.method public constructor <init>(Landroid/content/Context;Ljava/util/List;Ljava/util/List;III)V
    ...
    .line 4
    invoke-interface {p1}, Lv8/n1;->j9()Lm2/t0;

    move-result-object p1

    iput-object p1, p0, Lcom/android/camera2/compat/theme/custom/mm/beauty/MakeupSingleCheckAdapterMM;->mComponentRunningShine:Lm2/t0;
...
.method public onBindViewHolder(Lcom/android/camera/fragment/beauty/MakeupSingleCheckAdapter$SingleCheckViewHolder;I)V
    ...
    iget-object p0, p0, Lcom/android/camera2/compat/theme/custom/mm/beauty/MakeupSingleCheckAdapterMM;->mComponentRunningShine:Lm2/t0;

    invoke-virtual {p0}, Lm2/t0;->b0()Z
