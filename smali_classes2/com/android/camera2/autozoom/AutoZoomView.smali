...
# static fields
.field public static final u:Ljava/lang/String; = "AutoZoomView"
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    .line 7
    iput-boolean p2, p0, Lcom/android/camera2/autozoom/AutoZoomView;->s:Z
    ...
    .line 9
    invoke-virtual {p0}, Lcom/android/camera2/autozoom/AutoZoomView;->i()V
...
.method public O(Lab/a;)V
    ...
    :cond_2
    invoke-virtual {p1}, Lab/a;->b()[F

    move-result-object v0

    if-eqz v0, :cond_6

    invoke-virtual {p1}, Lab/a;->h()I
    ...
    invoke-virtual {p1}, Lab/a;->c()[F

    move-result-object v7

    invoke-virtual {p0, v4, v7}, Lcom/android/camera2/autozoom/AutoZoomView;->g(I[F)Landroid/graphics/RectF;

    move-result-object v7

    invoke-direct {v6, v5, v7}, Lab/b;-><init>(ILandroid/graphics/RectF;)V
    ...
    invoke-virtual {p1}, Lab/a;->g()[I

    move-result-object p1

    iput-object p1, p0, Lcom/android/camera2/autozoom/AutoZoomView;->j:[I

    invoke-virtual {p0, v3, v0}, Lcom/android/camera2/autozoom/AutoZoomView;->g(I[F)Landroid/graphics/RectF;

    move-result-object p1

    iput-object p1, p0, Lcom/android/camera2/autozoom/AutoZoomView;->g:Landroid/graphics/RectF;

    invoke-static {}, Lv8/i;->impl2()Lv8/i;

    move-result-object p1

    invoke-virtual {p0}, Lcom/android/camera2/autozoom/AutoZoomView;->k()Z
    ...
    invoke-interface {p1}, Lv8/i;->H8()V

    :cond_4
    invoke-virtual {p0}, Lcom/android/camera2/autozoom/AutoZoomView;->j()Z
    ...
    invoke-interface {p1}, Lv8/i;->Q6()V
...
.method public final g(I[F)Landroid/graphics/RectF;
    .locals 5
    ...
    invoke-static {v2}, Lab/c;->b(Landroid/graphics/RectF;)V

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object p1

    invoke-static {p1, v2}, Lab/c;->g(Landroid/content/Context;Landroid/graphics/RectF;)V
    ...
    invoke-static {v2, p1}, Lab/c;->f(Landroid/graphics/RectF;Landroid/util/Size;)V
...
.method public final i()V
    ...
    invoke-static {v0, v2}, Lab/c;->a(Landroid/content/Context;F)I
    ...
    iput-boolean v0, p0, Lcom/android/camera2/autozoom/AutoZoomView;->t:Z
...
.method public final j()Z
    ...
    invoke-virtual {p0}, Lcom/android/camera2/autozoom/AutoZoomView;->R()Z
...
.method public m(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/camera2/autozoom/AutoZoomView;->n(FF)V
...
.method public final n(FF)V
    ...
    invoke-interface {v0, v2}, Lv8/i;->cd(I)V

    :cond_3
    invoke-virtual {p0, p1, p2}, Lcom/android/camera2/autozoom/AutoZoomView;->h(FF)Landroid/graphics/RectF;
    ...
    invoke-static {p2, p1}, Lab/c;->h(Landroid/content/Context;Landroid/graphics/RectF;)V

    invoke-static {p1}, Lab/c;->i(Landroid/graphics/RectF;)V

    iget-object p2, p0, Lcom/android/camera2/autozoom/AutoZoomView;->o:Landroid/util/Size;

    invoke-static {p1, p2}, Lab/c;->f(Landroid/graphics/RectF;Landroid/util/Size;)V
    ...
    invoke-virtual {p0}, Lcom/android/camera2/autozoom/AutoZoomView;->S()Z
    ...
    :cond_4
    invoke-interface {p2, p1}, Lv8/j;->id(Landroid/graphics/RectF;)V
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v2, p0, Lcom/android/camera2/autozoom/AutoZoomView;->s:Z
    ...
    iget-boolean v0, p0, Lcom/android/camera2/autozoom/AutoZoomView;->s:Z
...
.method public onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    invoke-virtual {p0, p2}, Lcom/android/camera2/autozoom/AutoZoomView;->m(Landroid/view/MotionEvent;)Z
...
.method public setVideoCastLayoutType(I)V
    ...
    :goto_0
    iput-boolean p1, p0, Lcom/android/camera2/autozoom/AutoZoomView;->s:Z
    ...
    iget-boolean v1, p0, Lcom/android/camera2/autozoom/AutoZoomView;->s:Z
