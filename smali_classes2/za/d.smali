...
.method public i1(Lza/a$c;)V
    ...
    iget-object v3, p0, Lya/x4;->z:Landroid/util/Size;
    ...
    invoke-virtual {p0, p1, v1}, Lya/x4;->O(Landroid/util/Size;I)Lcom/xiaomi/engine/BufferFormat;
    ...
    invoke-virtual {p1}, Lya/j5;->b0()Landroid/view/Surface;
    ...
    iget-boolean p1, p1, Lya/s5$b;->m:Z
    ...
    invoke-virtual {p0, v2, p1, v1, v0}, Lya/x4;->N(ILandroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;
    ...
    invoke-virtual {p0, p1, v1, v0}, Lya/x4;->P(Landroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;
...
.method public p1()Lza/a$d;
    ...
    iget-object v2, v1, Lya/s5;->g:Lya/s5$b;

    iget-boolean v2, v2, Lya/s5$b;->h:Z

    if-nez v2, :cond_0

    invoke-virtual {v1}, Lya/s5;->e()I
...
.method public s1()Z
    ...
    iget-boolean v0, p0, Lya/q4;->q:Z

    if-eqz v0, :cond_0

    iget v0, p0, Lza/a;->Q:I
...
.method public t1(Lwe/w;)V
    ...
    invoke-super {p0, p1}, Lza/a;->t1(Lwe/w;)V

    invoke-static {}, Lcom/android/camera/u2;->y3()Z

    move-result p0

    invoke-virtual {p1, p0}, Lwe/w;->L0(Z)V
...
.method public v1(Lza/a$c;)V
    ...
    invoke-static {v0, p1, v4}, Lya/i3;->q1(Landroid/hardware/camera2/CaptureRequest$Builder;Lya/f;Z)V
    ...
    invoke-static {v0, p1, v4}, Lya/i3;->f1(Landroid/hardware/camera2/CaptureRequest$Builder;Lya/f;Z)V
    ...
    iget-boolean v1, p1, Lya/s5$b;->e:Z

    if-eqz v1, :cond_3

    iget p1, p1, Lya/s5$b;->c:I
    ...
    invoke-virtual {p1}, Lya/c4;->L()Lya/f;

    move-result-object p1

    invoke-static {p1}, Lya/g;->c3(Lya/f;)Z
    ...
    iget-boolean p1, p1, Lya/s5$b;->e:Z
...
.method public x1()Lza/a$d;
    ...
    invoke-virtual {v2, v6, v4}, Lya/j5;->s(IZ)Landroid/view/Surface;
    ...
    invoke-virtual {v6, v7, v4}, Lya/j5;->t(IZ)I

    move-result v6

    iput v6, p0, Lza/a;->K:I
    ...
    invoke-virtual {v2, v6, v4}, Lya/j5;->E(IZ)Landroid/view/Surface;
    ...
    invoke-virtual {v6, v4, v7}, Lya/j5;->F(ZI)I
