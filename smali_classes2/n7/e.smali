...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Ln7/e;->l:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/SurfaceView;Landroid/widget/Button;Landroid/widget/ImageView;)V
    ...
    iput-object v0, p0, Ln7/e;->h:Landroid/os/Handler;

    new-instance v0, Ln7/b;

    invoke-direct {v0, p0}, Ln7/b;-><init>(Ln7/e;)V

    iput-object v0, p0, Ln7/e;->k:Ljava/lang/Runnable;

    iput-object p1, p0, Ln7/e;->c:Landroid/content/Context;

    iput-object p2, p0, Ln7/e;->d:Landroid/view/SurfaceView;

    iput-object p3, p0, Ln7/e;->e:Landroid/widget/Button;

    iput-object p4, p0, Ln7/e;->f:Landroid/widget/ImageView;

    return-void
.end method

.method public static synthetic a(Ln7/e;F)V
    .locals 0

    invoke-direct {p0, p1}, Ln7/e;->n(F)V

    return-void
.end method

.method public static synthetic b(Ln7/e;)V
    .locals 0

    invoke-direct {p0}, Ln7/e;->m()V
...
.method public static synthetic c(Lcom/android/camera/litegallery/a;)Ljava/lang/Boolean;
    ...
    invoke-static {p0}, Ln7/e;->k(Lcom/android/camera/litegallery/a;)Ljava/lang/Boolean;
...
.method public static synthetic d(Ln7/e;)V
    .locals 0

    invoke-direct {p0}, Ln7/e;->l()V
...
.method private synthetic m()V
    ...
    sget-object v0, Ln7/e;->l:Ljava/lang/String;
    ...
    iget-object v0, p0, Ln7/e;->h:Landroid/os/Handler;

    new-instance v1, Ln7/d;

    invoke-direct {v1, p0}, Ln7/d;-><init>(Ln7/e;)V
...
.method private synthetic n(F)V
    .locals 1
    ...
    iget-object p0, p0, Ln7/e;->a:Lcom/google/android/exoplayer2/ExoPlayer;
    ...
    sget-object p0, Ln7/e;->l:Ljava/lang/String;
...
.method public e()V
    ...
    iget-object v0, p0, Ln7/e;->a:Lcom/google/android/exoplayer2/ExoPlayer;

    const/4 v1, 0x1

    if-nez v0, :cond_0

    iget-object v0, p0, Ln7/e;->b:Lcom/android/camera/litegallery/a;

    invoke-virtual {p0, v0, v1}, Ln7/e;->g(Lcom/android/camera/litegallery/a;Z)V
    ...
    iget-object v3, p0, Ln7/e;->a:Lcom/google/android/exoplayer2/ExoPlayer;
    ...
    invoke-virtual {p0, v1}, Ln7/e;->x(Z)V
    ...
    invoke-virtual {p0, v3}, Ln7/e;->x(Z)V
...
.method public final f()V
    ...
    iget-object v0, p0, Ln7/e;->d:Landroid/view/SurfaceView;

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Landroid/view/SurfaceView;->setVisibility(I)V

    iget-object p0, p0, Ln7/e;->f:Landroid/widget/ImageView;
...
.method public final g(Lcom/android/camera/litegallery/a;Z)V
    ...
    invoke-virtual {p0, p1}, Ln7/e;->i(Lcom/android/camera/litegallery/a;)Z
    ...
    :cond_0
    invoke-virtual {p1, v1}, Lcom/android/camera/litegallery/a;->Q(Z)V

    invoke-virtual {p1}, Lcom/android/camera/litegallery/a;->s()F

    move-result p2

    invoke-virtual {p0, p2}, Ln7/e;->j(F)Z
    ...
    invoke-virtual {p0, v0, p2}, Ln7/e;->r(Landroid/net/Uri;F)V

    goto :goto_0

    :cond_1
    invoke-virtual {p0, v0}, Ln7/e;->s(Landroid/net/Uri;)V

    :goto_0
    const/4 p1, 0x1

    invoke-virtual {p0, p1}, Ln7/e;->x(Z)V

    goto :goto_2

    :cond_2
    :goto_1
    invoke-virtual {p0}, Ln7/e;->u()V
...
.method public final h()V
    ...
    sget-object v2, Ln7/e;->l:Ljava/lang/String;
    ...
    iget-wide v2, p0, Ln7/e;->g:J

    sub-long/2addr v2, v0

    invoke-virtual {p0, v2, v3}, Ln7/e;->v(J)V
...
.method public final o(Lcom/android/camera/litegallery/a;)V
    .locals 5

    sget-object p1, Ln7/e;->l:Ljava/lang/String;
...
.method public onEvents(Lcom/google/android/exoplayer2/Player;Lcom/google/android/exoplayer2/Player$Events;)V
    ...
    invoke-virtual {p0}, Ln7/e;->release()V
    ...
    iget-object v1, p0, Ln7/e;->i:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    invoke-direct {v1, v3}, Lcom/android/camera/x3;-><init>(Ljava/lang/String;)V

    invoke-static {v1}, Ljava/util/concurrent/Executors;->newSingleThreadScheduledExecutor(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ScheduledExecutorService;

    move-result-object v1

    iput-object v1, p0, Ln7/e;->i:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    iget-object v3, p0, Ln7/e;->j:Ljava/util/concurrent/ScheduledFuture;
    ...
    :cond_8
    :goto_0
    iget-object v4, p0, Ln7/e;->i:Ljava/util/concurrent/ScheduledExecutorService;

    iget-object v3, p0, Ln7/e;->k:Ljava/lang/Runnable;
    ...
    iput-object v3, p0, Ln7/e;->j:Ljava/util/concurrent/ScheduledFuture;
    ...
    iget-object v1, p0, Ln7/e;->j:Ljava/util/concurrent/ScheduledFuture;
    ...
    iget-object p0, p0, Ln7/e;->j:Ljava/util/concurrent/ScheduledFuture;
...
.method public r(Landroid/net/Uri;F)V
    .locals 3
    ...
    iget-object v1, p0, Ln7/e;->c:Landroid/content/Context;
    ...
    iput-object v0, p0, Ln7/e;->a:Lcom/google/android/exoplayer2/ExoPlayer;

    iget-object v1, p0, Ln7/e;->d:Landroid/view/SurfaceView;
    ...
    iget-object p1, p0, Ln7/e;->a:Lcom/google/android/exoplayer2/ExoPlayer;
    ...
    iget-object p1, p0, Ln7/e;->d:Landroid/view/SurfaceView;

    new-instance v0, Ln7/a;

    invoke-direct {v0, p0, p2}, Ln7/a;-><init>(Ln7/e;F)V
...
.method public release()V
    ...
    :cond_0
    :goto_0
    iget-object p0, p0, Ln7/e;->i:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public t(Lcom/android/camera/litegallery/a;)V
    .locals 5
    ...
    :cond_0
    iput-object p1, p0, Ln7/e;->b:Lcom/android/camera/litegallery/a;

    invoke-virtual {p1}, Lcom/android/camera/litegallery/a;->p()J

    move-result-wide v2

    iput-wide v2, p0, Ln7/e;->g:J
    ...
    invoke-virtual {p1}, Lcom/android/camera/litegallery/a;->G()Z

    move-result v0

    invoke-virtual {p0, p1, v0}, Ln7/e;->g(Lcom/android/camera/litegallery/a;Z)V

    iget-wide v0, p0, Ln7/e;->g:J

    invoke-virtual {p0, v0, v1}, Ln7/e;->v(J)V
...
.method public u()V
    ...
    iget-object v0, p0, Ln7/e;->f:Landroid/widget/ImageView;

    invoke-virtual {v0, v2}, Landroid/widget/ImageView;->setVisibility(I)V

    iget-object v0, p0, Ln7/e;->b:Lcom/android/camera/litegallery/a;

    iget-object v1, p0, Ln7/e;->f:Landroid/widget/ImageView;

    const/4 v3, 0x1

    invoke-static {v0, v1, v3}, Lcom/android/camera/litegallery/c;->M(Lcom/android/camera/litegallery/a;Landroid/widget/ImageView;Z)V

    iget-wide v0, p0, Ln7/e;->g:J

    invoke-virtual {p0, v0, v1}, Ln7/e;->v(J)V

    invoke-virtual {p0, v2}, Ln7/e;->x(Z)V
...
.method public final v(J)V
    ...
    sget-object v1, Ln7/e;->l:Ljava/lang/String;
    ...
    iget-object p1, p0, Ln7/e;->e:Landroid/widget/Button;

    invoke-virtual {p1, p2}, Landroid/view/View;->setVisibility(I)V

    iget-object p0, p0, Ln7/e;->e:Landroid/widget/Button;
...
.method public final w(Lcom/google/android/exoplayer2/Timeline;)V
    .locals 6
...
.method public final x(Z)V
    ...
    iget-object p1, p0, Ln7/e;->c:Landroid/content/Context;
