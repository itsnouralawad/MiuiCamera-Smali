...
.method public constructor <init>(Landroid/opengl/EGLContext;ZZ)V
    ...
    iput-object v0, p0, Ls7/a;->a:Landroid/opengl/EGLConfig;

    sget-object v0, Landroid/opengl/EGL14;->EGL_NO_CONTEXT:Landroid/opengl/EGLContext;

    iput-object v0, p0, Ls7/a;->b:Landroid/opengl/EGLContext;

    sget-object v0, Landroid/opengl/EGL14;->EGL_NO_DISPLAY:Landroid/opengl/EGLDisplay;

    iput-object v0, p0, Ls7/a;->c:Landroid/opengl/EGLDisplay;

    sget-object v0, Landroid/opengl/EGL14;->EGL_NO_CONTEXT:Landroid/opengl/EGLContext;

    iput-object v0, p0, Ls7/a;->d:Landroid/opengl/EGLContext;

    const-string v0, "EGLBase"

    invoke-static {v0, v0}, Lcom/android/camera/log/Log;->v(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, p1, p2, p3}, Ls7/a;->s(Landroid/opengl/EGLContext;ZZ)V

    return-void
.end method

.method public static synthetic a(Ls7/a;Ljava/lang/Object;)Landroid/opengl/EGLSurface;
    .locals 0

    invoke-virtual {p0, p1}, Ls7/a;->m(Ljava/lang/Object;)Landroid/opengl/EGLSurface;
...
.method public static synthetic b(Ls7/a;II)Landroid/opengl/EGLSurface;
    .locals 0

    invoke-virtual {p0, p1, p2}, Ls7/a;->l(II)Landroid/opengl/EGLSurface;
...
.method public static synthetic c(Ls7/a;Landroid/opengl/EGLSurface;)Z
    .locals 0

    invoke-virtual {p0, p1}, Ls7/a;->t(Landroid/opengl/EGLSurface;)Z
...
.method public static synthetic d(Ls7/a;Landroid/opengl/EGLSurface;)I
    .locals 0

    invoke-virtual {p0, p1}, Ls7/a;->x(Landroid/opengl/EGLSurface;)I
...
.method public static synthetic e(Ls7/a;Landroid/opengl/EGLSurface;)V
    .locals 0

    invoke-virtual {p0, p1}, Ls7/a;->p(Landroid/opengl/EGLSurface;)V
...
.method public final f()V
    ...
    iget-object p0, p0, Ls7/a;->c:Landroid/opengl/EGLDisplay;
...
.method public final h(ZLjava/lang/String;)V
    ...
    :cond_0
    new-instance p0, Ls7/a$a;

    invoke-direct {p0, p2}, Ls7/a$a;-><init>(Ljava/lang/String;)V
...
.method public final i(Landroid/opengl/EGLContext;)Landroid/opengl/EGLContext;
    ...
    iget-object v1, p0, Ls7/a;->c:Landroid/opengl/EGLDisplay;

    iget-object v2, p0, Ls7/a;->a:Landroid/opengl/EGLConfig;
    ...
    invoke-virtual {p0, v0}, Ls7/a;->g(Ljava/lang/String;)V
...
.method public j(Ljava/lang/Object;)Ls7/a$b;
    .locals 2
    ...
    invoke-direct {v0, p0, p1}, Ls7/a$b;-><init>(Ls7/a;Ljava/lang/Object;)V

    invoke-virtual {v0}, Ls7/a$b;->e()V

    return-object v0
.end method

.method public k(II)Ls7/a$b;
    .locals 2
    .annotation build Lh7/c;
    .end annotation
    ...
    invoke-direct {v0, p0, p1, p2}, Ls7/a$b;-><init>(Ls7/a;II)V
...
.method public final l(II)Landroid/opengl/EGLSurface;
    ...
    :try_start_0
    iget-object p2, p0, Ls7/a;->c:Landroid/opengl/EGLDisplay;

    iget-object v5, p0, Ls7/a;->a:Landroid/opengl/EGLConfig;
    ...
    invoke-virtual {p0, p2}, Ls7/a;->g(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v4, p2}, Ls7/a;->h(ZLjava/lang/String;)V
    :try_end_0
...
.method public final m(Ljava/lang/Object;)Landroid/opengl/EGLSurface;
    ...
    :try_start_0
    iget-object v2, p0, Ls7/a;->c:Landroid/opengl/EGLDisplay;

    iget-object p0, p0, Ls7/a;->a:Landroid/opengl/EGLConfig;
...
.method public final n()V
    ...
    iget-object v0, p0, Ls7/a;->c:Landroid/opengl/EGLDisplay;

    iget-object v2, p0, Ls7/a;->b:Landroid/opengl/EGLContext;
...
.method public final o()V
    ...
    iget-object v0, p0, Ls7/a;->d:Landroid/opengl/EGLContext;
    ...
    iget-object v1, p0, Ls7/a;->d:Landroid/opengl/EGLContext;
...
.method public r()Landroid/opengl/EGLContext;
    ...
    iget-object p0, p0, Ls7/a;->b:Landroid/opengl/EGLContext;
...
.method public final s(Landroid/opengl/EGLContext;ZZ)V
    ...
    iput-object v2, p0, Ls7/a;->c:Landroid/opengl/EGLDisplay;
    ...
    invoke-virtual {p0, v2, v3}, Ls7/a;->h(ZLjava/lang/String;)V

    const/4 v2, 0x2

    new-array v2, v2, [I

    iget-object v3, p0, Ls7/a;->c:Landroid/opengl/EGLDisplay;
    ...
    invoke-virtual {p0, p2, p3}, Ls7/a;->q(ZZ)Landroid/opengl/EGLConfig;

    move-result-object p2

    iput-object p2, p0, Ls7/a;->a:Landroid/opengl/EGLConfig;
    ...
    invoke-virtual {p0, p2, p3}, Ls7/a;->h(ZLjava/lang/String;)V

    invoke-virtual {p0, p1}, Ls7/a;->i(Landroid/opengl/EGLContext;)Landroid/opengl/EGLContext;

    move-result-object p1

    iput-object p1, p0, Ls7/a;->b:Landroid/opengl/EGLContext;
    ...
    iget-object p3, p0, Ls7/a;->b:Landroid/opengl/EGLContext;
