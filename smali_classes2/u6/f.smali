...
# direct methods
.method public constructor <init>(Lu6/f$a;)V
    .locals 0
    ...
    invoke-direct {p1, p0}, Lu6/e;-><init>(Lu6/f;)V

    iput-object p1, p0, Lu6/f;->C:Landroid/view/View$OnClickListener;

    invoke-static {}, Lcom/android/camera/CameraAppImpl;->o()Landroid/content/Context;

    move-result-object p1

    iput-object p1, p0, Lu6/f;->z:Landroid/content/Context;

    iget-object p1, p0, Lu6/f;->C:Landroid/view/View$OnClickListener;

    iput-object p1, p0, Lu6/b;->a:Landroid/view/View$OnClickListener;

    const/4 p1, 0x4

    iput p1, p0, Lu6/f;->y:I
...
.method private synthetic C(Landroid/view/View;)V
    ...
    invoke-interface {v4, v5}, Lv8/y;->d4(I)V

    :cond_1
    if-eqz v1, :cond_2

    invoke-virtual {p0, p1}, Lu6/f;->z(Landroid/view/View;)V
    ...
    :cond_2
    invoke-virtual {p0, p1}, Lu6/f;->I(Landroid/view/View;)V

    iput v3, p0, Lu6/f;->y:I

    :goto_1
    xor-int/lit8 p1, v1, 0x1

    invoke-virtual {v0, p1}, Lu6/c;->t(Z)V

    iput-boolean v2, p0, Lu6/f;->A:Z

    return-void
.end method

.method public static synthetic x(Lu6/f;Landroid/view/View;)V
    .locals 0

    invoke-direct {p0, p1}, Lu6/f;->C(Landroid/view/View;)V
...
.method public D(Landroid/view/View;)V
    ...
    iget-object v1, p0, Lu6/f;->z:Landroid/content/Context;
    ...
    iget-object p0, p0, Lu6/f;->z:Landroid/content/Context;
...
.method public final I(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1, v2}, Lu6/f;->K(Landroid/view/View;Z)V
    ...
    invoke-virtual/range {p0 .. p0}, Lu6/f;->A()Z
    ...
    iget-object v14, v0, Lu6/f;->z:Landroid/content/Context;

    invoke-virtual {v14}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v14

    const v15, 0x7f07072b
    ...
    iget-object v15, v0, Lu6/f;->z:Landroid/content/Context;
    ...
    invoke-virtual/range {p0 .. p0}, Lu6/f;->B()Z
...
.method public J(Landroid/view/View;Ljava/lang/Object;I)V
    ...
    iget-object p2, p0, Lu6/f;->z:Landroid/content/Context;
    ...
    iput-boolean v3, p0, Lu6/f;->A:Z

    :cond_2
    invoke-virtual {v0}, Lu6/b;->h()Z

    move-result p2

    invoke-virtual {p0, p1, p2}, Lu6/f;->K(Landroid/view/View;Z)V
    ...
    :cond_3
    invoke-virtual {v0, v3}, Lu6/c;->t(Z)V

    iget p2, p0, Lu6/f;->y:I
    ...
    invoke-virtual {p0, p1}, Lu6/f;->H(Landroid/view/View;)V
...
.method public final z(Landroid/view/View;)V
    ...
    iget-object v13, v0, Lu6/f;->z:Landroid/content/Context;

    invoke-virtual {v13}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v13

    const v14, 0x7f070cd8
