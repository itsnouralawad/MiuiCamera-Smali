...
.method public static a(Landroid/content/Context;IZ)Landroid/widget/FrameLayout$LayoutParams;
    ...
    invoke-static {p0, p2}, La6/c;->g(Landroid/content/Context;Z)Landroid/widget/FrameLayout$LayoutParams;
    ...
    :pswitch_0
    invoke-static {p0, p2}, La6/c;->f(Landroid/content/Context;Z)Landroid/widget/FrameLayout$LayoutParams;
    ...
    :pswitch_1
    invoke-static {p0, p2}, La6/c;->d(Landroid/content/Context;Z)Landroid/widget/FrameLayout$LayoutParams;
    ...
    :pswitch_2
    invoke-static {p0, p2}, La6/c;->b(Landroid/content/Context;Z)Landroid/widget/FrameLayout$LayoutParams;
    ...
    :pswitch_3
    invoke-static {p0, p2}, La6/c;->c(Landroid/content/Context;Z)Landroid/widget/FrameLayout$LayoutParams;
    ...
    :pswitch_4
    invoke-static {p0, p2}, La6/c;->h(Landroid/content/Context;Z)Landroid/widget/FrameLayout$LayoutParams;
    ...
    :pswitch_5
    invoke-static {p0, p2}, La6/c;->i(Landroid/content/Context;Z)Landroid/widget/FrameLayout$LayoutParams;
    ...
    :pswitch_6
    invoke-static {p0, p2}, La6/c;->e(Landroid/content/Context;Z)Landroid/widget/FrameLayout$LayoutParams;
