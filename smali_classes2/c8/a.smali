...
.method public constructor <init>(JI)V
    ...
    iput-wide p1, p0, Lc8/a;->a:J

    iput p3, p0, Lc8/a;->c:I

    new-instance p1, Ljava/util/LinkedList;

    invoke-direct {p1}, Ljava/util/LinkedList;-><init>()V

    iput-object p1, p0, Lc8/a;->e:Ljava/util/List;
...
.method public declared-synchronized a(Ljava/lang/Runnable;Ljava/lang/Runnable;Landroid/os/Handler;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lc8/a;->b(Ljava/lang/Runnable;Ljava/lang/Runnable;Lio/reactivex/Scheduler;)V
    :try_end_0
...
.method public declared-synchronized b(Ljava/lang/Runnable;Ljava/lang/Runnable;Lio/reactivex/Scheduler;)V
    ...
    invoke-static {p3, p1}, Ldg/i;->r(Lio/reactivex/Scheduler;Ljava/lang/Runnable;)Lio/reactivex/disposables/Disposable;
    ...
    invoke-static {p3, p2}, Ldg/i;->r(Lio/reactivex/Scheduler;Ljava/lang/Runnable;)Lio/reactivex/disposables/Disposable;
    ...
    :cond_3
    iget-object v0, p0, Lc8/a;->e:Ljava/util/List;

    new-instance v1, Lc8/a$a;

    invoke-direct {v1, p1, p2, p3}, Lc8/a$a;-><init>(Ljava/lang/Runnable;Ljava/lang/Runnable;Lio/reactivex/Scheduler;)V
...
.method public declared-synchronized f(J)V
    ...
    iget-object p1, p0, Lc8/a;->e:Ljava/util/List;
    ...
    iget-object v1, v0, Lc8/a$a;->c:Lio/reactivex/Scheduler;

    if-eqz v1, :cond_2

    iget-object v0, v0, Lc8/a$a;->b:Ljava/lang/Runnable;

    if-eqz v0, :cond_1

    invoke-static {v1, v0}, Ldg/i;->r(Lio/reactivex/Scheduler;Ljava/lang/Runnable;)Lio/reactivex/disposables/Disposable;
...
.method public declared-synchronized g(J)V
    ...
    iget-object v0, v0, Lc8/a$a;->a:Ljava/lang/Runnable;
