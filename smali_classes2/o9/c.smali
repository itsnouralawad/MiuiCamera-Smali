...
# static fields
.field public static final j:Ljava/lang/String; = "VideoFile"
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lo9/c;->h:Landroid/os/ParcelFileDescriptor;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, Lo9/c;->i:Ljava/util/Set;

    iput-object p1, p0, Lo9/c;->c:Landroid/content/Context;
...
# virtual methods
.method public declared-synchronized a(Li7/c$b;)V
    .locals 1

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Lo9/c;->i:Ljava/util/Set;
...
.method public b()V
    ...
    iget-object v0, p0, Lo9/c;->g:Ljava/lang/String;
    ...
    iget-object v1, p0, Lo9/c;->g:Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, p0, Lo9/c;->b:Landroid/os/ParcelFileDescriptor;

    invoke-static {v0}, Lip/g;->a(Ljava/io/Closeable;)V

    const/4 v0, 0x0

    iput-object v0, p0, Lo9/c;->b:Landroid/os/ParcelFileDescriptor;

    invoke-virtual {p0}, Lo9/c;->c()V

    iput-object v0, p0, Lo9/c;->a:Landroid/net/Uri;

    iget-object v1, p0, Lo9/c;->d:Landroid/content/ContentValues;
    ...
    :cond_1
    iput-object v0, p0, Lo9/c;->d:Landroid/content/ContentValues;
...
.method public final c()V
    ...
    iget-object v0, p0, Lo9/c;->a:Landroid/net/Uri;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lo9/c;->c:Landroid/content/Context;

    invoke-virtual {v0}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v0

    iget-object v1, p0, Lo9/c;->a:Landroid/net/Uri;

    invoke-static {v0, v1}, Lo9/c;->q(Landroid/content/ContentResolver;Landroid/net/Uri;)J
    ...
    iget-object p0, p0, Lo9/c;->a:Landroid/net/Uri;
...
.method public d()V
    ...
    iget-object v0, p0, Lo9/c;->h:Landroid/os/ParcelFileDescriptor;
...
.method public e()Landroid/content/ContentValues;
    ...
    iget-object p0, p0, Lo9/c;->d:Landroid/content/ContentValues;
...
.method public f()Ljava/io/FileDescriptor;
    ...
    invoke-virtual {p0}, Lo9/c;->i()Landroid/os/ParcelFileDescriptor;
...
.method public g()Ljava/lang/String;
    ...
    invoke-static {v0, p0}, Lo9/c;->p(Landroid/content/ContentResolver;Landroid/net/Uri;)Ljava/lang/String;
...
.method public i()Landroid/os/ParcelFileDescriptor;
    ...
    invoke-virtual {p0}, Lo9/c;->h()Landroid/net/Uri;

    move-result-object p0

    invoke-static {v0, p0}, Lcom/android/camera/z5;->D1(Ljava/lang/String;Landroid/net/Uri;)Landroid/os/ParcelFileDescriptor;
...
.method public declared-synchronized j()Ljava/util/Set;
    ...
    iget-object v1, p0, Lo9/c;->i:Ljava/util/Set;
...
.method public k(ZLandroid/content/Intent;)V
    ...
    invoke-virtual {p0, p2}, Lo9/c;->o(Landroid/content/Intent;)V
...
.method public l()Landroid/net/Uri;
    ...
    iget-object v4, p0, Lo9/c;->d:Landroid/content/ContentValues;
    ...
    iget-object v5, p0, Lo9/c;->d:Landroid/content/ContentValues;
    ...
    invoke-static {v5}, Lm7/a;->y(Ljava/lang/String;)Z
    ...
    :cond_1
    invoke-virtual {p0, v4}, Lo9/c;->m(Landroid/content/ContentValues;)Z
    ...
    :cond_2
    iget-object v1, p0, Lo9/c;->c:Landroid/content/Context;

    const/4 v6, 0x1

    invoke-static {v1, v6, v5}, Ll9/x;->B(Landroid/content/Context;ZLjava/lang/String;)Landroid/net/Uri;
...
.method public final m(Landroid/content/ContentValues;)Z
    .locals 2
    .annotation build Lh7/c;
    .end annotation
...
.method public n()Z
    ...
    iget-object p0, p0, Lo9/c;->f:Landroid/os/ParcelFileDescriptor;
...
.method public final o(Landroid/content/Intent;)V
    ...
    iput-object p1, p0, Lo9/c;->e:Landroid/net/Uri;
    ...
    iget-object v2, p0, Lo9/c;->e:Landroid/net/Uri;
    ...
    iput-object v1, p0, Lo9/c;->f:Landroid/os/ParcelFileDescriptor;
    ...
    iget-object p0, p0, Lo9/c;->e:Landroid/net/Uri;
...
.method public r(Landroid/content/ContentValues;)V
    ...
    iput-object p1, p0, Lo9/c;->d:Landroid/content/ContentValues;
...
.method public t(Landroid/media/MediaRecorder;Z)V
    ...
    :cond_0
    iget-object v3, p0, Lo9/c;->d:Landroid/content/ContentValues;
    ...
    iput-object p2, p0, Lo9/c;->g:Ljava/lang/String;
    ...
    iget-object v2, p0, Lo9/c;->g:Ljava/lang/String;
    ...
    iget-object p0, p0, Lo9/c;->g:Ljava/lang/String;
    ...
    :cond_2
    iget-object p2, p0, Lo9/c;->d:Landroid/content/ContentValues;
    ...
    iget-object v3, p0, Lo9/c;->c:Landroid/content/Context;
    ...
    invoke-static {v2, v5, p2}, Ll9/x;->B(Landroid/content/Context;ZLjava/lang/String;)Landroid/net/Uri;
    ...
    iput-object v2, p0, Lo9/c;->a:Landroid/net/Uri;
    ...
    iget-object v4, p0, Lo9/c;->a:Landroid/net/Uri;
    ...
    :try_start_0
    iget-object v2, p0, Lo9/c;->a:Landroid/net/Uri;
    ...
    iput-object v2, p0, Lo9/c;->b:Landroid/os/ParcelFileDescriptor;
...
.method public u(Landroid/net/Uri;)V
    ...
    iput-object p1, p0, Lo9/c;->a:Landroid/net/Uri;
