...
.method public static synthetic a(Lmiuix/flexible/template/AbstractMarkTemplate;Lup/d;Lup/d;)I
    .locals 0

    invoke-direct {p0, p1, p2}, Lmiuix/flexible/template/AbstractMarkTemplate;->lambda$measureViewList$0(Lup/d;Lup/d;)I
...
.method private synthetic lambda$measureViewList$0(Lup/d;Lup/d;)I
    .locals 0

    invoke-virtual {p0, p1}, Lmiuix/flexible/template/AbstractMarkTemplate;->getViewNodePriority(Lup/d;)I

    move-result p1

    invoke-virtual {p0, p2}, Lmiuix/flexible/template/AbstractMarkTemplate;->getViewNodePriority(Lup/d;)I
...
.method private layoutViewList(Lup/c;ZIII)V
    .locals 17

    move-object/from16 v8, p0

    invoke-virtual/range {p1 .. p1}, Lup/d;->e()I

    move-result v0

    add-int v0, p4, v0

    invoke-virtual/range {p1 .. p1}, Lup/d;->a()I
    ...
    invoke-virtual/range {p1 .. p1}, Lup/c;->k()Ljava/util/List;
    ...
    invoke-virtual {v4}, Lup/d;->c()Landroid/view/View;
    ...
    invoke-virtual/range {p1 .. p1}, Lup/c;->l()I
    ...
    check-cast v15, Lup/c;

    invoke-virtual {v15}, Lup/c;->k()Ljava/util/List;
    ...
    invoke-virtual {v0}, Lup/d;->c()Landroid/view/View;
    ...
    invoke-direct/range {v0 .. v5}, Lmiuix/flexible/template/AbstractMarkTemplate;->layoutViewList(Lup/c;ZIII)V
...
.method private measureChildView(Lup/d;IIII)V
    .locals 7

    invoke-virtual {p1}, Lup/d;->c()Landroid/view/View;
    ...
    :cond_9
    invoke-virtual {p1, p2}, Lup/d;->j(I)V

    invoke-virtual {p1, p3}, Lup/d;->f(I)V

    :cond_a
    return-void
.end method

.method private measureViewList(Lup/c;Lup/c;IIII)V
    .locals 19
    ...
    invoke-virtual/range {p2 .. p2}, Lup/c;->k()Ljava/util/List;
    ...
    :cond_1
    invoke-virtual/range {p2 .. p2}, Lup/c;->l()I
    ...
    :goto_2
    instance-of v0, v4, Lup/c;

    if-eqz v0, :cond_5

    move-object/from16 v17, v4

    check-cast v17, Lup/c;
    ...
    invoke-direct/range {v0 .. v6}, Lmiuix/flexible/template/AbstractMarkTemplate;->measureViewList(Lup/c;Lup/c;IIII)V
    ...
    invoke-virtual/range {v17 .. v17}, Lup/d;->e()I
    ...
    invoke-virtual/range {v17 .. v17}, Lup/d;->a()I
    ...
    invoke-direct/range {v0 .. v5}, Lmiuix/flexible/template/AbstractMarkTemplate;->measureChildView(Lup/d;IIII)V
    ...
    invoke-virtual/range {p2 .. p2}, Lup/d;->d()F
    ...
    :cond_12
    invoke-virtual {v8, v13}, Lup/d;->j(I)V
    ...
    :cond_14
    invoke-virtual {v8, v14}, Lup/d;->f(I)V
    ...
    invoke-virtual {v2}, Lup/d;->a()I

    move-result v0

    invoke-virtual/range {p2 .. p2}, Lup/d;->a()I
    ...
    invoke-virtual {v7, v2, v10}, Lmiuix/flexible/template/AbstractMarkTemplate;->hasMatchParentChild(Lup/c;I)Z

    move-result v0

    if-eqz v0, :cond_17

    invoke-virtual {v2}, Lup/d;->e()I
    ...
    invoke-virtual/range {p2 .. p2}, Lup/d;->e()I

    move-result v1

    if-ge v0, v1, :cond_15

    invoke-virtual {v7, v2, v11}, Lmiuix/flexible/template/AbstractMarkTemplate;->hasMatchParentChild(Lup/c;I)Z
    ...
    invoke-virtual {v1}, Lup/d;->c()Landroid/view/View;
...
.method public buildViewTree(Landroid/view/ViewGroup;)V
    ...
    :cond_0
    invoke-static {v1, p0}, Lup/b;->b([Landroid/view/View;Lup/b$a;)Lup/c;

    move-result-object p1

    iput-object p1, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Lup/c;
...
.method public dp2px(F)I
    ...
    invoke-static {p0, p1}, Lip/k;->c(FF)I
...
.method public getViewNodePriority(Lup/d;)I
    .locals 2
    ...
    invoke-virtual {p1}, Lup/c;->k()Ljava/util/List;
...
.method public hasMatchParentChild(Lup/c;I)Z
    .locals 4
    ...
    invoke-virtual {p0, v0, p2}, Lmiuix/flexible/template/AbstractMarkTemplate;->hasMatchParentChild(Lup/c;I)Z
...
.method public init(Landroid/view/ViewGroup;Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object p1, Lqp/b$m;->HyperCellLayout:[I
    ...
    sget v2, Lqp/b$m;->HyperCellLayout_android_gravity:I
    ...
    :cond_0
    sget v2, Lqp/b$m;->HyperCellLayout_column_spacing:I
    ...
    :cond_1
    sget v2, Lqp/b$m;->HyperCellLayout_row_spacing:I
...
.method public onLayout(Landroid/view/ViewGroup;ZIIII)V
    ...
    iget-object p2, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Lup/c;
    ...
    iget-object p5, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Lup/c;

    invoke-virtual {p5}, Lup/d;->a()I
    ...
    iget-object p3, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Lup/c;

    invoke-virtual {p3}, Lup/d;->a()I
    ...
    iget-object p1, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Lup/c;

    invoke-virtual {p1}, Lup/d;->e()I
    ...
    iget-object v2, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Lup/c;

    move-object v1, p0

    invoke-direct/range {v1 .. v6}, Lmiuix/flexible/template/AbstractMarkTemplate;->layoutViewList(Lup/c;ZIII)V
...
.method public onMeasure(Landroid/view/ViewGroup;II)[I
    ...
    iget-object v4, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Lup/c;
    ...
    invoke-direct/range {v2 .. v8}, Lmiuix/flexible/template/AbstractMarkTemplate;->measureViewList(Lup/c;Lup/c;IIII)V
    ...
    :cond_1
    iget-object p0, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Lup/c;

    invoke-virtual {p0}, Lup/d;->a()I
