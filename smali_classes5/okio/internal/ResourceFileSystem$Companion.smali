...
.method private final keepPath(Lokio/Path;)Z
    ...
    invoke-static {p0, p1, v0}, Ltn/b0;->I1(Ljava/lang/String;Ljava/lang/String;Z)Z
...
.method public final removeBase(Lokio/Path;Lokio/Path;)Lokio/Path;
    ...
    invoke-static {p1, p2}, Ltn/c0;->c4(Ljava/lang/String;Ljava/lang/CharSequence;)Ljava/lang/String;
    ...
    invoke-static/range {v0 .. v5}, Ltn/b0;->j2(Ljava/lang/String;CCZILjava/lang/Object;)Ljava/lang/String;
...
.method public final toClasspathRoots(Ljava/lang/ClassLoader;)Ljava/util/List;
    ...
    invoke-virtual {v4, v2}, Lokio/internal/ResourceFileSystem$Companion;->toFileRoot(Ljava/net/URL;)Ljm/u0;
    ...
    invoke-virtual {v2, v0}, Lokio/internal/ResourceFileSystem$Companion;->toJarRoot(Ljava/net/URL;)Ljm/u0;
    ...
    :cond_3
    invoke-static {v1, p1}, Llm/g0;->y4(Ljava/util/Collection;Ljava/lang/Iterable;)Ljava/util/List;
...
.method public final toFileRoot(Ljava/net/URL;)Ljm/u0;
    .locals 4
...
.method public final toJarRoot(Ljava/net/URL;)Ljm/u0;
    .locals 9
    .param p1    # Ljava/net/URL;
        .annotation build Lfv/d;
        .end annotation
    ...
    invoke-static {p1, v0, v7, v1, v8}, Ltn/b0;->u2(Ljava/lang/String;Ljava/lang/String;ZILjava/lang/Object;)Z
    ...
    invoke-static {p1, v0, v1}, Lokio/internal/ZipKt;->openZip(Lokio/Path;Lokio/FileSystem;Lfn/l;)Lokio/ZipFileSystem;
