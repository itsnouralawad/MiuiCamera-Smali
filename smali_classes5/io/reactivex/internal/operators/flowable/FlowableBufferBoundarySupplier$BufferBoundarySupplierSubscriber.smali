...
# direct methods
.method public constructor <init>(Lgv/c;Ljava/util/concurrent/Callable;Ljava/util/concurrent/Callable;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1, v0}, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;-><init>(Lgv/c;Lio/reactivex/internal/fuseable/SimplePlainQueue;)V
...
# virtual methods
.method public bridge synthetic accept(Lgv/c;Ljava/lang/Object;)Z
    .locals 0

    .line 1
    check-cast p2, Ljava/util/Collection;

    invoke-virtual {p0, p1, p2}, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundarySupplier$BufferBoundarySupplierSubscriber;->accept(Lgv/c;Ljava/util/Collection;)Z
...
.method public accept(Lgv/c;Ljava/util/Collection;)Z
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iget-object p0, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->actual:Lgv/c;

    invoke-interface {p0, p2}, Lgv/c;->onNext(Ljava/lang/Object;)V
...
.method public cancel()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundarySupplier$BufferBoundarySupplierSubscriber;->s:Lgv/d;
...
.method public next()V
    ...
    invoke-static {v4, v3, v2}, Landroidx/lifecycle/a;->a(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-interface {v1, v2}, Lgv/b;->subscribe(Lgv/c;)V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundarySupplier$BufferBoundarySupplierSubscriber;->s:Lgv/d;

    invoke-interface {v1}, Lgv/d;->cancel()V

    iget-object p0, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->actual:Lgv/c;

    invoke-interface {p0, v0}, Lgv/c;->onError(Ljava/lang/Throwable;)V
...
.method public onComplete()V
    ...
    iget-object v1, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->actual:Lgv/c;

    const/4 v2, 0x0

    invoke-static {v0, v1, v2, p0, p0}, Lio/reactivex/internal/util/QueueDrainHelper;->drainMaxLoop(Lio/reactivex/internal/fuseable/SimplePlainQueue;Lgv/c;ZLio/reactivex/disposables/Disposable;Lio/reactivex/internal/util/QueueDrain;)V
...
.method public onSubscribe(Lgv/d;)V
    ...
    :cond_0
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundarySupplier$BufferBoundarySupplierSubscriber;->s:Lgv/d;

    iget-object v0, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->actual:Lgv/c;
    ...
    invoke-interface {p1, v3, v4}, Lgv/d;->request(J)V

    invoke-interface {v2, v1}, Lgv/b;->subscribe(Lgv/c;)V
    ...
    invoke-static {v2, v0}, Lio/reactivex/internal/subscriptions/EmptySubscription;->error(Ljava/lang/Throwable;Lgv/c;)V
