...
.method public constructor <init>(Lgv/c;Lio/reactivex/functions/Function;Lio/reactivex/functions/Function;Lio/reactivex/functions/BiFunction;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->actual:Lgv/c;
...
.method public drain()V
    ...
    iget-object v3, v1, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->actual:Lgv/c;
    ...
    invoke-virtual {v1, v3}, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->errorAll(Lgv/c;)V
    ...
    invoke-interface {v3}, Lgv/c;->onComplete()V
    ...
    invoke-interface {v7, v8}, Lgv/b;->subscribe(Lgv/c;)V
    ...
    invoke-interface {v3, v0}, Lgv/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-virtual {v1, v0, v3, v2}, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->fail(Ljava/lang/Throwable;Lgv/c;Lio/reactivex/internal/fuseable/SimpleQueue;)V
    ...
    invoke-interface {v3, v8}, Lgv/c;->onNext(Ljava/lang/Object;)V
...
.method public errorAll(Lgv/c;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public fail(Ljava/lang/Throwable;Lgv/c;Lio/reactivex/internal/fuseable/SimpleQueue;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p2}, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->errorAll(Lgv/c;)V
