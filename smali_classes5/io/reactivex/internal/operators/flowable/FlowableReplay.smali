...
.method private constructor <init>(Lgv/b;Lio/reactivex/Flowable;Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/Callable;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableReplay;->onSubscribe:Lgv/b;
...
.method public static create(Lio/reactivex/Flowable;Ljava/util/concurrent/Callable;)Lio/reactivex/flowables/ConnectableFlowable;
    ...
    invoke-direct {v2, v1, p0, v0, p1}, Lio/reactivex/internal/operators/flowable/FlowableReplay;-><init>(Lgv/b;Lio/reactivex/Flowable;Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/Callable;)V
...
.method public static multicastSelector(Ljava/util/concurrent/Callable;Lio/reactivex/functions/Function;)Lio/reactivex/Flowable;
    ...
    invoke-static {v0}, Lio/reactivex/Flowable;->unsafeCreate(Lgv/b;)Lio/reactivex/Flowable;
...
.method public subscribeActual(Lgv/c;)V
    ...
    iget-object p0, p0, Lio/reactivex/internal/operators/flowable/FlowableReplay;->onSubscribe:Lgv/b;
