...
.method private onSubscribe(Lgv/c;Ljava/util/concurrent/atomic/AtomicBoolean;)Lio/reactivex/functions/Consumer;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p1, p2}, Lio/reactivex/internal/operators/flowable/FlowableRefCount$DisposeConsumer;-><init>(Lio/reactivex/internal/operators/flowable/FlowableRefCount;Lgv/c;Ljava/util/concurrent/atomic/AtomicBoolean;)V
...
# virtual methods
.method public doSubscribe(Lgv/c;Lio/reactivex/disposables/CompositeDisposable;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p0, p1, p2, v0}, Lio/reactivex/internal/operators/flowable/FlowableRefCount$ConnectionSubscriber;-><init>(Lio/reactivex/internal/operators/flowable/FlowableRefCount;Lgv/c;Lio/reactivex/disposables/CompositeDisposable;Lio/reactivex/disposables/Disposable;)V
...
.method public subscribeActual(Lgv/c;)V
    ...
    invoke-direct {p0, p1, v0}, Lio/reactivex/internal/operators/flowable/FlowableRefCount;->onSubscribe(Lgv/c;Ljava/util/concurrent/atomic/AtomicBoolean;)Lio/reactivex/functions/Consumer;
    ...
    invoke-virtual {p0, p1, v0}, Lio/reactivex/internal/operators/flowable/FlowableRefCount;->doSubscribe(Lgv/c;Lio/reactivex/disposables/CompositeDisposable;)V
    :try_end_1
