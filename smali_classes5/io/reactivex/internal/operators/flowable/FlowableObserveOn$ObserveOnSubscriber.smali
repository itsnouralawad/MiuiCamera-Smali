...
# direct methods
.method public constructor <init>(Lgv/c;Lio/reactivex/Scheduler$Worker;ZI)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->actual:Lgv/c;
...
.method public onSubscribe(Lgv/d;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->s:Lgv/d;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->s:Lgv/d;
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->actual:Lgv/c;
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->actual:Lgv/c;
...
.method public poll()Ljava/lang/Object;
    ...
    iget-object p0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->s:Lgv/d;

    invoke-interface {p0, v1, v2}, Lgv/d;->request(J)V
...
.method public runAsync()V
    ...
    :goto_2
    invoke-virtual {p0, v9, v11, v0}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->checkTerminated(ZZLgv/c;)Z
    ...
    :cond_4
    invoke-interface {v0, v10}, Lgv/c;->onNext(Ljava/lang/Object;)V
    ...
    :cond_5
    iget-object v8, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->s:Lgv/d;

    invoke-interface {v8, v2, v3}, Lgv/d;->request(J)V
    ...
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->s:Lgv/d;

    invoke-interface {v3}, Lgv/d;->cancel()V

    invoke-interface {v1}, Lio/reactivex/internal/fuseable/SimpleQueue;->clear()V

    invoke-interface {v0, v2}, Lgv/c;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p0, v6, v7, v0}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->checkTerminated(ZZLgv/c;)Z
...
.method public runBackfused()V
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->actual:Lgv/c;

    const/4 v3, 0x0

    invoke-interface {v2, v3}, Lgv/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->actual:Lgv/c;

    invoke-interface {v1, v0}, Lgv/c;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v0}, Lgv/c;->onComplete()V
...
.method public runSync()V
    ...
    :cond_2
    invoke-interface {v0, v7}, Lgv/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->s:Lgv/d;

    invoke-interface {v2}, Lgv/d;->cancel()V

    invoke-interface {v0, v1}, Lgv/c;->onError(Ljava/lang/Throwable;)V
