...
# direct methods
.method public constructor <init>(Lgv/c;Lio/reactivex/functions/Function;I)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->actual:Lgv/c;
...
.method public cancel()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->s:Lgv/d;
...
.method public checkTerminated(ZZLgv/c;Lio/reactivex/internal/fuseable/SimpleQueue;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZ",
    ...
    invoke-interface {p3, p1}, Lgv/c;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {p3}, Lgv/c;->onComplete()V
...
.method public consumedOne(Z)V
    ...
    iget-object p0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->s:Lgv/d;

    int-to-long v0, p1

    invoke-interface {p0, v0, v1}, Lgv/d;->request(J)V
...
.method public drain()V
    ...
    :cond_0
    iget-object v2, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->actual:Lgv/c;
    ...
    :goto_2
    invoke-virtual {v1, v9, v11, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->checkTerminated(ZZLgv/c;Lio/reactivex/internal/fuseable/SimpleQueue;)Z
    ...
    iget-object v3, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->s:Lgv/d;

    invoke-interface {v3}, Lgv/d;->cancel()V
    ...
    invoke-interface {v2, v0}, Lgv/c;->onError(Ljava/lang/Throwable;)V
    ...
    iget-object v0, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->s:Lgv/d;
    ...
    invoke-virtual {v1, v15, v4, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->checkTerminated(ZZLgv/c;Lio/reactivex/internal/fuseable/SimpleQueue;)Z
    ...
    invoke-interface {v2, v5}, Lgv/c;->onNext(Ljava/lang/Object;)V

    iget-boolean v5, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->done:Z

    invoke-virtual {v1, v5, v4, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->checkTerminated(ZZLgv/c;Lio/reactivex/internal/fuseable/SimpleQueue;)Z
    ...
    :goto_6
    invoke-virtual {v1, v5, v8, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->checkTerminated(ZZLgv/c;Lio/reactivex/internal/fuseable/SimpleQueue;)Z
...
.method public onSubscribe(Lgv/d;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->s:Lgv/d;
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->actual:Lgv/c;
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->actual:Lgv/c;

    invoke-interface {v0, p0}, Lgv/c;->onSubscribe(Lgv/d;)V

    iget p0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->prefetch:I

    int-to-long v0, p0

    invoke-interface {p1, v0, v1}, Lgv/d;->request(J)V
