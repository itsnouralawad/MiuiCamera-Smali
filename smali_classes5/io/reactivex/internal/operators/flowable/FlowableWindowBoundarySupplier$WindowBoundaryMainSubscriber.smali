...
.method public constructor <init>(Lgv/c;Ljava/util/concurrent/Callable;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public drainLoop()V
    ...
    invoke-interface {v1, v5}, Lgv/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-static {v7, v8, v6}, Landroidx/lifecycle/a;->a(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Object;Ljava/lang/Object;)Z

    move-result v7

    if-eqz v7, :cond_9

    invoke-interface {v2, v6}, Lgv/b;->subscribe(Lgv/c;)V
...
.method public onSubscribe(Lgv/d;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$WindowBoundaryMainSubscriber;->s:Lgv/d;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$WindowBoundaryMainSubscriber;->s:Lgv/d;
    ...
    invoke-interface {v0, v2}, Lgv/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-static {v2, v3, v0}, Landroidx/lifecycle/a;->a(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-interface {p1, v5, v6}, Lgv/d;->request(J)V

    invoke-interface {v1, v0}, Lgv/b;->subscribe(Lgv/c;)V
