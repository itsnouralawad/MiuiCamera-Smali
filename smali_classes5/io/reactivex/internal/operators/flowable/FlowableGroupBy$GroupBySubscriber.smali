...
.method public constructor <init>(Lgv/c;Lio/reactivex/functions/Function;Lio/reactivex/functions/Function;IZ)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->actual:Lgv/c;
...
.method public cancel()V
    ...
    .line 3
    iget-object p0, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->s:Lgv/d;
...
.method public cancel(Ljava/lang/Object;)V
    ...
    .line 7
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->s:Lgv/d;
...
.method public checkTerminated(ZZLgv/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZ",
    ...
    invoke-interface {p3, p0}, Lgv/c;->onError(Ljava/lang/Throwable;)V
...
.method public drainFused()V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->actual:Lgv/c;
    ...
    invoke-interface {v1, v4}, Lgv/c;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v1, v4}, Lgv/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-interface {v1, p0}, Lgv/c;->onError(Ljava/lang/Throwable;)V

    goto :goto_0

    :cond_3
    invoke-interface {v1}, Lgv/c;->onComplete()V
...
.method public drainNormal()V
    ...
    :goto_1
    invoke-virtual {p0, v11, v13, v1, v0}, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->checkTerminated(ZZLgv/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    ...
    :cond_3
    invoke-interface {v1, v12}, Lgv/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v10, v11, v1, v0}, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->checkTerminated(ZZLgv/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    ...
    :cond_6
    iget-object v4, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->s:Lgv/d;

    invoke-interface {v4, v8, v9}, Lgv/d;->request(J)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->s:Lgv/d;
...
.method public onSubscribe(Lgv/d;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->s:Lgv/d;

    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->actual:Lgv/c;
