...
# direct methods
.method public constructor <init>(Lgv/c;ILio/reactivex/internal/queue/SpscArrayQueue;Lio/reactivex/Scheduler$Worker;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnSubscriber;->actual:Lgv/c;
...
.method public onSubscribe(Lgv/d;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->s:Lgv/d;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->s:Lgv/d;

    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnSubscriber;->actual:Lgv/c;
...
.method public run()V
    ...
    iget-object v3, v0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnSubscriber;->actual:Lgv/c;
    ...
    invoke-interface {v3, v15}, Lgv/c;->onError(Ljava/lang/Throwable;)V
    ...
    :cond_6
    invoke-interface {v3, v15}, Lgv/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v13, v0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->s:Lgv/d;

    int-to-long v14, v1

    invoke-interface {v13, v14, v15}, Lgv/d;->request(J)V
    ...
    invoke-interface {v3, v13}, Lgv/c;->onError(Ljava/lang/Throwable;)V
