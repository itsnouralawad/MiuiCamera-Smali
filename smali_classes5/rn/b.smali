...
# direct methods
.method public static synthetic a(Lqn/m;)Ljava/util/Spliterator;
    .locals 0

    invoke-static {p0}, Lrn/b;->g(Lqn/m;)Ljava/util/Spliterator;
...
.method public static final b(Ljava/util/stream/DoubleStream;)Lqn/m;
    .locals 1
    ...
    new-instance v0, Lrn/b$d;

    invoke-direct {v0, p0}, Lrn/b$d;-><init>(Ljava/util/stream/DoubleStream;)V

    return-object v0
.end method

.method public static final c(Ljava/util/stream/IntStream;)Lqn/m;
    .locals 1
    ...
    invoke-direct {v0, p0}, Lrn/b$b;-><init>(Ljava/util/stream/IntStream;)V

    return-object v0
.end method

.method public static final d(Ljava/util/stream/LongStream;)Lqn/m;
    .locals 1
    ...
    invoke-direct {v0, p0}, Lrn/b$c;-><init>(Ljava/util/stream/LongStream;)V

    return-object v0
.end method

.method public static final e(Ljava/util/stream/Stream;)Lqn/m;
    .locals 1
    ...
    invoke-direct {v0, p0}, Lrn/b$a;-><init>(Ljava/util/stream/Stream;)V

    return-object v0
.end method

.method public static final f(Lqn/m;)Ljava/util/stream/Stream;
    .locals 2
    .param p0    # Lqn/m;
        .annotation build Lfv/d;
        .end annotation
    ...
    invoke-direct {v0, p0}, Lrn/a;-><init>(Lqn/m;)V
...
.method public static final g(Lqn/m;)Ljava/util/Spliterator;
    .locals 1
...
.method public static final h(Ljava/util/stream/DoubleStream;)Ljava/util/List;
    ...
    invoke-static {p0}, Llm/o;->p([D)Ljava/util/List;
...
.method public static final i(Ljava/util/stream/IntStream;)Ljava/util/List;
    ...
    invoke-static {p0}, Llm/o;->r([I)Ljava/util/List;
...
.method public static final j(Ljava/util/stream/LongStream;)Ljava/util/List;
    ...
    invoke-static {p0}, Llm/o;->s([J)Ljava/util/List;
