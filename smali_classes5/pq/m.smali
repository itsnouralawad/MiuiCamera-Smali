...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 1
    invoke-direct {p0, p1, p2, v0}, Lpq/m;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 3
    invoke-virtual {p0, p1, p2, p3}, Lpq/m;->c(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    return-void
.end method

.method public static synthetic a(Lpq/m;)Lpq/m$b;
    .locals 0

    iget-object p0, p0, Lpq/m;->e:Lpq/m$b;
...
.method public final b()V
    ...
    sget v3, Loq/b$g;->miuix_appcompat_message_view_text_margin_right:I
    ...
    sget v2, Loq/b$i;->close:I

    invoke-virtual {v0, v2}, Landroid/view/View;->setId(I)V

    iget-object v2, p0, Lpq/m;->c:Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v2, p0}, Lpq/m$a;-><init>(Lpq/m;)V
...
.method public final c(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v0, Loq/b$o;->MessageView:[I

    sget v1, Loq/b$n;->Widget_MessageView:I

    invoke-virtual {p1, p2, v0, p3, v1}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object p2

    sget p3, Loq/b$o;->MessageView_android_text:I

    invoke-virtual {p2, p3}, Landroid/content/res/TypedArray;->getString(I)Ljava/lang/String;

    move-result-object p3

    sget v0, Loq/b$o;->MessageView_android_textColor:I

    sget v1, Loq/b$f;->miuix_appcompat_message_view_text_color_light:I
    ...
    sget v1, Loq/b$o;->MessageView_closeBackground:I

    sget v2, Loq/b$h;->miuix_appcompat_ic_message_view_close_guide_light:I
    ...
    iput-object p1, p0, Lpq/m;->c:Landroid/graphics/drawable/Drawable;

    sget p1, Loq/b$o;->MessageView_closable:I
    ...
    iput-object p2, p0, Lpq/m;->a:Landroid/widget/TextView;
    ...
    iget-object v3, p0, Lpq/m;->a:Landroid/widget/TextView;
    ...
    sget v5, Loq/b$g;->miuix_appcompat_message_view_text_padding_start:I
    ...
    iget-object p3, p0, Lpq/m;->a:Landroid/widget/TextView;
    ...
    sget v3, Loq/b$g;->miuix_appcompat_message_view_text_size:I
    ...
    invoke-virtual {p0, p1}, Lpq/m;->setClosable(Z)V
...
.method public setMessage(Ljava/lang/CharSequence;)V
    ...
    iget-object p0, p0, Lpq/m;->a:Landroid/widget/TextView;
...
.method public setOnMessageViewCloseListener(Lpq/m$b;)V
    .locals 0

    iput-object p1, p0, Lpq/m;->e:Lpq/m$b;
