...
.field public static final c:[Ldd/h$a;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Ldd/h;->a:Ljava/lang/Class;

    const/4 v0, 0x0

    new-array v1, v0, [Ljava/lang/annotation/Annotation;

    sput-object v1, Ldd/h;->b:[Ljava/lang/annotation/Annotation;

    new-array v0, v0, [Ldd/h$a;

    sput-object v0, Ldd/h;->c:[Ldd/h$a;

    invoke-static {}, Ljava/util/Collections;->emptyIterator()Ljava/util/Iterator;

    move-result-object v0

    sput-object v0, Ldd/h;->d:Ljava/util/Iterator;
...
.method public static A(Llc/j;Ljava/lang/Class;Z)Ljava/util/List;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1}, Llc/j;->k(Ljava/lang/Class;)Z
    ...
    invoke-virtual {p0, v0}, Llc/j;->k(Ljava/lang/Class;)Z
    ...
    invoke-static {p0, p1, v0, p2}, Ldd/h;->b(Llc/j;Ljava/lang/Class;Ljava/util/Collection;Z)V
...
.method public static C(Ljava/lang/Class;)[Ljava/lang/reflect/Method;
    ...
    :try_start_0
    invoke-static {p0}, Ldd/h;->F(Ljava/lang/Class;)[Ljava/lang/reflect/Method;
...
.method public static D(Ljava/lang/Class;)[Ldd/h$a;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0}, Ldd/h;->a0(Ljava/lang/Class;)Z
    ...
    new-instance v3, Ldd/h$a;

    aget-object v4, p0, v2

    invoke-direct {v3, v4}, Ldd/h$a;-><init>(Ljava/lang/reflect/Constructor;)V
    ...
    :cond_2
    :goto_1
    sget-object p0, Ldd/h;->c:[Ldd/h$a;
...
.method public static K(Ljava/lang/Class;)Ljava/lang/Class;
    ...
    :try_start_0
    invoke-static {p0}, Ldd/h;->P(Ljava/lang/Class;)Z
    ...
    invoke-static {p0}, Ldd/h;->H(Ljava/lang/Class;)Ljava/lang/Class;
...
.method public static N(Llc/j;)Ljava/lang/String;
    .locals 2
...
.method public static X(Ljava/lang/Object;)Z
    ...
    invoke-static {p0}, Ldd/h;->W(Ljava/lang/Class;)Z
...
.method public static a(Ljava/lang/Class;Ljava/lang/Class;Ljava/util/Collection;Z)V
    ...
    :cond_2
    invoke-static {p0}, Ldd/h;->c(Ljava/lang/Class;)[Ljava/lang/Class;
    ...
    invoke-static {v3, p1, p2, v2}, Ldd/h;->a(Ljava/lang/Class;Ljava/lang/Class;Ljava/util/Collection;Z)V
    ...
    invoke-static {p0, p1, p2, v2}, Ldd/h;->a(Ljava/lang/Class;Ljava/lang/Class;Ljava/util/Collection;Z)V
...
.method public static a0(Ljava/lang/Class;)Z
    ...
    sget-object v0, Ldd/h;->a:Ljava/lang/Class;
...
.method public static b(Llc/j;Ljava/lang/Class;Ljava/util/Collection;Z)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_3
    invoke-virtual {p0}, Llc/j;->N()Ljava/util/List;
    ...
    invoke-static {v0, p1, p2, v1}, Ldd/h;->b(Llc/j;Ljava/lang/Class;Ljava/util/Collection;Z)V

    goto :goto_0

    :cond_4
    invoke-virtual {p0}, Llc/j;->Q()Llc/j;

    move-result-object p0

    invoke-static {p0, p1, p2, v1}, Ldd/h;->b(Llc/j;Ljava/lang/Class;Ljava/util/Collection;Z)V
...
.method public static c0(Ldd/t;)Ljava/lang/String;
    .locals 0
    ...
    :cond_0
    invoke-interface {p0}, Ldd/t;->getName()Ljava/lang/String;

    move-result-object p0

    invoke-static {p0}, Ldd/h;->d(Ljava/lang/String;)Ljava/lang/String;
...
.method public static j(Lzb/i;Ljava/io/Closeable;Ljava/lang/Exception;)V
    .locals 1
    ...
    invoke-virtual {p0, v0}, Lzb/i;->s(Lzb/i$b;)Lzb/i;
...
.method public static j0(Llc/j;)Ljava/lang/Class;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static k(Lzb/i;Ljava/lang/Exception;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :goto_0
    invoke-static {p1}, Ldd/h;->o0(Ljava/lang/Throwable;)Ljava/lang/Throwable;
...
.method public static k0(Ljava/lang/Throwable;)V
    ...
    invoke-static {p0, v0}, Ldd/h;->l0(Ljava/lang/Throwable;Ljava/lang/String;)V
...
.method public static l(Ljava/lang/Class;Z)Ljava/lang/Object;
    ...
    invoke-static {p0, p1}, Ldd/h;->q(Ljava/lang/Class;Z)Ljava/lang/reflect/Constructor;
    ...
    invoke-static {p1, p0}, Ldd/h;->s0(Ljava/lang/Throwable;Ljava/lang/String;)V
...
.method public static m0(Llc/g;Ljava/io/IOException;)Ljava/lang/Object;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p0, v0}, Llc/l;->h(Llc/g;Ljava/lang/String;)Llc/l;
...
.method public static n()Ljava/util/Iterator;
    ...
    sget-object v0, Ldd/h;->d:Ljava/util/Iterator;
...
.method public static o(Ljava/lang/Throwable;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lzb/n;->d()Ljava/lang/String;
...
.method public static p(Ljava/lang/Class;)[Ljava/lang/annotation/Annotation;
    ...
    sget-object p0, Ldd/h;->b:[Ljava/lang/annotation/Annotation;
...
.method public static q(Ljava/lang/Class;Z)Ljava/lang/reflect/Constructor;
    ...
    invoke-static {v0, p1}, Ldd/h;->g(Ljava/lang/reflect/Member;Z)V
...
.method public static q0(Ljava/lang/Throwable;)Ljava/lang/Throwable;
    ...
    invoke-static {p0}, Ldd/h;->o0(Ljava/lang/Throwable;)Ljava/lang/Throwable;
...
.method public static r0(Ljava/lang/Throwable;)V
    ...
    invoke-static {p0}, Ldd/h;->k0(Ljava/lang/Throwable;)V
...
.method public static s0(Ljava/lang/Throwable;Ljava/lang/String;)V
    ...
    invoke-static {p0, p1}, Ldd/h;->l0(Ljava/lang/Throwable;Ljava/lang/String;)V
...
.method public static t(Ljava/util/EnumMap;)Ljava/lang/Class;
    ...
    invoke-static {p0}, Ldd/h;->s(Ljava/lang/Enum;)Ljava/lang/Class;
    ...
    :cond_0
    sget-object v0, Ldd/h$b;->c:Ldd/h$b;

    invoke-virtual {v0, p0}, Ldd/h$b;->a(Ljava/util/EnumMap;)Ljava/lang/Class;
...
.method public static u(Ljava/util/EnumSet;)Ljava/lang/Class;
    ...
    invoke-virtual {v0, p0}, Ldd/h$b;->b(Ljava/util/EnumSet;)Ljava/lang/Class;
...
.method public static v(Ljava/lang/Class;Ljava/lang/Class;)Ljava/lang/Enum;
    ...
    invoke-static {p0}, Ldd/h;->E(Ljava/lang/Class;)[Ljava/lang/reflect/Field;
...
.method public static w(Ljava/lang/Class;Ljava/lang/Class;Z)Ljava/util/List;
    ...
    invoke-static {p0, p1, v0, p2}, Ldd/h;->a(Ljava/lang/Class;Ljava/lang/Class;Ljava/util/Collection;Z)V
...
.method public static y(Ljava/lang/Class;Ljava/lang/Class;)Ljava/util/List;
    ...
    invoke-static {p0, p1, v0}, Ldd/h;->z(Ljava/lang/Class;Ljava/lang/Class;Ljava/util/List;)Ljava/util/List;
...
.method public static z(Ljava/lang/Class;Ljava/lang/Class;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {p0, p1, p2, v0}, Ldd/h;->a(Ljava/lang/Class;Ljava/lang/Class;Ljava/util/Collection;Z)V
