...
.method public a(Landroid/support/v4/media/MediaDescriptionCompat;I)V
    ...
    invoke-virtual {p0, p1, v0, p2}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21;->p(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
...
.method public l(Landroid/support/v4/media/MediaDescriptionCompat;)V
    ...
    invoke-virtual {p0, p1, v0, v1}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21;->p(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
...
.method public final o(Landroid/support/v4/media/session/MediaControllerCompat$a;)V
    ...
    invoke-interface {p0, v1}, Landroid/support/v4/media/session/b;->g0(Landroid/support/v4/media/session/a;)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public v()V
    ...
    invoke-interface {v3, v2}, Landroid/support/v4/media/session/b;->f0(Landroid/support/v4/media/session/a;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
