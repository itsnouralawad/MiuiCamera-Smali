...
.method public static v0(Landroid/os/IBinder;)Landroid/support/v4/media/session/b;
    .locals 2
...
.method public static w0()Landroid/support/v4/media/session/b;
    .locals 1

    sget-object v0, Landroid/support/v4/media/session/b$b$a;->e:Landroid/support/v4/media/session/b;

    return-object v0
.end method

.method public static x0(Landroid/support/v4/media/session/b;)Z
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    sput-object p0, Landroid/support/v4/media/session/b$b$a;->e:Landroid/support/v4/media/session/b;
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :cond_1
    invoke-interface {p0, p1, v3}, Landroid/support/v4/media/session/b;->Z(Landroid/support/v4/media/RatingCompat;Landroid/os/Bundle;)V
    ...
    :cond_3
    invoke-interface {p0, v0}, Landroid/support/v4/media/session/b;->g(Z)V
    ...
    invoke-interface {p0, v3, p1}, Landroid/support/v4/media/session/b;->G(Landroid/support/v4/media/MediaDescriptionCompat;I)V
    ...
    :cond_9
    invoke-interface {p0, p1, v3}, Landroid/support/v4/media/session/b;->p(Landroid/net/Uri;Landroid/os/Bundle;)V
    ...
    :cond_a
    invoke-interface {p0, p1, v3}, Landroid/support/v4/media/session/b;->o0(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    :cond_11
    invoke-interface {p0, v3}, Landroid/support/v4/media/session/b;->L(Landroid/support/v4/media/RatingCompat;)V
    ...
    :cond_13
    invoke-interface {p0, p1, v3}, Landroid/support/v4/media/session/b;->k0(Landroid/net/Uri;Landroid/os/Bundle;)V
    ...
    invoke-interface {p0, p1, p4, p2}, Landroid/support/v4/media/session/b;->t0(IILjava/lang/String;)V
    ...
    invoke-static {p1}, Landroid/support/v4/media/session/a$b;->v0(Landroid/os/IBinder;)Landroid/support/v4/media/session/a;
