...
.method public constructor <init>(Lorg/greenrobot/greendao/database/Database;Lorg/greenrobot/greendao/identityscope/IdentityScopeType;Ljava/util/Map;)V
    ...
    iput-object p1, p0, Lv2/b;->a:Lorg/greenrobot/greendao/internal/DaoConfig;
    ...
    iput-object p3, p0, Lv2/b;->b:Lorg/greenrobot/greendao/internal/DaoConfig;
    ...
    invoke-direct {p2, p1, p0}, Lcom/android/camera/db/greendao/SaveTaskDao;-><init>(Lorg/greenrobot/greendao/internal/DaoConfig;Lv2/b;)V

    iput-object p2, p0, Lv2/b;->c:Lcom/android/camera/db/greendao/SaveTaskDao;

    new-instance p1, Lcom/android/camera/db/greendao/InnerTaskDao;

    invoke-direct {p1, p3, p0}, Lcom/android/camera/db/greendao/InnerTaskDao;-><init>(Lorg/greenrobot/greendao/internal/DaoConfig;Lv2/b;)V

    iput-object p1, p0, Lv2/b;->d:Lcom/android/camera/db/greendao/InnerTaskDao;

    const-class p3, Lu2/b;
...
.method public a()V
    ...
    iget-object v0, p0, Lv2/b;->a:Lorg/greenrobot/greendao/internal/DaoConfig;

    invoke-virtual {v0}, Lorg/greenrobot/greendao/internal/DaoConfig;->clearIdentityScope()V

    iget-object p0, p0, Lv2/b;->b:Lorg/greenrobot/greendao/internal/DaoConfig;
...
.method public b()Lcom/android/camera/db/greendao/InnerTaskDao;
    ...
    iget-object p0, p0, Lv2/b;->d:Lcom/android/camera/db/greendao/InnerTaskDao;
...
.method public c()Lcom/android/camera/db/greendao/SaveTaskDao;
    ...
    iget-object p0, p0, Lv2/b;->c:Lcom/android/camera/db/greendao/SaveTaskDao;
