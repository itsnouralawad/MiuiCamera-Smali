...
.field public static final i:Lfc/g;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lfc/g;->b:[B

    new-instance v0, Lfc/g;

    invoke-direct {v0}, Lfc/g;-><init>()V

    sput-object v0, Lfc/g;->i:Lfc/g;
...
.method public static h()Lfc/g;
    .locals 1

    sget-object v0, Lfc/g;->i:Lfc/g;
...
# virtual methods
.method public final a(IILkc/c;I)I
    .locals 0

    invoke-virtual {p3, p4}, Lkc/c;->n(I)V

    const/16 p0, 0x5c

    invoke-virtual {p3, p0}, Lkc/c;->b(I)V
    ...
    sget-object p2, Lfc/g;->b:[B

    shr-int/lit8 p4, p0, 0x4

    aget-byte p4, p2, p4

    invoke-virtual {p3, p4}, Lkc/c;->b(I)V
    ...
    :goto_0
    sget-object p0, Lfc/g;->b:[B

    shr-int/lit8 p2, p1, 0x4

    aget-byte p2, p0, p2

    invoke-virtual {p3, p2}, Lkc/c;->b(I)V
...
.method public g(Ljava/lang/String;)[B
    ...
    invoke-static {v1, v5}, Lkc/c;->i([BI)Lkc/c;

    move-result-object v3

    :cond_0
    invoke-virtual {v3}, Lkc/c;->h()[B
    ...
    invoke-static {v4, v6}, Lfc/g;->d(II)I
    ...
    :cond_11
    invoke-virtual {v3, v5}, Lkc/c;->g(I)[B
...
.method public i(Ljava/lang/CharSequence;Ljava/lang/StringBuilder;)V
    ...
    invoke-virtual {p0, v5, v4}, Lfc/g;->c(I[C)I
    ...
    :cond_2
    invoke-virtual {p0, v7, v4}, Lfc/g;->b(I[C)I
...
.method public j(Ljava/lang/CharSequence;)[C
    ...
    invoke-virtual {p0, p1}, Lfc/g;->k(Ljava/lang/String;)[C
    ...
    invoke-virtual {p0, v7, v6}, Lfc/g;->c(I[C)I
    ...
    :cond_2
    invoke-virtual {p0, v10, v6}, Lfc/g;->b(I[C)I
    ...
    invoke-static {v0}, Lkc/n;->t([C)Lkc/n;

    move-result-object v4

    :cond_4
    invoke-virtual {v4}, Lkc/n;->s()[C
    ...
    :cond_b
    invoke-virtual {v4, v8}, Lkc/n;->J(I)V

    invoke-virtual {v4}, Lkc/n;->g()[C
...
.method public k(Ljava/lang/String;)[C
    ...
    :cond_a
    invoke-virtual {v5, v8}, Lkc/n;->J(I)V

    invoke-virtual {v5}, Lkc/n;->g()[C
...
.method public l(Ljava/lang/String;)[B
    ...
    invoke-virtual {p0, v4, v1, v3, v5}, Lfc/g;->a(IILkc/c;I)I

    move-result v5

    invoke-virtual {v3}, Lkc/c;->j()[B
    ...
    invoke-static {v4, v7}, Lfc/g;->d(II)I
