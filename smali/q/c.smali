...
.method public constructor <init>(Li/h;Lq/d;)V
    ...
    iput-object p1, p0, Lq/c;->A:Landroid/graphics/Paint;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Lq/c;->B:Landroid/graphics/Rect;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Lq/c;->C:Landroid/graphics/Rect;
...
.method public final I()Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v0}, Lq/d;->k()Ljava/lang/String;

    move-result-object v0

    iget-object p0, p0, Lq/a;->n:Li/h;

    invoke-virtual {p0, v0}, Li/h;->u(Ljava/lang/String;)Landroid/graphics/Bitmap;
...
.method public e(Landroid/graphics/RectF;Landroid/graphics/Matrix;Z)V
    ...
    invoke-virtual {p0}, Lq/c;->I()Landroid/graphics/Bitmap;
...
.method public s(Landroid/graphics/Canvas;Landroid/graphics/Matrix;I)V
    ...
    iget-object v2, p0, Lq/c;->A:Landroid/graphics/Paint;

    invoke-virtual {v2, p3}, Landroid/graphics/Paint;->setAlpha(I)V

    iget-object p3, p0, Lq/c;->D:Ll/a;
    ...
    iget-object p2, p0, Lq/c;->B:Landroid/graphics/Rect;
    ...
    iget-object p2, p0, Lq/c;->C:Landroid/graphics/Rect;
    ...
    iget-object p3, p0, Lq/c;->C:Landroid/graphics/Rect;
