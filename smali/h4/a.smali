...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lh4/a;->g:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static a()Ljava/util/concurrent/ConcurrentHashMap;
    ...
    sget-object v0, Lh4/a;->g:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static d(I)Lcom/android/camera/module/entry/b;
    .locals 1
...
.method public static declared-synchronized e(Landroid/content/Context;)Ljava/util/concurrent/ConcurrentHashMap;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_0
    sget-object v1, Lh4/a;->g:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    sget-object p0, Lh4/a;->g:Ljava/util/concurrent/ConcurrentHashMap;
    :try_end_0
    ...
    sget-object v2, Lh4/a;->f:[Ljava/lang/String;

    invoke-static {v2, p0}, Lh4/a;->f([Ljava/lang/String;Landroid/content/Context;)Ljava/util/LinkedHashMap;

    move-result-object p0

    invoke-direct {v1, p0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>(Ljava/util/Map;)V

    sput-object v1, Lh4/a;->g:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static f([Ljava/lang/String;Landroid/content/Context;)Ljava/util/LinkedHashMap;
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    check-cast v6, Lcom/android/camera/module/entry/b;

    if-eqz v6, :cond_0

    invoke-interface {v6}, Lcom/android/camera/module/entry/b;->support()Z

    move-result v7

    if-eqz v7, :cond_0

    invoke-interface {v6}, Lcom/android/camera/module/entry/b;->getModuleId()I
    ...
    invoke-interface {v6}, Lcom/android/camera/module/entry/b;->getEntryName()Ljava/lang/String;
...
.method public static declared-synchronized g(Landroid/content/Context;)Ljava/util/concurrent/ConcurrentHashMap;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v1, p0}, Lh4/a;->c(Ljava/lang/String;Landroid/content/Context;)Lorg/xmlpull/v1/XmlPullParser;

    move-result-object v1

    if-eqz v1, :cond_1

    invoke-static {v1}, Lh4/a;->b(Lorg/xmlpull/v1/XmlPullParser;)[Ljava/lang/String;
    ...
    invoke-static {v1, p0}, Lh4/a;->f([Ljava/lang/String;Landroid/content/Context;)Ljava/util/LinkedHashMap;

    move-result-object p0

    invoke-direct {v2, p0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>(Ljava/util/Map;)V

    sput-object v2, Lh4/a;->g:Ljava/util/concurrent/ConcurrentHashMap;
