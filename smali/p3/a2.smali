...
.method public constructor <init>()V
    ...
    iput-object v1, p0, Lp3/a2;->a:[F

    new-array v0, v0, [F

    iput-object v0, p0, Lp3/a2;->b:[F

    const/4 v2, 0x0

    iput v2, p0, Lp3/a2;->c:I

    new-instance v3, Ljava/util/ArrayList;

    invoke-direct {v3}, Ljava/util/ArrayList;-><init>()V

    iput-object v3, p0, Lp3/a2;->d:Ljava/util/ArrayList;

    iput-boolean v2, p0, Lp3/a2;->e:Z
    ...
    iput-object v3, p0, Lp3/a2;->f:Ljava/lang/String;
...
.method public static synthetic a(Lcom/android/gallery3d/ui/h;Lp3/u1;)V
    .locals 0

    invoke-static {p0, p1}, Lp3/a2;->q(Lcom/android/gallery3d/ui/h;Lp3/u1;)V

    return-void
.end method

.method public static synthetic b(Lp3/a2;Landroid/content/res/Resources;Lq3/w$a;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lp3/a2;->o(Landroid/content/res/Resources;Lq3/w$a;)V

    return-void
.end method

.method public static synthetic c(Lp3/u1;)V
    .locals 0

    invoke-static {p0}, Lp3/a2;->r(Lp3/u1;)V

    return-void
.end method

.method public static synthetic d(Ljava/lang/String;Lp3/u1;)Z
    .locals 0

    invoke-static {p0, p1}, Lp3/a2;->p(Ljava/lang/String;Lp3/u1;)Z
...
.method public static synthetic e(Lp3/a2;)[F
    .locals 0

    iget-object p0, p0, Lp3/a2;->b:[F

    return-object p0
.end method

.method private synthetic o(Landroid/content/res/Resources;Lq3/w$a;)V
    .locals 5
    ...
    iget-object v1, p2, Lq3/w$a;->b:Ljava/lang/String;
    ...
    iget-object v0, p2, Lq3/w$a;->b:Ljava/lang/String;
    ...
    iget-object p0, p0, Lp3/a2;->d:Ljava/util/ArrayList;

    new-instance p2, Lp3/u1;
    ...
    invoke-static {p1, v3}, Lp3/b4;->G(Ljava/lang/String;I)Landroid/graphics/Bitmap;

    move-result-object p1

    invoke-direct {v0, p1, v1}, Lcom/android/gallery3d/ui/c;-><init>(Landroid/graphics/Bitmap;Z)V

    invoke-direct {p2, v2, v0}, Lp3/u1;-><init>(Ljava/lang/String;Lcom/android/gallery3d/ui/b;)V
    ...
    new-instance p1, Lp3/u1;

    iget-object v0, p2, Lq3/w$a;->b:Ljava/lang/String;

    new-instance v2, Lcom/android/gallery3d/ui/c;

    iget-object p2, p2, Lq3/w$a;->b:Ljava/lang/String;

    invoke-static {p2, v3}, Lp3/b4;->G(Ljava/lang/String;I)Landroid/graphics/Bitmap;

    move-result-object p2

    invoke-direct {v2, p2, v1}, Lcom/android/gallery3d/ui/c;-><init>(Landroid/graphics/Bitmap;Z)V

    invoke-direct {p1, v0, v2}, Lp3/u1;-><init>(Ljava/lang/String;Lcom/android/gallery3d/ui/b;)V
...
.method public static synthetic p(Ljava/lang/String;Lp3/u1;)Z
    .locals 0

    invoke-virtual {p1}, Lp3/u1;->b()Ljava/lang/String;
...
.method public static synthetic q(Lcom/android/gallery3d/ui/h;Lp3/u1;)V
    .locals 0

    invoke-virtual {p1}, Lp3/u1;->a()Lcom/android/gallery3d/ui/b;
...
.method public static synthetic r(Lp3/u1;)V
    .locals 0

    invoke-virtual {p0}, Lp3/u1;->a()Lcom/android/gallery3d/ui/b;
...
.method public final f(II)V
    ...
    :goto_0
    invoke-virtual {p0, p1, p2}, Lp3/a2;->h(II)V
...
.method public final declared-synchronized g(Landroid/content/res/Resources;)V
    ...
    new-instance v1, Lp3/z1;

    invoke-direct {v1, p0, p1}, Lp3/z1;-><init>(Lp3/a2;Landroid/content/res/Resources;)V

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->forEach(Ljava/util/function/Consumer;)V

    iget-object v0, p0, Lp3/a2;->d:Ljava/util/ArrayList;

    new-instance v1, Lp3/u1;
    ...
    invoke-static {p1, v4}, Lp3/b4;->G(Ljava/lang/String;I)Landroid/graphics/Bitmap;
    ...
    invoke-direct {v1, v2, v3}, Lp3/u1;-><init>(Ljava/lang/String;Lcom/android/gallery3d/ui/b;)V
...
.method public final h(II)V
    ...
    iget-object v2, p0, Lp3/a2;->f:Ljava/lang/String;
    ...
    iget-object v6, p0, Lp3/a2;->f:Ljava/lang/String;
    ...
    new-instance v6, Lp3/a2$a;

    invoke-direct {v6, p0, p1, p2}, Lp3/a2$a;-><init>(Lp3/a2;II)V
...
.method public declared-synchronized j(Ljava/lang/String;)Lcom/android/gallery3d/ui/b;
    ...
    :try_start_0
    invoke-virtual {p0, p1}, Lp3/a2;->m(Ljava/lang/String;)Lcom/android/gallery3d/ui/b;
    ...
    sget-object v1, Lp3/b4;->l:Landroid/util/Size;
    ...
    iget-object v1, p0, Lp3/a2;->d:Ljava/util/ArrayList;

    new-instance v2, Lp3/u1;

    invoke-direct {v2, p1, v0}, Lp3/u1;-><init>(Ljava/lang/String;Lcom/android/gallery3d/ui/b;)V
...
.method public declared-synchronized m(Ljava/lang/String;)Lcom/android/gallery3d/ui/b;
    ...
    new-instance v1, Lp3/x1;

    invoke-direct {v1, p1}, Lp3/x1;-><init>(Ljava/lang/String;)V
    ...
    new-instance v0, Lp3/y1;

    invoke-direct {v0}, Lp3/y1;-><init>()V
...
.method public n(Lcom/android/gallery3d/ui/h;Landroid/content/res/Resources;)V
    ...
    :cond_0
    invoke-virtual {p0, p2}, Lp3/a2;->g(Landroid/content/res/Resources;)V
    ...
    invoke-static {p2, v3}, Lp3/b4;->o(Landroid/content/res/Resources;I)Landroid/graphics/Bitmap;
    ...
    invoke-direct {v1, v3, v2}, Lp3/u1;-><init>(Ljava/lang/String;Lcom/android/gallery3d/ui/b;)V
    ...
    invoke-direct {v1, p2, v2}, Lp3/u1;-><init>(Ljava/lang/String;Lcom/android/gallery3d/ui/b;)V

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object p2, p0, Lp3/a2;->d:Ljava/util/ArrayList;

    new-instance v0, Lp3/u1;

    new-instance v1, Lcom/android/gallery3d/ui/c;

    invoke-static {v4}, Lp3/b4;->w(Z)Landroid/graphics/Bitmap;
    ...
    invoke-direct {v0, v2, v1}, Lp3/u1;-><init>(Ljava/lang/String;Lcom/android/gallery3d/ui/b;)V
    ...
    invoke-static {v2}, Lp3/b4;->w(Z)Landroid/graphics/Bitmap;
    ...
    invoke-direct {v0, v3, v1}, Lp3/u1;-><init>(Ljava/lang/String;Lcom/android/gallery3d/ui/b;)V
    ...
    invoke-static {}, Lp3/b4;->x()Landroid/graphics/Bitmap;
    ...
    new-instance v0, Lp3/v1;

    invoke-direct {v0, p1}, Lp3/v1;-><init>(Lcom/android/gallery3d/ui/h;)V
...
.method public declared-synchronized s()V
    ...
    new-instance v1, Lp3/w1;

    invoke-direct {v1}, Lp3/w1;-><init>()V
...
.method public declared-synchronized u(I)V
    ...
    :cond_0
    :try_start_1
    invoke-virtual {p0, v0, p1}, Lp3/a2;->f(II)V

    iput p1, p0, Lp3/a2;->c:I
    ...
    invoke-virtual {p0, v0, p1}, Lp3/a2;->t([FI)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
