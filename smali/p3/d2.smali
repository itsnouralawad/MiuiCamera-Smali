...
.method public constructor <init>(Landroid/graphics/Rect;)V
    ...
    new-instance v0, Lp3/b2;

    invoke-direct {v0}, Lp3/b2;-><init>()V

    iput-object v0, p0, Lp3/d2;->a:Lp3/b2;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lp3/d2;->b:Z

    const/4 v0, 0x0

    iput v0, p0, Lp3/d2;->c:F

    iput v0, p0, Lp3/d2;->d:F

    new-instance v0, Lmiuix/animation/utils/VelocityMonitor;

    invoke-direct {v0}, Lmiuix/animation/utils/VelocityMonitor;-><init>()V

    iput-object v0, p0, Lp3/d2;->f:Lmiuix/animation/utils/VelocityMonitor;

    invoke-virtual {p0, p1}, Lp3/d2;->g(Landroid/graphics/Rect;)V

    return-void
.end method

.method public static synthetic a(Lp3/d2;)Lp3/b2;
    .locals 0

    iget-object p0, p0, Lp3/d2;->a:Lp3/b2;

    return-object p0
.end method

.method public static synthetic b(Lp3/d2;)Lp3/d2$d;
    .locals 0

    iget-object p0, p0, Lp3/d2;->e:Lp3/d2$d;
...
.method public c()Landroid/graphics/Rect;
    ...
    invoke-virtual {p0}, Lp3/b2;->b()Landroid/graphics/Rect;
...
.method public final d(Lp3/s1;)Landroid/graphics/Rect;
    .locals 8
    ...
    sget-object v2, Lp3/s1;->j:Lp3/s1;

    invoke-virtual {v2}, Lp3/s1;->a()I
...
.method public e(Lp3/s1;)Landroid/graphics/Rect;
    .locals 6

    iget-object v0, p0, Lp3/d2;->a:Lp3/b2;

    invoke-virtual {v0}, Lp3/b2;->b()Landroid/graphics/Rect;

    move-result-object v0

    sget-object v1, Lp3/d2$c;->a:[I
    ...
    invoke-virtual {p0, p1}, Lp3/d2;->d(Lp3/s1;)Landroid/graphics/Rect;
    ...
    invoke-virtual {p0}, Lp3/b2;->c()Landroid/graphics/Point;
...
.method public f()V
    ...
    iget-object v0, p0, Lp3/d2;->f:Lmiuix/animation/utils/VelocityMonitor;
    ...
    iget-object v2, p0, Lp3/d2;->f:Lmiuix/animation/utils/VelocityMonitor;
    ...
    iget-object v4, p0, Lp3/d2;->a:Lp3/b2;

    invoke-virtual {v4}, Lp3/b2;->d()Landroid/graphics/Rect;

    move-result-object v4

    iget-object v5, p0, Lp3/d2;->a:Lp3/b2;

    invoke-virtual {v5}, Lp3/b2;->c()Landroid/graphics/Point;
    ...
    new-instance v13, Lp3/d2$a;

    invoke-direct {v13, p0}, Lp3/d2$a;-><init>(Lp3/d2;)V
    ...
    new-instance v5, Lp3/d2$b;

    invoke-direct {v5, p0}, Lp3/d2$b;-><init>(Lp3/d2;)V
...
.method public g(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0, p1}, Lp3/b2;->e(Landroid/graphics/Rect;)V

    iget-object p0, p0, Lp3/d2;->a:Lp3/b2;

    invoke-virtual {p0, p1}, Lp3/b2;->h(Landroid/graphics/Rect;)V

    return-void
.end method

.method public h(Lp3/d2$d;)V
    .locals 5
    ...
    invoke-virtual {v0}, Lp3/b2;->c()Landroid/graphics/Point;

    move-result-object v0

    iget-object v1, p0, Lp3/d2;->f:Lmiuix/animation/utils/VelocityMonitor;
    ...
    iput-object p1, p0, Lp3/d2;->e:Lp3/d2$d;
...
.method public i(FF)V
    ...
    iput p1, p0, Lp3/d2;->c:F

    iput p2, p0, Lp3/d2;->d:F
...
.method public j(II)V
    ...
    invoke-virtual {v0, p1, p2}, Lp3/b2;->i(II)V

    iget-object p1, p0, Lp3/d2;->e:Lp3/d2$d;

    invoke-interface {p1}, Lp3/d2$d;->a()V

    iget-object p1, p0, Lp3/d2;->a:Lp3/b2;

    invoke-virtual {p1}, Lp3/b2;->c()Landroid/graphics/Point;

    move-result-object p1

    iget-object p0, p0, Lp3/d2;->f:Lmiuix/animation/utils/VelocityMonitor;
