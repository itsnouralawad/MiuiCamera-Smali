.class public Lcom/android/camera/f6;
...
.method public static c(Ljava/util/List;Ld/g;)Ljava/util/List;
    .locals 7
    ...
    invoke-direct {v3}, Lg/f;-><init>()V

    invoke-virtual {v3, v2}, Lg/f;->O(Z)Lg/f;

    invoke-virtual {v3, v2}, Lg/f;->K(Z)Lg/f;

    invoke-static {p1, v3}, Ld/h;->n(Ld/g;Lg/f;)[B
    ...
    new-instance p1, Lcom/android/camera/f6$b;

    invoke-direct {p1, v0}, Lcom/android/camera/f6$b;-><init>(Lcom/android/camera/f6$a;)V

    const/16 v0, 0xe1

    iput v0, p1, Lcom/android/camera/f6$b;->a:I

    add-int/lit8 v3, v3, 0x2

    iput v3, p1, Lcom/android/camera/f6$b;->b:I

    iput-object v5, p1, Lcom/android/camera/f6$b;->c:[B
    ...
    check-cast v4, Lcom/android/camera/f6$b;

    iget v4, v4, Lcom/android/camera/f6$b;->a:I
    ...
    iget-object v4, v4, Lcom/android/camera/f6$b;->c:[B

    invoke-static {v4}, Lcom/android/camera/f6;->b([B)Z
...
.method public static d(Ljava/io/InputStream;Z)Ljava/util/List;
    ...
    invoke-direct {p1, v2}, Lcom/android/camera/f6$b;-><init>(Lcom/android/camera/f6$a;)V

    iput v5, p1, Lcom/android/camera/f6$b;->a:I

    iput v6, p1, Lcom/android/camera/f6$b;->b:I
    ...
    iput-object v4, p1, Lcom/android/camera/f6$b;->c:[B
    ...
    :cond_8
    :goto_2
    new-instance v7, Lcom/android/camera/f6$b;

    invoke-direct {v7, v2}, Lcom/android/camera/f6$b;-><init>(Lcom/android/camera/f6$a;)V

    iput v5, v7, Lcom/android/camera/f6$b;->a:I

    iput v6, v7, Lcom/android/camera/f6$b;->b:I

    add-int/lit8 v6, v6, -0x2

    new-array v5, v6, [B

    iput-object v5, v7, Lcom/android/camera/f6$b;->c:[B
...
.method public static e(Ljava/io/OutputStream;Ljava/util/List;)V
    ...
    check-cast v1, Lcom/android/camera/f6$b;

    invoke-virtual {p0, v0}, Ljava/io/OutputStream;->write(I)V

    iget v2, v1, Lcom/android/camera/f6$b;->a:I

    invoke-virtual {p0, v2}, Ljava/io/OutputStream;->write(I)V

    iget v2, v1, Lcom/android/camera/f6$b;->b:I
    ...
    :cond_0
    iget-object v1, v1, Lcom/android/camera/f6$b;->c:[B
...
.method public static f(Ljava/io/InputStream;Ljava/io/OutputStream;Ld/g;)Z
    .locals 3

    const/4 v0, 0x0

    invoke-static {p0, v0}, Lcom/android/camera/f6;->d(Ljava/io/InputStream;Z)Ljava/util/List;

    move-result-object p0

    invoke-static {p0, p2}, Lcom/android/camera/f6;->c(Ljava/util/List;Ld/g;)Ljava/util/List;
    ...
    :cond_0
    :try_start_0
    invoke-static {p1, p0}, Lcom/android/camera/f6;->e(Ljava/io/OutputStream;Ljava/util/List;)V
    :try_end_0
