...
# direct methods
.method public constructor <init>(ZLjava/lang/ref/Reference;Lcom/android/camera/ThumbnailUpdater;Lcom/android/camera/l5;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z",
    ...
    .line 1
    invoke-direct/range {v0 .. v5}, Lcom/android/camera/ThumbnailUpdater$LoadThumbnailTask;-><init>(ZZLjava/lang/ref/Reference;Lcom/android/camera/ThumbnailUpdater;Lcom/android/camera/l5;)V

    return-void
.end method

.method public constructor <init>(ZZLjava/lang/ref/Reference;Lcom/android/camera/ThumbnailUpdater;Lcom/android/camera/l5;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZ",
...
# virtual methods
.method public varargs C([Ljava/lang/Void;)Lcom/android/camera/l5;
    .locals 17
    ...
    :cond_0
    invoke-virtual/range {p0 .. p0}, Lcom/xiaomi/camera/common/LifecycleAsyncTask;->r()Z
    ...
    invoke-static {v6}, Lcom/android/camera/l5;->t(Landroid/content/ContentResolver;)Lcom/android/camera/l5$b;
    ...
    :cond_2
    iget-object v0, v7, Lcom/android/camera/l5$b;->d:Landroid/net/Uri;
    ...
    check-cast v0, Lcom/android/camera/l5;
    ...
    invoke-static {v11, v6}, Lcom/android/camera/z5;->w3(Landroid/net/Uri;Landroid/content/ContentResolver;)Z
    ...
    :cond_3
    iget-wide v13, v7, Lcom/android/camera/l5$b;->j:J

    :goto_1
    invoke-virtual {v0, v13, v14}, Lcom/android/camera/l5;->J(J)V
    ...
    invoke-static {v3, v11}, Ll9/i;->f(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    invoke-virtual {v12, v11}, Lw2/c;->x(Ljava/lang/Long;)Lu2/b;
    ...
    invoke-virtual {v3}, Lcom/android/camera/ActivityBase;->Mh()Z
    ...
    invoke-static {v3, v6}, Lcom/android/camera/l5;->w(Landroid/content/Context;Landroid/content/ContentResolver;)Lcom/android/camera/l5;
    ...
    :cond_d
    new-array v8, v10, [Lcom/android/camera/l5;

    const/4 v11, 0x2

    iput v11, v1, Lcom/android/camera/ThumbnailUpdater$LoadThumbnailTask;->p:I

    invoke-virtual {v3}, Lcom/android/camera/ActivityBase;->Kh()Z
    ...
    invoke-static {v3, v8, v6, v7}, Lcom/android/camera/l5;->v(Landroid/content/Context;[Lcom/android/camera/l5;Landroid/net/Uri;Lcom/android/camera/l5$b;)I
    ...
    invoke-virtual {v3}, Lcom/android/camera/ActivityBase;->ii()Ljava/util/ArrayList;

    move-result-object v9

    invoke-static {v3, v8, v9, v6}, Lcom/android/camera/l5;->x(Landroid/content/Context;[Lcom/android/camera/l5;Ljava/util/ArrayList;Landroid/net/Uri;)I
    ...
    :cond_13
    iget-wide v12, v7, Lcom/android/camera/l5$b;->c:J

    :goto_8
    invoke-virtual {v0, v12, v13}, Lcom/android/camera/l5;->O(J)V
    ...
    :cond_14
    iget-boolean v2, v7, Lcom/android/camera/l5$b;->i:Z

    :goto_9
    invoke-virtual {v0, v2}, Lcom/android/camera/l5;->N(Z)V
    ...
    :cond_18
    iget-boolean v1, v7, Lcom/android/camera/l5$b;->i:Z

    :goto_b
    invoke-virtual {v0, v1}, Lcom/android/camera/l5;->N(Z)V
...
.method public D(Lcom/android/camera/l5;)V
    .locals 6
    ...
    invoke-static {v0, p1, v2, v1, p0}, Lcom/android/camera/ThumbnailUpdater;->e(Lcom/android/camera/ThumbnailUpdater;Lcom/android/camera/l5;ZZZ)V
...
.method public bridge synthetic m([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/ThumbnailUpdater$LoadThumbnailTask;->C([Ljava/lang/Void;)Lcom/android/camera/l5;
...
.method public bridge synthetic y(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/ThumbnailUpdater$LoadThumbnailTask;->D(Lcom/android/camera/l5;)V
