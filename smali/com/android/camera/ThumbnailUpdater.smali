...
.method public constructor <init>(Lcom/android/camera/ActivityBase;)V
    ...
    iput-object p1, p0, Lcom/android/camera/ThumbnailUpdater;->i:Landroid/os/Handler;
...
.method public static synthetic e(Lcom/android/camera/ThumbnailUpdater;Lcom/android/camera/l5;ZZZ)V
    .locals 0

    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/android/camera/ThumbnailUpdater;->v(Lcom/android/camera/l5;ZZZ)V
...
.method public static j(Z)Landroid/net/Uri;
    ...
    invoke-static {v3}, Lm7/a;->k(Landroid/content/Context;)Ljava/lang/String;
...
.method private synthetic r(ZIZ)V
    ...
    :cond_0
    invoke-interface {v0}, Lv8/d;->canProvide()Z
    ...
    :cond_1
    iget-object p0, p0, Lcom/android/camera/ThumbnailUpdater;->a:Lcom/android/camera/l5;

    invoke-interface {v0, p0, p1, p2, p3}, Lv8/d;->S2(Lcom/android/camera/l5;ZIZ)V
...
.method public k()V
    ...
    invoke-virtual {v1}, Lcom/xiaomi/camera/common/LifecycleAsyncTask;->j()V
    ...
    iget-object v4, p0, Lcom/android/camera/ThumbnailUpdater;->a:Lcom/android/camera/l5;

    const/4 v5, 0x1

    invoke-direct {v1, v5, v3, p0, v4}, Lcom/android/camera/ThumbnailUpdater$LoadThumbnailTask;-><init>(ZLjava/lang/ref/Reference;Lcom/android/camera/ThumbnailUpdater;Lcom/android/camera/l5;)V

    invoke-virtual {v0}, Landroidx/activity/ComponentActivity;->getLifecycle()Landroidx/lifecycle/Lifecycle;

    move-result-object v0

    invoke-virtual {v1, v0}, Lcom/xiaomi/camera/common/LifecycleAsyncTask;->g(Landroidx/lifecycle/Lifecycle;)Lcom/xiaomi/camera/common/LifecycleAsyncTask;
    ...
    invoke-virtual {v0, v1, v2}, Lcom/xiaomi/camera/common/LifecycleAsyncTask;->n(Ljava/lang/String;[Ljava/lang/Object;)Lcom/xiaomi/camera/common/LifecycleAsyncTask;
...
.method public l(Z)V
    ...
    iget-object v8, p0, Lcom/android/camera/ThumbnailUpdater;->a:Lcom/android/camera/l5;
    ...
    invoke-direct/range {v3 .. v8}, Lcom/android/camera/ThumbnailUpdater$LoadThumbnailTask;-><init>(ZZLjava/lang/ref/Reference;Lcom/android/camera/ThumbnailUpdater;Lcom/android/camera/l5;)V

    invoke-virtual {v0}, Landroidx/activity/ComponentActivity;->getLifecycle()Landroidx/lifecycle/Lifecycle;

    move-result-object p1

    invoke-virtual {v1, p1}, Lcom/xiaomi/camera/common/LifecycleAsyncTask;->g(Landroidx/lifecycle/Lifecycle;)Lcom/xiaomi/camera/common/LifecycleAsyncTask;
    ...
    invoke-virtual {p1, v0, v1}, Lcom/xiaomi/camera/common/LifecycleAsyncTask;->n(Ljava/lang/String;[Ljava/lang/Object;)Lcom/xiaomi/camera/common/LifecycleAsyncTask;
...
.method public n()Lcom/android/camera/l5;
    .locals 0
...
.method public t()V
    ...
    :cond_0
    iget-object v2, p0, Lcom/android/camera/ThumbnailUpdater;->a:Lcom/android/camera/l5;

    if-eqz v2, :cond_1

    invoke-virtual {v2}, Lcom/android/camera/l5;->m()Z
    ...
    invoke-virtual {v2, v0}, Lcom/xiaomi/camera/common/LifecycleAsyncTask;->g(Landroidx/lifecycle/Lifecycle;)Lcom/xiaomi/camera/common/LifecycleAsyncTask;
    ...
    new-array v3, v3, [Lcom/android/camera/l5;

    iget-object p0, p0, Lcom/android/camera/ThumbnailUpdater;->a:Lcom/android/camera/l5;

    aput-object p0, v3, v1

    invoke-virtual {v0, v2, v3}, Lcom/xiaomi/camera/common/LifecycleAsyncTask;->n(Ljava/lang/String;[Ljava/lang/Object;)Lcom/xiaomi/camera/common/LifecycleAsyncTask;

    :cond_1
    return-void
.end method

.method public u(Lcom/android/camera/l5;ZZ)V
    .locals 1

    const/4 v0, 0x1

    invoke-virtual {p0, p1, p2, p3, v0}, Lcom/android/camera/ThumbnailUpdater;->v(Lcom/android/camera/l5;ZZZ)V

    return-void
.end method

.method public final v(Lcom/android/camera/l5;ZZZ)V
    .locals 0

    iput-object p1, p0, Lcom/android/camera/ThumbnailUpdater;->a:Lcom/android/camera/l5;
...
.method public x()V
    ...
    invoke-direct {v1, p0}, Lcom/android/camera/n5;-><init>(Lcom/android/camera/ThumbnailUpdater;)V
...
.method public y(ZZ)V
    ...
    new-instance v2, Lcom/android/camera/o5;

    invoke-direct {v2, p0, p1, v0, p2}, Lcom/android/camera/o5;-><init>(Lcom/android/camera/ThumbnailUpdater;ZIZ)V
