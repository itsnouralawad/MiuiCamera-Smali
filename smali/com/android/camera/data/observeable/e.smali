...
.method public static synthetic e(Lcom/android/camera/data/observeable/e;Lcom/android/camera/resource/BaseResourceItem;Ljava/lang/Throwable;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/camera/data/observeable/e;->m(Lcom/android/camera/resource/BaseResourceItem;Ljava/lang/Throwable;)V

    return-void
.end method

.method public static synthetic f(Lcom/android/camera/resource/BaseResourceItem;)Lio/reactivex/ObservableSource;
    .locals 0

    invoke-static {p0}, Lcom/android/camera/data/observeable/e;->k(Lcom/android/camera/resource/BaseResourceItem;)Lio/reactivex/ObservableSource;
...
.method public static synthetic g(Ljava/lang/String;Lh8/a;)Lio/reactivex/ObservableSource;
    .locals 0

    invoke-static {p0, p1}, Lcom/android/camera/data/observeable/e;->j(Ljava/lang/String;Lh8/a;)Lio/reactivex/ObservableSource;
...
.method public static synthetic h(Lcom/android/camera/data/observeable/e;Lio/reactivex/ObservableEmitter;ZLjava/lang/String;Lcom/android/camera/resource/BaseResourceItem;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lcom/android/camera/data/observeable/e;->l(Lio/reactivex/ObservableEmitter;ZLjava/lang/String;Lcom/android/camera/resource/BaseResourceItem;)V

    return-void
.end method

.method public static synthetic j(Ljava/lang/String;Lh8/a;)Lio/reactivex/ObservableSource;
    .locals 2
    ...
    invoke-virtual {p1}, Lh8/a;->getDownloadUrl()Ljava/lang/String;
    ...
    iget-object p0, p1, Lh8/a;->c:Lcom/android/camera/resource/BaseResourceItem;
...
.method public static synthetic k(Lcom/android/camera/resource/BaseResourceItem;)Lio/reactivex/ObservableSource;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method private synthetic l(Lio/reactivex/ObservableEmitter;ZLjava/lang/String;Lcom/android/camera/resource/BaseResourceItem;)V
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    invoke-static {v0, v1}, Lk9/a;->H2(Ljava/lang/String;I)V
    ...
    invoke-virtual {p0, p4, v0}, Lcom/android/camera/data/observeable/e;->s(Lcom/android/camera/resource/BaseResourceItem;Ljava/lang/Integer;)V
    ...
    :cond_0
    invoke-virtual {p0, p4}, Lcom/android/camera/data/observeable/e;->o(Lcom/android/camera/resource/BaseResourceItem;)V

    if-eqz p2, :cond_1

    invoke-static {p3}, Ly7/j6;->r(Ljava/lang/String;)Z

    :cond_1
    return-void
.end method

.method private synthetic m(Lcom/android/camera/resource/BaseResourceItem;Ljava/lang/Throwable;)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    invoke-virtual {p0, p2, p1}, Lcom/android/camera/data/observeable/e;->r(Ljava/lang/Throwable;Lcom/android/camera/resource/BaseResourceItem;)V
...
.method public final i(Landroidx/fragment/app/FragmentActivity;)Z
    ...
    invoke-static {p0, v0, v1}, Lcom/android/camera/fragment/CtaNoticeFragment;->lh(Landroidx/fragment/app/FragmentManager;Lcom/android/camera/fragment/CtaNoticeFragment$a;I)Z
...
.method public final o(Lcom/android/camera/resource/BaseResourceItem;)V
    .locals 0
...
.method public p(Lcom/android/camera/resource/BaseResourceItem;Landroidx/fragment/app/FragmentActivity;Lio/reactivex/ObservableEmitter;Z)Lio/reactivex/disposables/Disposable;
    .locals 3
    ...
    invoke-static {p2}, Lk9/a;->I2(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/camera/data/observeable/e;->s(Lcom/android/camera/resource/BaseResourceItem;Ljava/lang/Integer;)V
    ...
    invoke-direct {v0, v1, p1}, Lh8/b;-><init>(Ljava/lang/String;Lcom/android/camera/resource/BaseResourceItem;)V
    ...
    invoke-direct {v1, p2}, Lq2/e;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v1, p0, p3, p4, p2}, Lq2/g;-><init>(Lcom/android/camera/data/observeable/e;Lio/reactivex/ObservableEmitter;ZLjava/lang/String;)V

    new-instance p2, Lq2/h;

    invoke-direct {p2, p0, p1}, Lq2/h;-><init>(Lcom/android/camera/data/observeable/e;Lcom/android/camera/resource/BaseResourceItem;)V
...
.method public final r(Ljava/lang/Throwable;Lcom/android/camera/resource/BaseResourceItem;)V
    .locals 4
    .annotation build Lh7/c;
    .end annotation
...
.method public s(Lcom/android/camera/resource/BaseResourceItem;Ljava/lang/Integer;)V
    .locals 1
    .annotation build Landroidx/annotation/MainThread;
    .end annotation
