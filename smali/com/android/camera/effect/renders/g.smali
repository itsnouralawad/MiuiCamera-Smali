...
# instance fields
.field public f:Lcom/android/camera/effect/renders/s;
...
.method public constructor <init>(Lcom/android/gallery3d/ui/h;)V
    ...
    iput-object v0, p0, Lcom/android/camera/effect/renders/g;->f:Lcom/android/camera/effect/renders/s;
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/effect/renders/s;->b(Lcom/android/camera/effect/renders/r;)V
...
.method public draw(Lt3/a;)Z
    ...
    :cond_3
    invoke-virtual {p0, p1}, Lcom/android/camera/effect/renders/g;->u(Lt3/a;)Z
...
.method public varargs e([I)V
    ...
    :cond_0
    invoke-virtual {v1}, Lcom/android/camera/effect/b;->isKaleidoscopeEnable()Z
    ...
    :cond_1
    invoke-virtual {v1}, Lcom/android/camera/effect/b;->isNeedDrawExposure()Z
    ...
    :cond_2
    invoke-virtual {v1}, Lcom/android/camera/effect/b;->isDrawTilt()Z
    ...
    :cond_4
    invoke-virtual {v1}, Lcom/android/camera/effect/b;->isNeedDrawPeaking()Z
    ...
    :cond_5
    invoke-virtual {v1}, Lcom/android/camera/effect/b;->isMakeupEnable()Z
    ...
    :cond_7
    invoke-virtual {v1, v7}, Lcom/android/camera/effect/b;->getEffectForPreview(Z)I
...
.method public final t(Lt3/a;)V
    ...
    invoke-virtual {v0}, Lcom/android/camera/effect/b;->getBlurAnimationValue()I
    ...
    invoke-direct {v1, p1, v0}, Lt3/e;-><init>(Landroid/graphics/Rect;I)V

    invoke-interface {p0, v1}, Lcom/android/gallery3d/ui/h;->q(Lt3/a;)V
...
.method public final u(Lt3/a;)Z
    ...
    invoke-virtual {v0}, Lcom/android/camera/effect/renders/s;->l()I
    ...
    invoke-virtual {v0, v2}, Lcom/android/camera/effect/renders/o;->C(Lcom/android/camera/effect/renders/r;)V
    ...
    invoke-virtual {v2}, Lcom/android/camera/effect/b;->isBackGroundBlur()Z
    ...
    invoke-virtual {v0, p1}, Lcom/android/camera/effect/renders/o;->draw(Lt3/a;)Z

    invoke-virtual {p0, p1}, Lcom/android/camera/effect/renders/g;->t(Lt3/a;)V

    return v1
.end method

.method public final v(I)Lcom/android/camera/effect/renders/r;
    .locals 2

    iget-object v0, p0, Lcom/android/camera/effect/renders/g;->f:Lcom/android/camera/effect/renders/s;
    ...
    iget-object p0, p0, Lcom/android/camera/effect/renders/g;->f:Lcom/android/camera/effect/renders/s;

    invoke-virtual {p0, p1}, Lcom/android/camera/effect/renders/s;->j(I)Lcom/android/camera/effect/renders/r;
...
.method public final w()Lcom/android/camera/effect/renders/r;
    .locals 2
    ...
    invoke-virtual {p0, v0}, Lcom/android/camera/effect/renders/g;->v(I)Lcom/android/camera/effect/renders/r;
...
.method public final x(I)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/effect/renders/s;->r(I)V
...
.method public final y(Z)Z
    ...
    invoke-static {v1, v3}, Lw3/g;->b(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, p0, Lcom/android/camera/effect/renders/g;->h:Lcom/android/camera/effect/renders/n;

    invoke-virtual {v1}, Lcom/android/camera/effect/renders/s;->g()V

    invoke-static {}, Lcom/android/camera/effect/b;->getInstance()Lcom/android/camera/effect/b;

    move-result-object v1

    invoke-virtual {v1}, Lcom/android/camera/effect/b;->needDestroyMakeup()Z
    ...
    invoke-virtual {v1, v2}, Lcom/android/camera/effect/b;->setDestroyMakeup(Z)V
    ...
    invoke-virtual {v1}, Lcom/android/camera/effect/b;->isBeautyFrameReady()Z
    ...
    invoke-virtual {p0, v1}, Lcom/android/camera/effect/renders/g;->v(I)Lcom/android/camera/effect/renders/r;
    ...
    invoke-virtual {v4, v1}, Lcom/android/camera/effect/renders/s;->b(Lcom/android/camera/effect/renders/r;)V
    ...
    sget v1, Lcom/android/camera/effect/c;->H:I
    ...
    invoke-virtual {v4}, Lcom/android/camera/effect/b;->getCurrentKaleidoscope()Ljava/lang/String;
    ...
    invoke-virtual {v2, v1}, Lcom/android/camera/effect/renders/s;->b(Lcom/android/camera/effect/renders/r;)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/effect/renders/g;->w()Lcom/android/camera/effect/renders/r;
    ...
    invoke-virtual {v1}, Lcom/android/camera/effect/renders/s;->m()Ljava/util/ArrayList;
