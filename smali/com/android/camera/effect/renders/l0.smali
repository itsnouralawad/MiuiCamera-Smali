...
.method public constructor <init>(Lcom/android/gallery3d/ui/h;)V
    ...
    .line 2
    iput p1, p0, Lcom/android/camera/effect/renders/l0;->l:F

    const p1, 0x3c23d70a    # 0.01f

    .line 3
    iput p1, p0, Lcom/android/camera/effect/renders/l0;->m:F

    const p1, 0xcd5c60

    .line 4
    iput p1, p0, Lcom/android/camera/effect/renders/l0;->n:I

    const p1, 0x6db2f4

    .line 5
    iput p1, p0, Lcom/android/camera/effect/renders/l0;->o:I

    const/high16 p1, 0x41000000    # 8.0f

    .line 6
    iput p1, p0, Lcom/android/camera/effect/renders/l0;->p:F

    const/high16 p1, 0x41200000    # 10.0f

    .line 7
    iput p1, p0, Lcom/android/camera/effect/renders/l0;->q:F

    const/high16 p1, 0x40000000    # 2.0f

    .line 8
    iput p1, p0, Lcom/android/camera/effect/renders/l0;->r:F
...
.method public b(FF)V
    ...
    iput p2, p0, Lcom/android/camera/effect/renders/l0;->m:F
...
.method public draw(Lt3/a;)Z
    ...
    iget v0, p0, Lcom/android/camera/effect/renders/l0;->r:F

    const/high16 v1, 0x3f800000    # 1.0f

    add-float/2addr v0, v1

    iput v0, p0, Lcom/android/camera/effect/renders/l0;->r:F
...
.method public initShader()V
    ...
    iput v0, p0, Lcom/android/camera/effect/renders/l0;->k:I
    ...
    iput v0, p0, Lcom/android/camera/effect/renders/l0;->f:I
    ...
    iput v0, p0, Lcom/android/camera/effect/renders/l0;->g:I
    ...
    iput v0, p0, Lcom/android/camera/effect/renders/l0;->i:I
    ...
    iput v0, p0, Lcom/android/camera/effect/renders/l0;->j:I
    ...
    iput v0, p0, Lcom/android/camera/effect/renders/l0;->h:I
...
.method public initShaderValue(Z)V
    ...
    iget p1, p0, Lcom/android/camera/effect/renders/l0;->k:I
    ...
    iget p1, p0, Lcom/android/camera/effect/renders/l0;->d:I

    iget v0, p0, Lcom/android/camera/effect/renders/l0;->l:F

    invoke-static {p1, v0}, Landroid/opengl/GLES20;->glUniform1f(IF)V

    iget p1, p0, Lcom/android/camera/effect/renders/l0;->e:I

    iget v0, p0, Lcom/android/camera/effect/renders/l0;->m:F

    invoke-static {p1, v0}, Landroid/opengl/GLES20;->glUniform1f(IF)V

    iget p1, p0, Lcom/android/camera/effect/renders/l0;->f:I

    iget v0, p0, Lcom/android/camera/effect/renders/l0;->n:I
    ...
    iget v2, p0, Lcom/android/camera/effect/renders/l0;->n:I
    ...
    iget v3, p0, Lcom/android/camera/effect/renders/l0;->n:I
    ...
    iget p1, p0, Lcom/android/camera/effect/renders/l0;->g:I

    iget v0, p0, Lcom/android/camera/effect/renders/l0;->o:I
    ...
    iget v2, p0, Lcom/android/camera/effect/renders/l0;->o:I
    ...
    iget v3, p0, Lcom/android/camera/effect/renders/l0;->o:I
    ...
    iget p1, p0, Lcom/android/camera/effect/renders/l0;->i:I

    iget v0, p0, Lcom/android/camera/effect/renders/l0;->p:F

    invoke-static {p1, v0}, Landroid/opengl/GLES20;->glUniform1f(IF)V

    iget p1, p0, Lcom/android/camera/effect/renders/l0;->j:I

    iget v0, p0, Lcom/android/camera/effect/renders/l0;->q:F

    invoke-static {p1, v0}, Landroid/opengl/GLES20;->glUniform1f(IF)V

    iget p1, p0, Lcom/android/camera/effect/renders/l0;->h:I

    iget p0, p0, Lcom/android/camera/effect/renders/l0;->r:F
