...
.method public final b(FFFFLcom/android/gallery3d/ui/j;)V
    ...
    iget-object p5, p0, Lcom/android/camera/effect/renders/r;->mGLCanvas:Lcom/android/gallery3d/ui/h;

    invoke-interface {p5}, Lcom/android/gallery3d/ui/h;->getState()Lcom/android/camera/effect/d;

    move-result-object p5

    invoke-virtual {p5}, Lcom/android/camera/effect/d;->k()V
    ...
    invoke-virtual {p5, p1, p2, v1}, Lcom/android/camera/effect/d;->t(FFF)V
    ...
    invoke-virtual {p5, p3, p4, p1}, Lcom/android/camera/effect/d;->m(FFF)V
    ...
    invoke-virtual {p3}, Lcom/android/camera/effect/d;->c()[F
    ...
    invoke-virtual {p3}, Lcom/android/camera/effect/d;->e()[F
    ...
    invoke-virtual {p3}, Lcom/android/camera/effect/d;->a()F
    ...
    invoke-virtual {p3}, Lcom/android/camera/effect/d;->b()F
...
.method public final c(Lcom/android/gallery3d/ui/b;FFIIII)V
    ...
    invoke-virtual {p1}, Lcom/android/camera/effect/d;->a()F
    ...
    iget-object p4, p0, Lcom/android/camera/effect/renders/r;->mGLCanvas:Lcom/android/gallery3d/ui/h;

    invoke-interface {p4}, Lcom/android/gallery3d/ui/h;->getState()Lcom/android/camera/effect/d;
    ...
    invoke-virtual {p4, p2, p3, p5}, Lcom/android/camera/effect/d;->t(FFF)V
...
.method public final d(Lcom/android/gallery3d/ui/b;IFFFFF)V
    ...
    invoke-virtual {p1}, Lcom/android/camera/effect/d;->k()V
    ...
    invoke-virtual {p1, p4, p5, p2}, Lcom/android/camera/effect/d;->t(FFF)V
    ...
    invoke-virtual {p1, p6, p7, p4}, Lcom/android/camera/effect/d;->m(FFF)V
    ...
    invoke-virtual {p5}, Lcom/android/camera/effect/d;->c()[F
    ...
    invoke-virtual {p5}, Lcom/android/camera/effect/d;->e()[F
    ...
    invoke-virtual {p5}, Lcom/android/camera/effect/d;->a()F
    ...
    invoke-virtual {p2}, Lcom/android/camera/effect/d;->b()F
...
.method public draw(Lt3/a;)Z
    ...
    iget v2, p1, Lt3/o;->s:I

    iget-object p1, p1, Lt3/o;->t:Ljava/nio/FloatBuffer;
    ...
    iget-object v0, p1, Lt3/m;->t:Lcom/android/gallery3d/ui/b;

    iget-object v2, p1, Lt3/m;->r:Landroid/graphics/RectF;

    iget-object p1, p1, Lt3/m;->s:Landroid/graphics/RectF;
    ...
    iget-object v3, p1, Lt3/k;->w:Lcom/android/gallery3d/ui/b;

    iget v4, p1, Lt3/k;->x:I

    iget v5, p1, Lt3/k;->t:F

    iget v6, p1, Lt3/k;->r:F

    iget v7, p1, Lt3/k;->s:F

    iget v8, p1, Lt3/k;->u:F

    iget v9, p1, Lt3/k;->v:F
    ...
    iget-object v3, p1, Lt3/i;->v:Lcom/android/gallery3d/ui/b;

    iget v4, p1, Lt3/i;->r:F

    iget v5, p1, Lt3/i;->s:F

    iget v6, p1, Lt3/i;->w:I

    iget v7, p1, Lt3/i;->x:I

    iget v8, p1, Lt3/i;->y:I

    iget v9, p1, Lt3/i;->z:I
    ...
    iget v3, p1, Lt3/l;->r:F

    iget v4, p1, Lt3/l;->s:F

    iget v5, p1, Lt3/l;->t:F

    iget v6, p1, Lt3/l;->u:F

    iget-object v7, p1, Lt3/l;->v:Lcom/android/gallery3d/ui/j;
    ...
    iget v3, p1, Lt3/h;->r:F

    iget v4, p1, Lt3/h;->s:F

    iget v5, p1, Lt3/h;->t:F

    iget v6, p1, Lt3/h;->u:F

    iget-object v7, p1, Lt3/h;->v:Lcom/android/gallery3d/ui/j;
...
.method public final f(FFFFLcom/android/gallery3d/ui/j;)V
    ...
    invoke-interface {v1}, Lcom/android/gallery3d/ui/h;->getState()Lcom/android/camera/effect/d;
    ...
    invoke-virtual {v1, p1, p2, v2}, Lcom/android/camera/effect/d;->t(FFF)V
    ...
    invoke-virtual {p1, p3, p4, p2}, Lcom/android/camera/effect/d;->m(FFF)V
...
.method public getFragShaderString()Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/android/camera/z5;->N3(Ljava/lang/String;)Ljava/lang/String;
...
.method public final h(Lcom/android/gallery3d/ui/b;Landroid/graphics/RectF;Landroid/graphics/RectF;)V
    ...
    invoke-virtual {v0, v1, v2, v3, p2}, Lcom/android/camera/effect/d;->q(FFFF)V
...
.method public final i(Lcom/android/gallery3d/ui/b;Landroid/graphics/RectF;[F)V
    ...
    iget-object v4, p0, Lcom/android/camera/effect/renders/r;->mGLCanvas:Lcom/android/gallery3d/ui/h;

    invoke-interface {v4}, Lcom/android/gallery3d/ui/h;->getState()Lcom/android/camera/effect/d;

    move-result-object v4

    invoke-virtual {v4}, Lcom/android/camera/effect/d;->b()F

    move-result v4

    instance-of v5, p1, Lcom/android/gallery3d/ui/r;

    if-eqz v5, :cond_2

    move-object v5, p1

    check-cast v5, Lcom/android/gallery3d/ui/r;

    invoke-virtual {v5}, Lcom/android/gallery3d/ui/r;->isPremultiplied()Z
    ...
    invoke-virtual {p1, v5, v6, v1}, Lcom/android/camera/effect/d;->t(FFF)V
    ...
    invoke-virtual {p1, v1, p2, v2}, Lcom/android/camera/effect/d;->m(FFF)V
    ...
    invoke-virtual {p2}, Lcom/android/camera/effect/d;->c()[F
    ...
    invoke-virtual {p2}, Lcom/android/camera/effect/d;->e()[F
...
.method public final j(Landroid/graphics/Rect;I)V
    ...
    invoke-virtual {p2}, Lcom/android/camera/effect/d;->k()V
    ...
    invoke-virtual {p2, v1, v2, v3}, Lcom/android/camera/effect/d;->t(FFF)V
    ...
    invoke-virtual {p2, v1, p1, v2}, Lcom/android/camera/effect/d;->m(FFF)V
    ...
    invoke-virtual {p2}, Lcom/android/camera/effect/d;->a()F
...
.method public final m(IZ)V
    ...
    iget-object v3, p0, Lcom/android/camera/effect/renders/r;->mGLCanvas:Lcom/android/gallery3d/ui/h;

    invoke-interface {v3}, Lcom/android/gallery3d/ui/h;->getState()Lcom/android/camera/effect/d;

    move-result-object v3

    invoke-virtual {v3}, Lcom/android/camera/effect/d;->a()F
