...
.field private mHapticFeedbackCompat:Lks/c;
...
.method public constructor <init>(Landroidx/recyclerview/widget/RemixRecyclerView;)V
    ...
    invoke-direct {v1, p1, v0}, Lzq/d;-><init>(Landroid/content/Context;Landroid/view/animation/Interpolator;)V

    iput-object v1, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lzq/d;
...
.method private getHapticFeedbackCompat()Lks/c;
    ...
    iget-object v0, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mHapticFeedbackCompat:Lks/c;
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mHapticFeedbackCompat:Lks/c;

    :cond_0
    iget-object p0, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mHapticFeedbackCompat:Lks/c;
...
.method private internalPostOnAnimation()V
    ...
    invoke-static {v0, p0}, Lzq/a;->b(Landroid/view/View;Ljava/lang/Runnable;)V
...
.method public fling(II)V
    ...
    invoke-direct {v2, v4, v3}, Lzq/d;-><init>(Landroid/content/Context;Landroid/view/animation/Interpolator;)V

    iput-object v2, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lzq/d;
    ...
    :cond_9
    :goto_4
    iget-object v3, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lzq/d;
    ...
    invoke-virtual/range {v3 .. v11}, Lzq/d;->d(IIIIIIII)V
...
.method public resetFlingPosition()V
    ...
    iget-object p0, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lzq/d;

    invoke-virtual {p0}, Lzq/d;->w()V
...
.method public run()V
    ...
    iget-object v1, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lzq/d;
    ...
    iget-object v6, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lzq/d;

    invoke-virtual {v6}, Lzq/d;->o()I

    move-result v6

    if-ne v6, v3, :cond_1

    invoke-virtual {v1}, Lzq/d;->h()F
    ...
    iget-object v4, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lzq/d;

    invoke-virtual {v4}, Lzq/d;->o()I
    ...
    iget-object v8, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lzq/d;

    invoke-virtual {v8}, Lzq/d;->h()F

    move-result v8

    iget-object v9, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lzq/d;

    invoke-virtual {v9}, Lzq/d;->i()F

    move-result v9

    invoke-interface {v7, v8, v9}, Lmp/c;->b(FF)Z
    ...
    iget-object v5, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lzq/d;

    invoke-virtual {v5}, Lzq/d;->q()I
    ...
    invoke-direct/range {p0 .. p0}, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->getHapticFeedbackCompat()Lks/c;

    move-result-object v1

    const/16 v4, 0xc9

    invoke-virtual {v1, v4}, Lks/c;->o(I)V
...
.method public smoothScrollBy(IIILandroid/view/animation/Interpolator;)V
    ...
    :cond_2
    iget-object p3, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lzq/d;

    invoke-virtual {p3}, Lzq/d;->o()I
    ...
    invoke-direct {p3, v2, p4}, Lzq/d;-><init>(Landroid/content/Context;Landroid/view/animation/Interpolator;)V

    iput-object p3, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lzq/d;
    ...
    iget-object v1, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lzq/d;
    ...
    invoke-virtual/range {v1 .. v7}, Lzq/d;->G(IIIIII)V
