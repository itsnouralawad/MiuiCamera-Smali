...
.method public static a(Ljava/lang/String;)Ld/b;
    .locals 1
    ...
    invoke-static {p0, v0}, Le/e;->b(Ljava/lang/String;Ld/b;)Ld/b;
...
.method public static b(Ljava/lang/String;Ld/b;)Ld/b;
    .locals 13
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ld/e;
    ...
    invoke-direct {v0, p0}, Le/i;-><init>(Ljava/lang/String;)V

    const/4 p0, 0x0

    invoke-virtual {v0, p0}, Le/i;->b(I)C
    ...
    invoke-virtual {v0, v3}, Le/i;->b(I)C
    ...
    invoke-virtual {v0, v5}, Le/i;->b(I)C
    ...
    invoke-virtual {v0, v7, v8}, Le/i;->c(Ljava/lang/String;I)I
    ...
    invoke-direct {p0, p1, v6}, Ld/e;-><init>(Ljava/lang/String;I)V
    ...
    :cond_6
    invoke-interface {p1, v7}, Ld/b;->q(I)V
    ...
    :cond_9
    :goto_3
    invoke-interface {p1, v7}, Ld/b;->p(I)V
    ...
    :cond_d
    invoke-interface {p1, v3}, Ld/b;->p(I)V
    ...
    invoke-virtual {v0, v1, v4}, Le/i;->c(Ljava/lang/String;I)I
    ...
    invoke-interface {p1, v1}, Ld/b;->T(I)V
    ...
    invoke-virtual {v0, v1, v7}, Le/i;->c(Ljava/lang/String;I)I
    ...
    :cond_11
    :goto_6
    invoke-interface {p1, v1}, Ld/b;->X(I)V
    ...
    :cond_13
    :goto_7
    invoke-interface {p1, v1}, Ld/b;->c0(I)V
    ...
    invoke-virtual {v0, v8, v11}, Le/i;->c(Ljava/lang/String;I)I
    ...
    :cond_17
    invoke-interface {p1, v8}, Ld/b;->R(I)V
    ...
    invoke-virtual {v0, v2, v7}, Le/i;->c(Ljava/lang/String;I)I
    ...
    invoke-interface {p1, v1}, Ld/b;->setTimeZone(Ljava/util/TimeZone;)V
...
.method public static c(Ld/b;)Ljava/lang/String;
    .locals 8
    ...
    invoke-interface {p0}, Ld/b;->getHour()I

    move-result v2

    if-nez v2, :cond_2

    invoke-interface {p0}, Ld/b;->getMinute()I

    move-result v2

    if-nez v2, :cond_2

    invoke-interface {p0}, Ld/b;->getSecond()I

    move-result v2

    if-nez v2, :cond_2

    invoke-interface {p0}, Ld/b;->f()I

    move-result v2

    if-nez v2, :cond_2

    invoke-interface {p0}, Ld/b;->getTimeZone()Ljava/util/TimeZone;
