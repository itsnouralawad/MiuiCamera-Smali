...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Li2/i;->b:Li2/f;
    ...
    iput-object v0, p0, Li2/i;->a:Landroid/util/SparseArray;
...
.method public static f()V
    ...
    invoke-virtual {v1, v0, v3}, Lcom/android/camera/data/data/g;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v3, v0}, Lr2/a$a;->remove(Ljava/lang/String;)Lr2/a$a;

    move-result-object v3

    invoke-interface {v3, v0, v1, v2}, Lr2/a$a;->putLong(Ljava/lang/String;J)Lr2/a$a;
...
.method public a()V
    ...
    iget-object v0, p0, Li2/i;->b:Li2/f;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Li2/c;->c(Z)V

    invoke-virtual {p0}, Li2/i;->d()Li2/a$a;

    move-result-object v0

    invoke-interface {v0, v1}, Li2/a$a;->c(Z)V

    invoke-virtual {p0, v1}, Li2/i;->c(I)Li2/a$b;

    move-result-object v0

    invoke-interface {v0, v1}, Li2/a$b;->c(Z)V

    const/4 v0, 0x0

    invoke-virtual {p0, v0}, Li2/i;->c(I)Li2/a$b;

    move-result-object p0

    invoke-interface {p0, v1}, Li2/a$b;->c(Z)V

    return-void

    :cond_0
    invoke-static {v0, v1}, Li2/i;->n(J)V

    new-instance v0, Li2/i$a;

    invoke-direct {v0, p0}, Li2/i$a;-><init>(Li2/i;)V
...
.method public b()Li2/a$b;
    ...
    :cond_0
    iget-object p0, p0, Li2/i;->b:Li2/f;

    return-object p0
.end method

.method public c(I)Li2/a$b;
    .locals 1

    iget-object v0, p0, Li2/i;->a:Landroid/util/SparseArray;
    ...
    invoke-direct {v0, p1}, Li2/d;-><init>(I)V

    iget-object p0, p0, Li2/i;->a:Landroid/util/SparseArray;
...
.method public d()Li2/a$a;
    .locals 1

    iget-object v0, p0, Li2/i;->c:Li2/b;
    ...
    iput-object v0, p0, Li2/i;->c:Li2/b;

    :cond_0
    iget-object p0, p0, Li2/i;->c:Li2/b;
...
.method public final g()V
    ...
    invoke-virtual {p0, v2}, Li2/i;->c(I)Li2/a$b;
    ...
    invoke-static {v4, v5, v6}, Li2/i;->k(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v7

    invoke-static {}, Li2/i;->h()Ljava/lang/String;
    ...
    invoke-static {v9, v5, v6}, Li2/i;->k(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v5

    invoke-static {}, Li2/i;->i()Ljava/lang/String;

    move-result-object v6

    iget-object v9, p0, Li2/i;->b:Li2/f;

    invoke-virtual {v9, v2}, Li2/c;->c(Z)V

    invoke-virtual {p0}, Li2/i;->d()Li2/a$a;

    move-result-object v9

    invoke-interface {v9, v2}, Li2/a$a;->c(Z)V

    invoke-interface {v1, v2}, Li2/a$b;->c(Z)V

    invoke-interface {v3, v2}, Li2/a$b;->c(Z)V
    ...
    invoke-virtual {v9}, Li2/c;->b()Landroid/content/SharedPreferences$Editor;
    ...
    invoke-interface {v9}, Li2/a$a;->b()Landroid/content/SharedPreferences$Editor;
    ...
    invoke-interface {v1}, Li2/a$b;->b()Landroid/content/SharedPreferences$Editor;
    ...
    invoke-interface {v3}, Li2/a$b;->b()Landroid/content/SharedPreferences$Editor;
    ...
    invoke-static {v7}, Li2/i;->l(Ljava/lang/String;)V

    invoke-virtual {p0, v4}, Li2/i;->o(Ljava/lang/String;)V
    ...
    invoke-static {v5}, Li2/i;->m(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v2}, Li2/i;->o(Ljava/lang/String;)V

    :cond_2
    iget-object v2, p0, Li2/i;->b:Li2/f;

    invoke-virtual {v2, v0}, Li2/c;->c(Z)V

    invoke-virtual {p0}, Li2/i;->d()Li2/a$a;

    move-result-object p0

    invoke-interface {p0, v0}, Li2/a$a;->c(Z)V

    invoke-interface {v1, v0}, Li2/a$b;->c(Z)V

    invoke-interface {v3, v0}, Li2/a$b;->c(Z)V
...
.method public final o(Ljava/lang/String;)V
    ...
    invoke-static {p1, v2, v3}, Li2/i;->k(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v8, p0, Li2/i;->b:Li2/f;
    ...
    iget-object v8, p0, Li2/i;->a:Landroid/util/SparseArray;
    ...
    invoke-virtual {v8}, Li2/c;->b()Landroid/content/SharedPreferences$Editor;
    ...
    invoke-static {p1, v0, v3}, Li2/i;->k(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {p0}, Li2/a$a;->b()Landroid/content/SharedPreferences$Editor;
