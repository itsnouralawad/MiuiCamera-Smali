...
.method private newDrawing()V
    ...
    invoke-static {}, Lkv/c$a;->a()Lkv/c;

    move-result-object v0

    sget-object v1, Lmv/o;->w7:Lmv/o$a;

    invoke-interface {v0, v1}, Lkv/c;->w3(Lmv/o$a;)V

    invoke-interface {v0}, Lkv/c;->Cp()Lkv/a;

    move-result-object v2

    invoke-interface {v2, v1}, Lkv/a;->w3(Lmv/o$a;)V

    const-string v1, "1"

    invoke-interface {v2, v1}, Lkv/a;->setData(Ljava/lang/String;)V
    ...
    invoke-interface {v0, v1}, Lmv/j;->setId(Ljava/lang/String;)V

    const-string v1, "21600,21600"

    invoke-interface {v0, v1}, Lmv/j;->h6(Ljava/lang/String;)V

    const/high16 v1, 0x434a0000    # 202.0f

    invoke-interface {v0, v1}, Lmv/j;->h8(F)V

    const-string v1, "m,l,21600r21600,l21600,xe"

    invoke-interface {v0, v1}, Lmv/j;->E8(Ljava/lang/String;)V

    invoke-interface {v0}, Lmv/j;->o6()Lmv/k;

    move-result-object v1

    sget-object v2, Lmv/p;->E7:Lmv/p$a;

    invoke-interface {v1, v2}, Lmv/k;->Q9(Lmv/p$a;)V

    invoke-interface {v0}, Lmv/j;->addNewPath()Lmv/g;

    move-result-object v1

    sget-object v2, Lmv/q;->J7:Lmv/q$a;

    invoke-interface {v1, v2}, Lmv/g;->kf(Lmv/q$a;)V

    sget-object v2, Lkv/d;->F6:Lkv/d$a;

    invoke-interface {v1, v2}, Lmv/g;->tr(Lkv/d$a;)V
...
.method public findCommentShape(II)Lmv/i;
    .locals 5
    ...
    invoke-interface {v0}, Lmv/i;->B0()I
    ...
    invoke-interface {v0, v1}, Lmv/i;->t6(I)Liv/a;

    move-result-object v2

    invoke-interface {v2}, Liv/a;->UD()Liv/b$a;

    move-result-object v3

    sget-object v4, Liv/b;->J5:Liv/b$a;

    if-ne v3, v4, :cond_0

    invoke-interface {v2, v1}, Liv/a;->getRowArray(I)Ljava/math/BigInteger;
    ...
    invoke-interface {v2, v1}, Liv/a;->Uo(I)Ljava/math/BigInteger;
...
.method public newCommentShape()Lmv/i;
    .locals 5

    invoke-static {}, Lmv/i$a;->a()Lmv/i;
    ...
    invoke-interface {v0, v1}, Lmv/i;->setId(Ljava/lang/String;)V
    ...
    invoke-interface {v0, v1}, Lmv/i;->setType(Ljava/lang/String;)V

    const-string v1, "position:absolute; visibility:hidden"

    invoke-interface {v0, v1}, Lmv/i;->l(Ljava/lang/String;)V

    const-string v1, "#ffffe1"

    invoke-interface {v0, v1}, Lmv/i;->S2(Ljava/lang/String;)V

    sget-object v2, Lkv/e;->N6:Lkv/e$a;

    invoke-interface {v0, v2}, Lmv/i;->r(Lkv/e$a;)V

    invoke-interface {v0}, Lmv/i;->addNewFill()Lmv/b;

    move-result-object v2

    invoke-interface {v2, v1}, Lmv/b;->setColor(Ljava/lang/String;)V

    invoke-interface {v0}, Lmv/i;->addNewShadow()Lmv/h;

    move-result-object v1

    sget-object v2, Lmv/q;->J7:Lmv/q$a;

    invoke-interface {v1, v2}, Lmv/h;->s(Lmv/q$a;)V

    const-string v3, "black"

    invoke-interface {v1, v3}, Lmv/h;->setColor(Ljava/lang/String;)V

    invoke-interface {v1, v2}, Lmv/h;->Ne(Lmv/q$a;)V

    invoke-interface {v0}, Lmv/i;->addNewPath()Lmv/g;

    move-result-object v1

    sget-object v2, Lkv/d;->E6:Lkv/d$a;

    invoke-interface {v1, v2}, Lmv/g;->tr(Lkv/d$a;)V

    invoke-interface {v0}, Lmv/i;->S()Lmv/m;

    move-result-object v1

    const-string v2, "mso-direction-alt:auto"

    invoke-interface {v1, v2}, Lmv/m;->l(Ljava/lang/String;)V

    invoke-interface {v0}, Lmv/i;->addNewClientData()Liv/a;

    move-result-object v1

    sget-object v2, Liv/b;->J5:Liv/b$a;

    invoke-interface {v1, v2}, Liv/a;->Ig(Liv/b$a;)V

    invoke-interface {v1}, Liv/a;->Ka()Liv/c;

    invoke-interface {v1}, Liv/a;->pA()Liv/c;

    invoke-interface {v1}, Liv/a;->addNewAnchor()Lorg/apache/xmlbeans/XmlString;
    ...
    invoke-interface {v1}, Liv/a;->Oy()Liv/c;
    ...
    invoke-interface {v1}, Liv/a;->addNewRow()Lorg/apache/xmlbeans/XmlInteger;
    ...
    invoke-interface {v1}, Liv/a;->G8()Lorg/apache/xmlbeans/XmlInteger;
...
.method public read(Ljava/io/InputStream;)V
    ...
    invoke-static {v2}, Lkv/c$a;->k(Ljava/lang/String;)Lkv/c;
    ...
    invoke-static {v2}, Lmv/j$a;->k(Ljava/lang/String;)Lmv/j;
    ...
    invoke-interface {v2}, Lmv/j;->getId()Ljava/lang/String;
    ...
    invoke-static {v2}, Lmv/i$a;->k(Ljava/lang/String;)Lmv/i;

    move-result-object v2

    invoke-interface {v2}, Lmv/i;->getId()Ljava/lang/String;
...
.method public removeCommentShape(II)Z
    ...
    invoke-virtual {p0, p1, p2}, Lorg/apache/poi/xssf/usermodel/XSSFVMLDrawing;->findCommentShape(II)Lmv/i;
