...
.method private getWatermarkParagraph(Ljava/lang/String;I)Lorg/apache/poi/xwpf/usermodel/XWPFParagraph;
    ...
    invoke-static {}, Lmv/d$a;->a()Lmv/d;

    move-result-object v2

    invoke-interface {v2}, Lmv/d;->Fl()Lmv/j;

    move-result-object v3

    const-string v4, "_x0000_t136"

    invoke-interface {v3, v4}, Lmv/j;->setId(Ljava/lang/String;)V

    const-string v4, "1600,21600"

    invoke-interface {v3, v4}, Lmv/j;->h6(Ljava/lang/String;)V

    const/high16 v4, 0x43080000    # 136.0f

    invoke-interface {v3, v4}, Lmv/j;->h8(F)V

    const-string v4, "10800"

    invoke-interface {v3, v4}, Lmv/j;->u8(Ljava/lang/String;)V

    const-string v4, "m@7,0l@8,0m@5,21600l@6,21600e"

    invoke-interface {v3, v4}, Lmv/j;->E8(Ljava/lang/String;)V

    invoke-interface {v3}, Lmv/j;->i1()Lmv/c;

    move-result-object v4

    invoke-interface {v4}, Lmv/c;->addNewF()Lmv/a;

    move-result-object v5

    const-string v6, "sum #0 0 10800"

    invoke-interface {v5, v6}, Lmv/a;->da(Ljava/lang/String;)V
    ...
    invoke-interface {v4, v5}, Lmv/a;->da(Ljava/lang/String;)V

    invoke-interface {v3}, Lmv/j;->addNewPath()Lmv/g;

    move-result-object v4

    sget-object v5, Lmv/q;->J7:Lmv/q$a;

    invoke-interface {v4, v5}, Lmv/g;->Jh(Lmv/q$a;)V

    sget-object v6, Lkv/d;->H6:Lkv/d$a;

    invoke-interface {v4, v6}, Lmv/g;->tr(Lkv/d$a;)V

    const-string v6, "@9,0;@10,10800;@11,21600;@12,10800"

    invoke-interface {v4, v6}, Lmv/g;->al(Ljava/lang/String;)V

    const-string v6, "270,180,90,0"

    invoke-interface {v4, v6}, Lmv/g;->Ai(Ljava/lang/String;)V

    invoke-interface {v3}, Lmv/j;->W1()Lmv/l;

    move-result-object v4

    invoke-interface {v4, v5}, Lmv/l;->s(Lmv/q$a;)V

    invoke-interface {v4, v5}, Lmv/l;->fv(Lmv/q$a;)V

    invoke-interface {v3}, Lmv/j;->t4()Lmv/f;

    move-result-object v4

    invoke-interface {v4}, Lmv/f;->addNewH()Lmv/e;

    move-result-object v4

    const-string v5, "#0,bottomRight"

    invoke-interface {v4, v5}, Lmv/e;->setPosition(Ljava/lang/String;)V

    const-string v5, "6629,14971"

    invoke-interface {v4, v5}, Lmv/e;->sg(Ljava/lang/String;)V

    invoke-interface {v3}, Lmv/j;->addNewLock()Lkv/b;

    move-result-object v3

    sget-object v4, Lmv/o;->w7:Lmv/o$a;

    invoke-interface {v3, v4}, Lkv/b;->w3(Lmv/o$a;)V

    invoke-interface {v2}, Lmv/d;->UA()Lmv/i;
    ...
    invoke-interface {v3, v4}, Lmv/i;->setId(Ljava/lang/String;)V
    ...
    invoke-interface {v3, p2}, Lmv/i;->Z(Ljava/lang/String;)V

    const-string p2, "#_x0000_t136"

    invoke-interface {v3, p2}, Lmv/i;->setType(Ljava/lang/String;)V
    ...
    invoke-interface {v3, p2}, Lmv/i;->l(Ljava/lang/String;)V
    ...
    invoke-interface {v3, p2}, Lmv/i;->C4(Ljava/lang/String;)V

    const-string p2, "black"

    invoke-interface {v3, p2}, Lmv/i;->S2(Ljava/lang/String;)V

    sget-object p2, Lmv/q;->M7:Lmv/q$a;

    invoke-interface {v3, p2}, Lmv/i;->b7(Lmv/q$a;)V

    invoke-interface {v3}, Lmv/i;->W1()Lmv/l;

    move-result-object p2

    const-string v3, "font-family:&quot;Cambria&quot;;font-size:1pt"

    invoke-interface {p2, v3}, Lmv/l;->l(Ljava/lang/String;)V

    invoke-interface {p2, p1}, Lmv/l;->pF(Ljava/lang/String;)V
