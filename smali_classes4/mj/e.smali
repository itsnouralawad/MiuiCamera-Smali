...
.method public static synthetic a(IZ)V
    ...
    invoke-static {p0, p1}, Lmj/e;->n(IZ)V

    return-void
.end method

.method public static synthetic b(Ljava/lang/String;Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicInteger;Lqj/b;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lmj/e;->k(Ljava/lang/String;Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicInteger;Lqj/b;Ljava/util/concurrent/atomic/AtomicBoolean;)V

    return-void
.end method

.method public static synthetic c([B[BLjava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Lqj/b;Ljava/util/concurrent/atomic/AtomicInteger;)V
    .locals 0

    invoke-static/range {p0 .. p5}, Lmj/e;->m([B[BLjava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Lqj/b;Ljava/util/concurrent/atomic/AtomicInteger;)V

    return-void
.end method

.method public static synthetic d(Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Lqj/b;Ljava/util/concurrent/atomic/AtomicInteger;ILjava/lang/String;)V
    .locals 0

    invoke-static/range {p0 .. p5}, Lmj/e;->l(Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Lqj/b;Ljava/util/concurrent/atomic/AtomicInteger;ILjava/lang/String;)V
...
.method public static f()Z
    ...
    sget-object v0, Lmj/e;->a:Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Luk/c;->a(Ljava/lang/String;Ljava/lang/String;)V

    return v4

    :cond_0
    invoke-static {v1}, Luk/i;->p(Ljava/lang/String;)Z
...
.method public static g(Lcom/faceunity/core/avatar/model/Avatar;Ljava/util/List;)Z
    ...
    sget-object p0, Lmj/e;->a:Ljava/lang/String;

    const-string p1, "checkAvatarIsLegal avatar isEmpty"

    invoke-static {p0, p1}, Luk/c;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v5}, Luk/i;->p(Ljava/lang/String;)Z
    ...
    invoke-static {v1, v4}, Lmj/e;->e(Ljava/lang/StringBuilder;Ljava/lang/String;)V
    ...
    sget-object p1, Lmj/e;->a:Ljava/lang/String;
    ...
    invoke-static {p1, p0}, Luk/c;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static h(Lfk/f;Lcom/faceunity/core/avatar/model/Avatar;)Z
    .locals 5
    ...
    invoke-static {p1}, Luk/i;->p(Ljava/lang/String;)Z
    ...
    :cond_2
    invoke-static {v0, v3}, Lmj/e;->e(Ljava/lang/StringBuilder;Ljava/lang/String;)V
    ...
    invoke-static {v0, p1}, Lmj/e;->e(Ljava/lang/StringBuilder;Ljava/lang/String;)V
    ...
    invoke-static {v0, p0}, Lmj/e;->e(Ljava/lang/StringBuilder;Ljava/lang/String;)V
...
.method public static i(ZILqj/b;)V
    .locals 0
    ...
    invoke-static {}, Lmj/e;->f()Z

    move-result p0

    if-eqz p0, :cond_1

    invoke-static {}, Lmj/e;->p()V
    ...
    invoke-interface {p2, p0, p1}, Lqj/b;->a(ILjava/lang/String;)V
    ...
    invoke-interface {p2, p0, p1}, Lqj/b;->c(ILjava/lang/String;)V
...
.method public static j(Ljava/lang/String;Lqj/b;)V
    .locals 13
    ...
    invoke-virtual {v0, v3, v4}, Luk/f;->d([B[B)V
    ...
    invoke-direct/range {v5 .. v10}, Lmj/b;-><init>(Ljava/lang/String;Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicInteger;Lqj/b;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    ...
    invoke-static {p0}, Lmj/e;->q(Lcom/faceunity/toolbox/utils/FULogger$LogLevel;)V

    sget-object p0, Lcom/faceunity/toolbox/utils/FULogger$LogLevel;->INFO:Lcom/faceunity/toolbox/utils/FULogger$LogLevel;

    invoke-static {p0}, Lmj/e;->r(Lcom/faceunity/toolbox/utils/FULogger$LogLevel;)V
    ...
    invoke-direct/range {v2 .. v8}, Lmj/c;-><init>([B[BLjava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Lqj/b;Ljava/util/concurrent/atomic/AtomicInteger;)V
...
.method public static synthetic k(Ljava/lang/String;Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicInteger;Lqj/b;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    .locals 3
    ...
    invoke-virtual {v1, v2, p0}, Lbk/e;->G(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p2, v1, p3}, Lmj/e;->i(ZILqj/b;)V
...
.method public static synthetic l(Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Lqj/b;Ljava/util/concurrent/atomic/AtomicInteger;ILjava/lang/String;)V
    .locals 2
    ...
    invoke-static {v1, p4, p2}, Lmj/e;->i(ZILqj/b;)V
    ...
    invoke-interface {p2, p4, p5}, Lqj/b;->c(ILjava/lang/String;)V
...
.method public static synthetic m([B[BLjava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Lqj/b;Ljava/util/concurrent/atomic/AtomicInteger;)V
    .locals 2
    ...
    invoke-direct {v0, p2, p3, p4, p5}, Lmj/a;-><init>(Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Lqj/b;Ljava/util/concurrent/atomic/AtomicInteger;)V
...
.method public static synthetic n(IZ)V
    ...
    invoke-virtual {v1}, Loj/b;->g()Lcom/faceunity/core/avatar/model/Scene;

    move-result-object v2

    invoke-virtual {v1, p0}, Loj/b;->p(I)Lck/c;
    ...
    invoke-virtual {v3}, Lck/c;->b()Lqh/a;
    ...
    invoke-static {v5, v4}, Lmj/e;->g(Lcom/faceunity/core/avatar/model/Avatar;Ljava/util/List;)Z
    ...
    invoke-static {v0, v5}, Luk/c;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v5, v7, v4}, Lbk/e;->f(Lcom/faceunity/core/avatar/model/Avatar;Ljava/util/List;)V

    goto :goto_0

    :cond_1
    invoke-static {v0, v6}, Luk/c;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v4, v5}, Loj/b;->b(Lcom/faceunity/core/avatar/model/Avatar;Ljava/lang/String;)V

    invoke-virtual {v3}, Lck/c;->a()Lcom/faceunity/core/avatar/model/Avatar;

    move-result-object v4

    sget-object v5, Lpj/b;->a:Lpj/b;

    invoke-virtual {v1, v4, v5}, Loj/b;->q(Lcom/faceunity/core/avatar/model/Avatar;Lpj/b;)Lfk/f;
    ...
    invoke-static {v4, v5}, Lmj/e;->h(Lfk/f;Lcom/faceunity/core/avatar/model/Avatar;)Z
    ...
    invoke-virtual {p1, v4, v5}, Lbk/e;->R(Lfk/f;Lcom/faceunity/core/avatar/model/Avatar;)V
    ...
    :cond_5
    :goto_2
    invoke-virtual {v1, v2, v4}, Loj/b;->f(Lcom/faceunity/core/avatar/model/Scene;Lfk/f;)V

    invoke-virtual {v1, v2}, Loj/b;->s(Lcom/faceunity/core/avatar/model/Scene;)V

    invoke-virtual {v3}, Lck/c;->a()Lcom/faceunity/core/avatar/model/Avatar;

    move-result-object p1

    invoke-virtual {v1, v2, p1}, Loj/b;->e(Lcom/faceunity/core/avatar/model/Scene;Lcom/faceunity/core/avatar/model/Avatar;)V
    ...
    invoke-static {p0, p1}, Lmj/e;->e(Ljava/lang/StringBuilder;Ljava/lang/String;)V
    ...
    invoke-static {v0, p0}, Luk/c;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static o(IZ)V
    ...
    invoke-direct {v1, p0, p1}, Lmj/d;-><init>(IZ)V
...
.method public static p()V
    ...
    sget-object v2, Lnj/a;->c:Ljava/lang/String;
