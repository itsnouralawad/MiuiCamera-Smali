...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lii/a;->a:Ljava/lang/Object;

    const/16 v0, 0x10e

    iput v0, p0, Lii/a;->g:I
    ...
    iput-object v1, p0, Lii/a;->h:Lcom/faceunity/wrapper/faceunity$AvatarInfo;

    const/16 v1, 0xa

    new-array v1, v1, [F

    iput-object v1, p0, Lii/a;->i:[F

    const/4 v1, 0x4

    new-array v2, v1, [F

    iput-object v2, p0, Lii/a;->j:[F

    const/4 v2, 0x0

    iput-boolean v2, p0, Lii/a;->k:Z

    const/16 v2, 0x96

    new-array v2, v2, [F

    iput-object v2, p0, Lii/a;->l:[F

    new-array v2, v1, [I

    iput-object v2, p0, Lii/a;->m:[I

    const/4 v2, 0x1

    iput v2, p0, Lii/a;->s:I

    iput-boolean v2, p0, Lii/a;->u:Z

    iput v0, p0, Lii/a;->v:I

    sget-object v0, Lii/a$e;->d:Lii/a$e;

    iput-object v0, p0, Lii/a;->w:Lii/a$e;

    new-instance v0, Ljava/util/LinkedList;

    invoke-direct {v0}, Ljava/util/LinkedList;-><init>()V

    iput-object v0, p0, Lii/a;->b:Ljava/util/LinkedList;

    new-instance v0, Ljava/util/LinkedList;

    invoke-direct {v0}, Ljava/util/LinkedList;-><init>()V

    iput-object v0, p0, Lii/a;->c:Ljava/util/LinkedList;
    ...
    iget-object p0, p0, Lii/a;->h:Lcom/faceunity/wrapper/faceunity$AvatarInfo;
...
.method public C(Ljava/lang/Runnable;)V
    ...
    iget-object v0, p0, Lii/a;->b:Ljava/util/LinkedList;

    if-eqz v0, :cond_0

    iget-object p0, p0, Lii/a;->b:Ljava/util/LinkedList;
...
.method public I()V
    ...
    invoke-virtual {p0, v1}, Lii/a;->z(Ljava/util/List;)V

    iget-object v1, p0, Lii/a;->e:Ljava/util/List;
    ...
    iget-object p0, p0, Lii/a;->e:Ljava/util/List;
...
.method public Q()I
    ...
    iget p0, p0, Lii/a;->L:I

    return p0
.end method

.method public R()Lii/a$e;
    .locals 0
...
.method public T()[F
    ...
    iget-object v1, p0, Lii/a;->i:[F

    const/4 v2, 0x0

    invoke-static {v2, v0, v1}, Lcom/faceunity/wrapper/faceunity;->fuGetFaceInfo(ILjava/lang/String;[F)I

    iget-object p0, p0, Lii/a;->i:[F
...
.method public W()V
    ...
    iget-object v0, p0, Lii/a;->h:Lcom/faceunity/wrapper/faceunity$AvatarInfo;
    ...
    iget v4, p0, Lii/a;->f:I

    add-int/lit8 v5, v4, 0x1

    iput v5, p0, Lii/a;->f:I

    iget-object v5, p0, Lii/a;->m:[I
...
.method public final X([BIII)I
    ...
    invoke-virtual {p0, p3, p4}, Lii/a;->V(II)I
    ...
    invoke-virtual {p0}, Lii/a;->G()V

    iget v0, p0, Lii/a;->s:I
    ...
    iget-boolean v2, p0, Lii/a;->k:Z

    if-eqz v2, :cond_1

    if-eqz p1, :cond_1

    iget v5, p0, Lii/a;->q:I

    iget v8, p0, Lii/a;->f:I

    add-int/lit8 v2, v8, 0x1

    iput v2, p0, Lii/a;->f:I

    iget-object v9, p0, Lii/a;->m:[I
    ...
    :cond_1
    iget-object v2, p0, Lii/a;->h:Lcom/faceunity/wrapper/faceunity$AvatarInfo;

    const/4 v3, 0x1

    iget v6, p0, Lii/a;->f:I

    add-int/lit8 p1, v6, 0x1

    iput p1, p0, Lii/a;->f:I

    iget-object v7, p0, Lii/a;->m:[I
    ...
    invoke-static {p2, p0}, Loi/c;->c(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final Y([BIII)I
    ...
    iget v3, p0, Lii/a;->q:I

    iget v6, p0, Lii/a;->f:I

    add-int/lit8 v0, v6, 0x1

    iput v0, p0, Lii/a;->f:I
...
.method public final c0()V
    ...
    invoke-static {v1, v0}, Loi/c;->f(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_0
    :try_start_0
    iget-object v1, p0, Lii/a;->b:Ljava/util/LinkedList;
    ...
    invoke-virtual {p0}, Lii/a;->J()Ljava/lang/Runnable;
    ...
    iget-object v0, p0, Lii/a;->c:Ljava/util/LinkedList;

    invoke-virtual {p0, v0}, Lii/a;->z(Ljava/util/List;)V

    iget-object v0, p0, Lii/a;->c:Ljava/util/LinkedList;

    if-eqz v0, :cond_3

    iget-object p0, p0, Lii/a;->c:Ljava/util/LinkedList;
...
.method public d0()V
    ...
    invoke-direct {v0, p0}, Lii/a$c;-><init>(Lii/a;)V
...
.method public final e0()V
    ...
    iput-object v1, p0, Lii/a;->b:Ljava/util/LinkedList;
    ...
    iput-object v1, p0, Lii/a;->c:Ljava/util/LinkedList;
    ...
    iput-object v1, p0, Lii/a;->d:Ljava/util/List;

    :cond_2
    iget-object v0, p0, Lii/a;->e:Ljava/util/List;

    if-eqz v0, :cond_3

    invoke-interface {v0}, Ljava/util/List;->clear()V

    iput-object v1, p0, Lii/a;->e:Ljava/util/List;
...
.method public g(ZI)V
    ...
    iput-boolean p1, p0, Lii/a;->u:Z

    new-instance p1, Lii/a$b;

    invoke-direct {p1, p0, p2}, Lii/a$b;-><init>(Lii/a;I)V
...
.method public s()[F
    ...
    iget-object v1, p0, Lii/a;->l:[F

    const/4 v2, 0x0

    invoke-static {v2, v0, v1}, Lcom/faceunity/wrapper/faceunity;->fuGetFaceInfo(ILjava/lang/String;[F)I

    iget-object p0, p0, Lii/a;->l:[F
...
.method public u(I)V
    ...
    iput p1, p0, Lii/a;->v:I

    iget-boolean p1, p0, Lii/a;->u:Z

    const/16 v0, 0x5a

    if-eqz p1, :cond_0

    iget p1, p0, Lii/a;->v:I
    ...
    invoke-direct {v0, p0}, Lii/a$a;-><init>(Lii/a;)V

    invoke-virtual {p0, v0}, Lii/a;->q(Ljava/lang/Runnable;)V

    :cond_3
    iput p1, p0, Lii/a;->s:I
...
.method public y([BIIII)I
    ...
    :cond_1
    invoke-virtual {p0}, Lii/a;->onSurfaceCreated()Z
    ...
    :cond_2
    sget-object v1, Lii/a$d;->a:[I

    iget-object v3, p0, Lii/a;->w:Lii/a$e;
    ...
    :cond_3
    invoke-virtual {p0, p1, p2, p3, p4}, Lii/a;->Y([BIII)I
    ...
    :cond_4
    invoke-virtual {p0, p1, p5, p3, p4}, Lii/a;->a0([BIII)I
    ...
    :cond_5
    invoke-virtual {p0, p1, p2, p3, p4}, Lii/a;->X([BIII)I
    ...
    :cond_6
    invoke-virtual {p0, p1, p2, p3, p4}, Lii/a;->Z([BIII)I

    move-result p1

    :goto_1
    iget p2, p0, Lii/a;->f:I
    ...
    :cond_7
    iget-boolean p2, p0, Lii/a;->y:Z

    if-eqz p2, :cond_8

    iget-boolean p2, p0, Lii/a;->x:Z

    if-eqz p2, :cond_8

    iput-boolean v2, p0, Lii/a;->y:Z

    iput-boolean v2, p0, Lii/a;->x:Z
