...
.method public static a(Landroid/content/Context;Ltl/b;Ljava/lang/String;I)I
    .locals 9
    ...
    sget-object v3, Lul/i;->f:Ljava/lang/String;
    ...
    invoke-static {v2}, Lul/g;->b(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v0, v3}, Lvl/a;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p0, v2}, Lul/g;->c(Landroid/content/Context;Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    iget-boolean p1, p1, Ltl/b;->i:Z

    if-eqz p1, :cond_2

    invoke-static {p2}, Lul/g;->b(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    :cond_2
    invoke-static {p0, p2}, Lul/g;->c(Landroid/content/Context;Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    sget-object p0, Lsl/b;->b:Lsl/b;

    goto :goto_2

    :cond_4
    sget-object p0, Lsl/b;->c:Lsl/b;
