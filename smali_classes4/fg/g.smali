...
.method public static e(Ljava/util/concurrent/CountDownLatch;)V
    ...
    new-instance v0, Lfg/g$d;

    invoke-direct {v0, p0}, Lfg/g$d;-><init>(Ljava/util/concurrent/CountDownLatch;)V

    invoke-static {v0}, Lfg/g;->h(Lfg/g$g;)V
...
.method public static h(Lfg/g$g;)V
    .locals 1
    ...
    :goto_0
    :try_start_0
    invoke-interface {p0}, Lfg/g$g;->run()V
    :try_end_0
    .catch Ljava/lang/InterruptedException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static i(Landroid/os/Handler;Ljava/util/concurrent/Callable;)Ljava/lang/Object;
    ...
    invoke-direct {v0}, Lfg/g$c;-><init>()V

    new-instance v1, Lfg/g$b;

    invoke-direct {v1}, Lfg/g$b;-><init>()V
    ...
    new-instance v3, Lfg/g$e;

    invoke-direct {v3, v0, p1, v1, v2}, Lfg/g$e;-><init>(Lfg/g$c;Ljava/util/concurrent/Callable;Lfg/g$b;Ljava/util/concurrent/CountDownLatch;)V

    invoke-virtual {p0, v3}, Landroid/os/Handler;->post(Ljava/lang/Runnable;)Z

    invoke-static {v2}, Lfg/g;->e(Ljava/util/concurrent/CountDownLatch;)V

    iget-object p0, v1, Lfg/g$b;->a:Ljava/lang/Exception;

    if-nez p0, :cond_1

    iget-object p0, v0, Lfg/g$c;->a:Ljava/lang/Object;
    ...
    iget-object p1, v1, Lfg/g$b;->a:Ljava/lang/Exception;
    ...
    invoke-static {p1, v0}, Lfg/g;->g([Ljava/lang/StackTraceElement;[Ljava/lang/StackTraceElement;)[Ljava/lang/StackTraceElement;
...
.method public static j(Landroid/os/Handler;Ljava/lang/Runnable;)V
    ...
    new-instance v0, Lfg/g$f;

    invoke-direct {v0, p1}, Lfg/g$f;-><init>(Ljava/lang/Runnable;)V

    invoke-static {p0, v0}, Lfg/g;->i(Landroid/os/Handler;Ljava/util/concurrent/Callable;)Ljava/lang/Object;
...
.method public static k(Ljava/lang/Thread;)V
    ...
    invoke-direct {v0, p0}, Lfg/g$a;-><init>(Ljava/lang/Thread;)V
