...
.method public final a(Lorg/json/JSONObject;Ljava/util/HashMap;)V
    ...
    invoke-virtual {p0, v0}, Lek/b;->c(Lorg/json/JSONObject;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Lek/b;->c(Lorg/json/JSONObject;)Ljava/lang/String;
...
.method public final d(Lorg/json/JSONObject;)Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v2, v3}, Lek/b;->f(Lorg/json/JSONObject;Z)Lhk/b;
...
.method public e(Ljava/lang/String;Ljava/util/HashMap;Ljava/util/HashMap;Ljava/util/HashMap;Ljava/util/HashMap;)V
    ...
    sget-object v2, Lek/b;->a:Ljava/lang/String;
    ...
    invoke-static {v2, v3}, Luk/j;->k(Ljava/lang/String;Ljava/lang/String;)V

    :try_start_0
    invoke-static {p1}, Lvk/b;->g(Ljava/lang/String;)Lorg/json/JSONObject;
    ...
    invoke-virtual {p0, v4, v3}, Lek/b;->g(Lorg/json/JSONObject;Ljava/util/HashMap;)V
    ...
    invoke-virtual {p0, v4}, Lek/b;->d(Lorg/json/JSONObject;)Ljava/util/ArrayList;

    move-result-object v4

    invoke-virtual {p0, v4, p2, v3}, Lek/b;->b(Ljava/util/List;Ljava/util/HashMap;Ljava/util/HashMap;)V
    ...
    invoke-virtual {p0, p2}, Lek/b;->d(Lorg/json/JSONObject;)Ljava/util/ArrayList;

    move-result-object p2

    invoke-virtual {p0, p2, p3, v3}, Lek/b;->b(Ljava/util/List;Ljava/util/HashMap;Ljava/util/HashMap;)V
    ...
    invoke-virtual {p0, p2, v1, p3}, Lek/b;->h(Lorg/json/JSONObject;Ljava/lang/String;Z)Lfk/f;
    ...
    invoke-virtual {p0, p2, v0, p3}, Lek/b;->h(Lorg/json/JSONObject;Ljava/lang/String;Z)Lfk/f;
    ...
    invoke-virtual {p0, p1, p5}, Lek/b;->a(Lorg/json/JSONObject;Ljava/util/HashMap;)V
    :try_end_0
    ...
    sget-object p1, Lek/b;->a:Ljava/lang/String;
...
.method public final f(Lorg/json/JSONObject;Z)Lhk/b;
    .locals 2
    ...
    invoke-static {p1, p0}, Luk/g;->c(Lorg/json/JSONObject;Ljava/lang/String;)[I
...
.method public final h(Lorg/json/JSONObject;Ljava/lang/String;Z)Lfk/f;
    .locals 2
    ...
    invoke-virtual {p1, p3}, Lfk/f;->h(Lcom/faceunity/core/entity/FUBundleData;)V
