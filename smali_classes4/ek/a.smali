...
# virtual methods
.method public final a(Lfk/b$a;Lcom/faceunity/core/entity/FUGroupAnimationBundleData;)V
    .locals 2

    iget-object p0, p1, Lfk/b$a;->a:Ljava/util/List;
    ...
    :cond_0
    iget-object p0, p1, Lfk/b$a;->b:Ljava/util/List;
...
.method public b(Lfk/b;Z)Lfk/b;
    .locals 5

    if-nez p1, :cond_0

    sget-object p0, Lek/a;->a:Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lfk/b;->b()Lfk/b$a;

    move-result-object v1

    invoke-virtual {v0, v1}, Lfk/b;->g(Lfk/b$a;)V

    invoke-virtual {p1}, Lfk/b;->d()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lfk/b;->i(Ljava/lang/String;)V

    invoke-virtual {p1}, Lfk/b;->c()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lfk/b;->h(Ljava/lang/String;)V

    invoke-virtual {p1}, Lfk/b;->e()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lfk/b;->j(Ljava/lang/String;)V
    ...
    invoke-virtual {p1}, Lfk/b;->a()Lcom/faceunity/core/entity/FUAnimationBundleData;
    ...
    invoke-virtual {v0, v2}, Lfk/b;->f(Lcom/faceunity/core/entity/FUAnimationBundleData;)V

    invoke-virtual {v0}, Lfk/b;->a()Lcom/faceunity/core/entity/FUAnimationBundleData;

    move-result-object p1

    check-cast p1, Lcom/faceunity/core/entity/FUGroupAnimationBundleData;

    invoke-virtual {p0, v1, p1}, Lek/a;->a(Lfk/b$a;Lcom/faceunity/core/entity/FUGroupAnimationBundleData;)V
    ...
    invoke-virtual {v0, p0}, Lfk/b;->f(Lcom/faceunity/core/entity/FUAnimationBundleData;)V

    :goto_0
    return-object v0
.end method

.method public c(Lfk/d;Z)Lfk/d;
    .locals 2
    ...
    invoke-virtual {p1}, Lfk/d;->c()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p0, v0}, Lfk/d;->g(Ljava/lang/String;)V

    invoke-virtual {p1}, Lfk/d;->a()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p0, v0}, Lfk/d;->e(Ljava/lang/String;)V

    invoke-virtual {p1}, Lfk/d;->d()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p0, v0}, Lfk/d;->h(Ljava/lang/String;)V

    new-instance v0, Lcom/faceunity/core/entity/FUEmotionBundleData;

    invoke-virtual {p1}, Lfk/d;->b()Lcom/faceunity/core/entity/FUEmotionBundleData;
    ...
    invoke-virtual {p0, v0}, Lfk/d;->f(Lcom/faceunity/core/entity/FUEmotionBundleData;)V
...
.method public final d(Ljava/util/Map;Ljava/util/List;)V
    ...
    invoke-virtual {p2}, Lfk/b;->d()Ljava/lang/String;
...
.method public final e(Ljava/util/Map;Ljava/util/List;)V
    ...
    invoke-virtual {p2}, Lfk/d;->c()Ljava/lang/String;
...
.method public f(Ljava/lang/String;Lfk/a;)V
    .locals 10
    ...
    sget-object v6, Lek/a;->a:Ljava/lang/String;
    ...
    invoke-static {v6, v7}, Luk/j;->k(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p2}, Lfk/a;->a()Ljava/util/Map;

    move-result-object v6

    invoke-virtual {p2}, Lfk/a;->b()Ljava/util/Map;

    move-result-object v7

    invoke-virtual {p2}, Lfk/a;->e()Ljava/util/Map;
    ...
    invoke-virtual {p0, v3, v9}, Lek/a;->q(Lorg/json/JSONArray;Ljava/lang/String;)Ljava/util/List;

    move-result-object v3

    invoke-virtual {p0, v6, v3}, Lek/a;->d(Ljava/util/Map;Ljava/util/List;)V
    ...
    invoke-virtual {p0, v2}, Lek/a;->r(Lorg/json/JSONArray;)Ljava/util/List;

    move-result-object v2

    invoke-virtual {p0, v7, v2}, Lek/a;->e(Ljava/util/Map;Ljava/util/List;)V
    ...
    invoke-virtual {p0, v2, v3, v6}, Lek/a;->t(Lorg/json/JSONObject;Ljava/lang/String;Ljava/util/Map;)Ljava/util/List;

    move-result-object v2

    invoke-virtual {p2, v2}, Lfk/a;->h(Ljava/util/List;)V
    ...
    invoke-virtual {p2, v2}, Lfk/a;->j(Ljava/util/List;)V
    ...
    invoke-virtual {p2, v2}, Lfk/a;->i(Ljava/util/List;)V
    ...
    invoke-virtual {p0, v1, v2, v6}, Lek/a;->n(Lorg/json/JSONObject;Ljava/lang/String;Ljava/util/Map;)Lfk/b;

    move-result-object v1

    invoke-virtual {p2, v1}, Lfk/a;->k(Lfk/b;)V
    ...
    invoke-virtual {p0, p2, v0}, Lek/a;->o(Lorg/json/JSONObject;Z)Lfk/f;
    ...
    invoke-virtual {p0, p1, v0}, Lek/a;->o(Lorg/json/JSONObject;Z)Lfk/f;
    ...
    sget-object p1, Lek/a;->a:Ljava/lang/String;
...
.method public final g(Lorg/json/JSONObject;)Lfk/c;
    .locals 3
    ...
    invoke-virtual {p0, v0}, Lfk/c;->f(I)V

    goto :goto_0

    :cond_0
    invoke-virtual {p0, v2}, Lfk/c;->f(I)V
    ...
    invoke-virtual {p0, v0}, Lfk/c;->j(Z)V

    goto :goto_1

    :cond_1
    invoke-virtual {p0, v2}, Lfk/c;->j(Z)V
    ...
    invoke-virtual {p0, v0}, Lfk/c;->h(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Lfk/c;->g(Ljava/lang/Integer;)V
    ...
    invoke-virtual {p0, p1}, Lfk/c;->i(Ljava/lang/Boolean;)V

    :cond_5
    return-object p0
.end method

.method public final h(Lorg/json/JSONObject;Z)Lfk/b$a;
    .locals 3
    ...
    invoke-virtual {p0, v1, v2}, Lek/a;->p(Lorg/json/JSONArray;Ljava/lang/String;)Ljava/util/List;

    move-result-object v1

    iput-object v1, v0, Lfk/b$a;->a:Ljava/util/List;
    ...
    invoke-virtual {p0, v1}, Lek/a;->s(Lorg/json/JSONArray;)Ljava/util/List;

    move-result-object v1

    iput-object v1, v0, Lfk/b$a;->b:Ljava/util/List;
    ...
    invoke-virtual {p0, v1, p2}, Lek/a;->l(Lorg/json/JSONObject;Z)Lcom/faceunity/core/entity/FUAnimationBundleData;

    move-result-object v1

    iput-object v1, v0, Lfk/b$a;->c:Lcom/faceunity/core/entity/FUAnimationBundleData;
    ...
    iput-object v1, v0, Lfk/b$a;->e:Lcom/faceunity/core/entity/FUBundleData;
    ...
    iput-object v1, v0, Lfk/b$a;->f:Lcom/faceunity/core/entity/FUBundleData;
    ...
    iput-object v1, v0, Lfk/b$a;->g:Lcom/faceunity/core/entity/FUBundleData;
    ...
    invoke-virtual {p0, p1, p2}, Lek/a;->m(Lorg/json/JSONObject;Z)Lcom/faceunity/core/entity/FUEmotionBundleData;

    move-result-object p0

    iput-object p0, v0, Lfk/b$a;->d:Lcom/faceunity/core/entity/FUEmotionBundleData;
...
.method public final i(Lorg/json/JSONObject;ZLjava/lang/String;)Lcom/faceunity/core/entity/FUAnimationBundleData;
    ...
    invoke-static {v1}, Lik/c;->i(Ljava/lang/String;)Ljava/lang/String;
...
.method public final j(Lorg/json/JSONObject;ZLjava/lang/String;)Lfk/b;
    .locals 16
    ...
    invoke-virtual {v2, v3}, Lfk/b;->i(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3}, Lfk/b;->j(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3}, Lfk/b;->h(Ljava/lang/String;)V

    :cond_2
    invoke-virtual/range {p0 .. p1}, Lek/a;->g(Lorg/json/JSONObject;)Lfk/c;
    ...
    invoke-static {v4}, Lik/c;->i(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lfk/b;->e()Ljava/lang/String;

    move-result-object v7

    invoke-virtual {v3}, Lfk/c;->e()Z

    move-result v9

    const/4 v10, 0x0

    invoke-virtual {v3}, Lfk/c;->a()I

    move-result v11

    invoke-virtual {v3}, Lfk/c;->c()Ljava/lang/String;

    move-result-object v12

    invoke-virtual {v3}, Lfk/c;->b()Ljava/lang/Integer;

    move-result-object v13

    invoke-virtual {v3}, Lfk/c;->d()Ljava/lang/Boolean;
    ...
    invoke-virtual {v2, v15}, Lfk/b;->f(Lcom/faceunity/core/entity/FUAnimationBundleData;)V
    ...
    invoke-virtual {v0, v1, v3}, Lek/a;->h(Lorg/json/JSONObject;Z)Lfk/b$a;

    move-result-object v1

    invoke-virtual {v2, v1}, Lfk/b;->g(Lfk/b$a;)V

    invoke-virtual {v2}, Lfk/b;->b()Lfk/b$a;

    move-result-object v1

    invoke-virtual {v2}, Lfk/b;->a()Lcom/faceunity/core/entity/FUAnimationBundleData;

    move-result-object v3

    check-cast v3, Lcom/faceunity/core/entity/FUGroupAnimationBundleData;

    invoke-virtual {v0, v1, v3}, Lek/a;->a(Lfk/b$a;Lcom/faceunity/core/entity/FUGroupAnimationBundleData;)V
    ...
    invoke-virtual {v2, v0}, Lfk/b;->f(Lcom/faceunity/core/entity/FUAnimationBundleData;)V

    :goto_1
    return-object v2
.end method

.method public final k(Lorg/json/JSONObject;Z)Lfk/d;
    .locals 2
    ...
    invoke-static {p1}, Lik/c;->i(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lfk/d;->d()Ljava/lang/String;

    move-result-object v0

    invoke-direct {p2, p1, v0}, Lcom/faceunity/core/entity/FUEmotionBundleData;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, p2}, Lfk/d;->f(Lcom/faceunity/core/entity/FUEmotionBundleData;)V
...
.method public final n(Lorg/json/JSONObject;Ljava/lang/String;Ljava/util/Map;)Lfk/b;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1, p2, p3}, Lek/a;->t(Lorg/json/JSONObject;Ljava/lang/String;Ljava/util/Map;)Ljava/util/List;
...
.method public final o(Lorg/json/JSONObject;Z)Lfk/f;
    .locals 3
    ...
    invoke-virtual {p0, v2}, Lfk/f;->f(Lcom/faceunity/core/entity/FUAnimationBundleData;)V
    ...
    invoke-virtual {p0, p2}, Lfk/f;->h(Lcom/faceunity/core/entity/FUBundleData;)V
...
.method public final p(Lorg/json/JSONArray;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {p0, v2, v3, p2}, Lek/a;->i(Lorg/json/JSONObject;ZLjava/lang/String;)Lcom/faceunity/core/entity/FUAnimationBundleData;
...
.method public final q(Lorg/json/JSONArray;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {p0, v2, v3, p2}, Lek/a;->j(Lorg/json/JSONObject;ZLjava/lang/String;)Lfk/b;
...
.method public final r(Lorg/json/JSONArray;)Ljava/util/List;
    ...
    invoke-virtual {p0, v2, v3}, Lek/a;->k(Lorg/json/JSONObject;Z)Lfk/d;
...
.method public final s(Lorg/json/JSONArray;)Ljava/util/List;
    ...
    invoke-virtual {p0, v2, v3}, Lek/a;->l(Lorg/json/JSONObject;Z)Lcom/faceunity/core/entity/FUAnimationBundleData;
...
.method public final t(Lorg/json/JSONObject;Ljava/lang/String;Ljava/util/Map;)Ljava/util/List;
    ...
    :cond_0
    invoke-virtual {v0, v4}, Lek/a;->g(Lorg/json/JSONObject;)Lfk/c;

    move-result-object v4

    invoke-virtual {v5}, Lfk/b;->b()Lfk/b$a;
    ...
    invoke-virtual {v5}, Lfk/b;->a()Lcom/faceunity/core/entity/FUAnimationBundleData;
    ...
    invoke-virtual {v5}, Lfk/b;->e()Ljava/lang/String;

    move-result-object v10

    invoke-virtual {v4}, Lfk/c;->e()Z

    move-result v12

    const/4 v13, 0x0

    invoke-virtual {v4}, Lfk/c;->a()I

    move-result v14

    invoke-virtual {v4}, Lfk/c;->c()Ljava/lang/String;

    move-result-object v16

    invoke-virtual {v4}, Lfk/c;->b()Ljava/lang/Integer;

    move-result-object v17

    invoke-virtual {v4}, Lfk/c;->d()Ljava/lang/Boolean;
    ...
    invoke-virtual {v5, v4}, Lfk/b;->f(Lcom/faceunity/core/entity/FUAnimationBundleData;)V
    ...
    invoke-virtual {v0, v7, v4}, Lek/a;->a(Lfk/b$a;Lcom/faceunity/core/entity/FUGroupAnimationBundleData;)V
    ...
    invoke-virtual {v5, v7}, Lfk/b;->f(Lcom/faceunity/core/entity/FUAnimationBundleData;)V
