...
.method private final readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-static {v0, p2}, Lon/q;->z1(II)Lon/k;

    move-result-object p2

    const/4 v1, 0x6

    invoke-static {p2, v1}, Lon/q;->e1(Lon/i;I)Lon/i;

    move-result-object p2

    invoke-virtual {p2}, Lon/i;->b()I

    move-result v1

    invoke-virtual {p2}, Lon/i;->c()I

    move-result v2

    invoke-virtual {p2}, Lon/i;->d()I
