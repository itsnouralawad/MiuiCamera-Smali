...
.method public constructor <init>(Lwe/d0;)V
    ...
    iput-object p1, p0, Lwe/d0$c;->a:Lwe/d0;
...
.method public a(Lwe/e;)V
    ...
    invoke-virtual {p0, p1, v0}, Lwe/d0$c;->d(Lwe/e;Ljava/lang/String;)V
...
.method public c(Lwe/e;)V
    ...
    iget-object v5, p0, Lwe/d0$c;->a:Lwe/d0;

    invoke-virtual {v5}, Lwe/d0;->z0()Z
    ...
    :cond_0
    invoke-virtual {p1}, Lwe/e;->n()Lwe/e$a;

    move-result-object v5

    if-eqz v5, :cond_e

    iget-object v6, p0, Lwe/d0$c;->a:Lwe/d0;

    invoke-static {v6, v7, v8}, Lwe/d0;->N(Lwe/d0;J)Lwe/w;

    move-result-object v6

    invoke-virtual {v5}, Lwe/e$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual {v6, v9, v10}, Lwe/w;->r1(J)V

    iget-object v11, p0, Lwe/d0$c;->a:Lwe/d0;

    invoke-static {v11, v7, v8}, Lwe/d0;->l(Lwe/d0;J)Lwe/w;

    iget-object v11, p0, Lwe/d0$c;->a:Lwe/d0;

    invoke-static {v11, v9, v10, v6}, Lwe/d0;->K(Lwe/d0;JLwe/w;)V

    :cond_1
    if-ne v1, v0, :cond_4

    iget-object v1, p0, Lwe/d0$c;->a:Lwe/d0;

    invoke-virtual {v1}, Lwe/d0;->z0()Z
    ...
    invoke-virtual {p1}, Lwe/e;->l()Ljava/util/List;
    ...
    invoke-virtual {v0}, Lwe/e$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v4, p0, Lwe/d0$c;->a:Lwe/d0;

    invoke-static {v4, v7, v8}, Lwe/d0;->N(Lwe/d0;J)Lwe/w;

    move-result-object v4

    if-eqz v4, :cond_9

    invoke-virtual {v4, v1}, Lwe/w;->G0(Lcom/xiaomi/protocol/ICustomCaptureResult;)V

    invoke-virtual {v4}, Lwe/w;->s()Lwe/x;

    move-result-object v1

    invoke-virtual {v1}, Lwe/x;->V0()Z
    ...
    invoke-virtual {v4}, Lwe/w;->K()Lfm/c;
    ...
    invoke-direct/range {v0 .. v6}, Lwe/h0;-><init>(Ljava/util/List;ZJZLfm/c;)V

    invoke-virtual {p1}, Lwe/e;->c()I

    move-result v0

    invoke-virtual {p0, v0}, Lwe/h0;->h(I)V
    ...
    iget-object v0, p1, Lwe/k;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-virtual {p1, p0}, Lwe/k;->e(Lwe/h0;)I

    goto/16 :goto_1

    :cond_8
    iget-object p1, p0, Lwe/d0$c;->a:Lwe/d0;

    invoke-static {p1}, Lwe/d0;->d(Lwe/d0;)Lwe/k$a;

    move-result-object p1

    invoke-interface {p1, v7, v8, v3}, Lwe/k$a;->c(JI)V
    ...
    invoke-virtual {p1, v1}, Lp8/m;->W(Ljava/lang/String;)V
    ...
    invoke-interface {p1, v0, v3, v3}, Lwe/k$a;->f(Landroid/media/Image;IZ)V

    invoke-virtual {v0}, Landroid/media/Image;->close()V

    invoke-virtual {p0, v0}, Lwe/d0$c;->b(Landroid/media/Image;)V
    ...
    :cond_a
    iget-object v0, p0, Lwe/d0$c;->a:Lwe/d0;

    invoke-static {v0, v7, v8}, Lwe/d0;->N(Lwe/d0;J)Lwe/w;
    ...
    invoke-static {v7}, Lya/j3;->U(Landroid/hardware/camera2/CaptureResult;)Z
    ...
    invoke-virtual {v5}, Lwe/e$a;->e()Landroid/media/Image;

    move-result-object v1

    invoke-virtual {v0, v6}, Lwe/w;->G0(Lcom/xiaomi/protocol/ICustomCaptureResult;)V
    ...
    invoke-static {v5, v1, v4}, Lse/d;->l(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;I)Landroid/media/Image;

    move-result-object v4

    new-instance v5, Lwe/i;

    const/4 v6, 0x1

    invoke-direct {v5, v4, v3, v6}, Lwe/i;-><init>(Landroid/media/Image;IZ)V

    invoke-virtual {v0, v5}, Lwe/k;->d(Lwe/i;)V
    ...
    :cond_b
    invoke-virtual {p0, v1}, Lwe/d0$c;->b(Landroid/media/Image;)V

    goto :goto_1

    :cond_c
    invoke-virtual {p0, p1, v1}, Lwe/d0$c;->d(Lwe/e;Ljava/lang/String;)V
...
.method public final d(Lwe/e;Ljava/lang/String;)V
    .locals 13
    .param p1    # Lwe/e;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual {v7}, Lwe/e$a;->p()Z

    move-result v9

    if-eqz v9, :cond_2

    invoke-virtual {v7}, Lwe/e$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-static {v5, v9, v10}, Lwe/d0;->N(Lwe/d0;J)Lwe/w;
    ...
    iget-object v7, p0, Lwe/d0$c;->a:Lwe/d0;

    invoke-virtual {p1}, Lwe/e;->b()I

    move-result v9

    invoke-static {v7, p1, v9}, Lwe/d0;->O(Lwe/d0;Lwe/e;I)Lcom/xiaomi/protocol/ICustomCaptureResult;

    move-result-object v7

    invoke-virtual {v5, v7}, Lwe/w;->G0(Lcom/xiaomi/protocol/ICustomCaptureResult;)V
    ...
    invoke-static {v7, v10, v11}, Lwe/d0;->N(Lwe/d0;J)Lwe/w;
    ...
    iget-object v8, p0, Lwe/d0$c;->a:Lwe/d0;

    invoke-virtual {p1}, Lwe/e;->b()I

    move-result v9

    invoke-static {v8, p1, v9}, Lwe/d0;->O(Lwe/d0;Lwe/e;I)Lcom/xiaomi/protocol/ICustomCaptureResult;

    move-result-object v8

    invoke-virtual {v7, v8}, Lwe/w;->G0(Lcom/xiaomi/protocol/ICustomCaptureResult;)V
    ...
    invoke-static {v0, p2, p0}, Lwe/d0;->k(Lwe/d0;Lwe/e$a;Lwe/f;)V
    ...
    invoke-virtual {v0}, Lwe/h0;->a()Z

    move-result v5

    if-eqz v5, :cond_9

    iget-object v5, v4, Lwe/k;->b:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v5}, Ljava/util/concurrent/atomic/AtomicInteger;->getAndIncrement()I

    :cond_9
    iget-object p0, p0, Lwe/d0$c;->a:Lwe/d0;
    ...
    invoke-virtual {v0, v2}, Lwe/h0;->i(I)V

    :cond_b
    if-eqz v4, :cond_c

    invoke-virtual {v4, v0}, Lwe/k;->e(Lwe/h0;)I
