...
.method public X(Lwe/h0;)V
    ...
    invoke-virtual {p0, v5}, Lwe/k;->q(Landroid/media/Image;)Z
    ...
    invoke-static {v6, v1}, Lse/e;->b(Ljava/lang/String;I)V

    invoke-virtual {v4}, Lwe/e$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual {p0, v6, v5, v1, v7}, Lwe/g0;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    sget-object v9, Lkb/hi;->H:Lkb/kp;

    invoke-static {v8, v9}, Lkb/lp;->l(Landroid/hardware/camera2/CaptureRequest;Lkb/kp;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v6, v5, v7, v8}, Lwe/g0;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V

    :goto_3
    invoke-virtual {v4}, Lwe/e$a;->k()Landroid/media/Image;

    move-result-object v4

    iget-object v5, p0, Lwe/k;->j:Lwe/k$a;

    invoke-virtual {p0, v4, v5}, Lwe/c;->b0(Landroid/media/Image;Lwe/k$a;)V
...
.method public b(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/List;
    ...
    new-instance v2, Lwe/g0$a;

    invoke-direct {v2, p0}, Lwe/g0$a;-><init>(Lwe/g0;)V
    ...
    new-instance v2, Lwe/g0$b;

    invoke-direct {v2, p0}, Lwe/g0$b;-><init>(Lwe/g0;)V
    ...
    new-instance v1, Lwe/g0$c;

    invoke-direct {v1, p0}, Lwe/g0$c;-><init>(Lwe/g0;)V
...
.method public final f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    :cond_0
    new-instance p1, Lwe/g0$d;

    invoke-direct {p1, p0}, Lwe/g0$d;-><init>(Lwe/g0;)V
    ...
    :cond_2
    new-instance p1, Lwe/g0$e;

    invoke-direct {p1, p0}, Lwe/g0$e;-><init>(Lwe/g0;)V
