...
.method public constructor <init>(Lwe/d0;)V
    ...
    iput-object p1, p0, Lwe/d0$e;->a:Lwe/d0;
...
.method public a(Lwe/k;)Z
    ...
    invoke-virtual {p0, p1}, Lwe/r;->z(Lwe/k;)Z
...
.method public b(Landroid/media/Image;)V
    ...
    iget-object p0, p0, Lwe/d0$e;->a:Lwe/d0;

    invoke-static {p0}, Lwe/d0;->i(Lwe/d0;)Lwe/f;

    move-result-object p0

    invoke-interface {p0, p1}, Lwe/f;->b(Landroid/media/Image;)V
...
.method public c(JI)V
    ...
    iget-object v0, p0, Lwe/d0$e;->a:Lwe/d0;

    invoke-static {v0}, Lwe/d0;->p(Lwe/d0;)Lwe/d0$j;

    move-result-object v0

    if-eqz v0, :cond_2

    invoke-virtual {p0, p1, p2}, Lwe/d0$e;->d(J)Lwe/w;

    move-result-object v0

    if-eqz v0, :cond_2

    invoke-virtual {v0}, Lwe/w;->i0()Z
    ...
    invoke-virtual {v1, p1}, Lp8/m;->W(Ljava/lang/String;)V

    iget-object p0, p0, Lwe/d0$e;->a:Lwe/d0;

    invoke-static {p0}, Lwe/d0;->p(Lwe/d0;)Lwe/d0$j;

    move-result-object p0

    invoke-interface {p0, v0, p3}, Lwe/d0$j;->b(Lwe/w;I)V
...
.method public d(J)Lwe/w;
    .locals 0

    iget-object p0, p0, Lwe/d0$e;->a:Lwe/d0;

    invoke-static {p0, p1, p2}, Lwe/d0;->N(Lwe/d0;J)Lwe/w;
...
.method public e(ILjava/lang/Object;)V
    ...
    invoke-virtual {p0, p2}, Lwe/d0$e;->i(Lcom/xiaomi/engine/ResultData;)V
    ...
    invoke-virtual {p0, p2}, Lwe/d0$e;->j(Lcom/xiaomi/engine/ResultData;)V
...
.method public f(Landroid/media/Image;IZ)V
    ...
    invoke-static {v8, v13}, Lse/e;->d(II)V

    invoke-static/range {p1 .. p1}, Lse/d;->g(Landroid/media/Image;)[B

    move-result-object v0

    if-eqz v0, :cond_12

    iget-object v1, v1, Lwe/d0$e;->a:Lwe/d0;

    invoke-static {v1}, Lwe/d0;->m(Lwe/d0;)Lcom/xiaomi/camera/imagecodec/ReprocessData$OnDataAvailableListener;
    ...
    :cond_0
    invoke-virtual {v1, v9, v10}, Lwe/d0$e;->d(J)Lwe/w;
    ...
    invoke-virtual {v15}, Lwe/w;->l()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual {v15}, Lwe/w;->s()Lwe/x;

    move-result-object v3

    invoke-virtual {v3}, Lwe/x;->o0()I
    ...
    invoke-static {v5}, Lse/c;->d(I)Z

    move-result v4

    if-nez v4, :cond_8

    invoke-virtual {v3}, Lwe/x;->R0()Z
    ...
    iget-object v2, v1, Lwe/d0$e;->a:Lwe/d0;
    ...
    invoke-static/range {v2 .. v7}, Lwe/d0;->n(Lwe/d0;Lwe/w;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;
    ...
    invoke-static {v3, v0, v7}, Lse/d;->l(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;I)Landroid/media/Image;

    move-result-object v3

    iget-object v4, v1, Lwe/d0$e;->a:Lwe/d0;

    invoke-static {v4}, Lwe/d0;->i(Lwe/d0;)Lwe/f;

    move-result-object v4

    invoke-interface {v4, v0}, Lwe/f;->b(Landroid/media/Image;)V
    ...
    iget-object v3, v1, Lwe/d0$e;->a:Lwe/d0;

    invoke-static {v3}, Lwe/d0;->q(Lwe/d0;)Ll9/h;

    move-result-object v3

    iget-object v4, v1, Lwe/d0$e;->a:Lwe/d0;

    invoke-static {v4}, Lwe/d0;->o(Lwe/d0;)Ll9/d$a;

    move-result-object v4

    invoke-virtual {v3, v0, v2, v15, v4}, Ll9/h;->s(Landroid/media/Image;Landroid/hardware/camera2/CaptureResult;Lwe/w;Ll9/d$a;)V

    invoke-static {v5}, Lse/c;->c(I)Z

    move-result v0

    if-eqz v0, :cond_7

    iget-object v0, v1, Lwe/d0$e;->a:Lwe/d0;

    invoke-static {v0}, Lwe/d0;->r(Lwe/d0;)Ljava/util/Map;
    ...
    invoke-static {v3}, Lwe/d0;->s(Lwe/d0;)Ljava/util/Map;
    ...
    invoke-static {v3, v5}, Lwe/d0;->t(Lwe/d0;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {v3}, Lwe/d0;->u(Lwe/d0;)Ljava/util/Map;
    ...
    invoke-static {v3, v5}, Lwe/d0;->v(Lwe/d0;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-virtual {v15}, Lwe/w;->J()I

    move-result v5

    invoke-virtual {v15}, Lwe/w;->I()I

    move-result v6

    invoke-virtual {v15}, Lwe/w;->d()Landroid/graphics/Rect;

    move-result-object v7

    invoke-virtual {v15}, Lwe/w;->P()F

    move-result v8

    invoke-static {v3, v5, v6, v7, v8}, Lcom/android/camera/z5;->M(Landroid/graphics/Rect;IILandroid/graphics/Rect;F)Z
    ...
    invoke-static {v0}, Lwe/d0;->u(Lwe/d0;)Ljava/util/Map;
    ...
    invoke-static {v0}, Lwe/d0;->s(Lwe/d0;)Ljava/util/Map;
    ...
    invoke-static {v2}, Lwe/d0;->m(Lwe/d0;)Lcom/xiaomi/camera/imagecodec/ReprocessData$OnDataAvailableListener;
    ...
    invoke-static {v2}, Lwe/d0;->u(Lwe/d0;)Ljava/util/Map;
    ...
    invoke-static {v1}, Lwe/d0;->s(Lwe/d0;)Ljava/util/Map;
    ...
    invoke-virtual/range {v1 .. v7}, Lwe/d0$e;->h(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;ZLwe/w;J)V
    ...
    invoke-static {v2, v0, v3}, Lse/d;->l(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;I)Landroid/media/Image;

    move-result-object v2

    iget-object v3, v1, Lwe/d0$e;->a:Lwe/d0;

    invoke-static {v3}, Lwe/d0;->i(Lwe/d0;)Lwe/f;

    move-result-object v3

    invoke-interface {v3, v0}, Lwe/f;->b(Landroid/media/Image;)V

    iget-object v0, v1, Lwe/d0$e;->a:Lwe/d0;

    invoke-static {v0, v9, v10, v2}, Lwe/d0;->w(Lwe/d0;JLandroid/media/Image;)V
    ...
    invoke-static {v1, v9, v10, v0}, Lwe/d0;->w(Lwe/d0;JLandroid/media/Image;)V
...
.method public final h(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;ZLwe/w;J)V
    .locals 6
    ...
    invoke-static {p2}, Lse/d;->f(Landroid/media/Image;)[B
    ...
    invoke-virtual {p4, v3, v0}, Lwe/w;->a([BI)V

    const-string p2, "JPEG"

    invoke-virtual {p4, p2}, Lwe/w;->a0(Ljava/lang/String;)Z
    ...
    invoke-virtual {p4, p2}, Lwe/w;->V0(Z)V
    ...
    iget-object p2, p0, Lwe/d0$e;->a:Lwe/d0;

    invoke-static {p2}, Lwe/d0;->q(Lwe/d0;)Ll9/h;

    move-result-object p2

    const/4 p3, 0x0

    invoke-virtual {p2, p4, p1, p3, p3}, Ll9/h;->i(Lwe/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z

    move-result p1

    iget-object p2, p0, Lwe/d0$e;->a:Lwe/d0;

    invoke-virtual {p4}, Lwe/w;->O()Landroid/media/Image;
    ...
    invoke-virtual {p4}, Lwe/w;->u0()V

    :cond_3
    iget-object p1, p0, Lwe/d0$e;->a:Lwe/d0;

    invoke-static {p1, p4}, Lwe/d0;->y(Lwe/d0;Lwe/w;)Z
    ...
    invoke-interface {p1, p4}, Lwe/d0$j;->a(Lwe/w;)V
    ...
    invoke-static {p1, p5, p6}, Lwe/d0;->l(Lwe/d0;J)Lwe/w;
...
.method public final i(Lcom/xiaomi/engine/ResultData;)V
    ...
    invoke-virtual {p0, v0, v1}, Lwe/d0$e;->d(J)Lwe/w;
    ...
    invoke-static {p1}, Lwe/l;->a(Lcom/xiaomi/engine/ResultData;)Ljava/lang/String;
    ...
    invoke-virtual {v0, p1}, Lwe/z;->F(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lwe/x;->U0(B)V

    invoke-virtual {v0, p1}, Lwe/z;->d0(B)V
...
.method public final j(Lcom/xiaomi/engine/ResultData;)V
    ...
    invoke-virtual {v1, v2, v3}, Lwe/d0$e;->d(J)Lwe/w;
    ...
    :goto_1
    iget-object v11, v1, Lwe/d0$e;->a:Lwe/d0;

    invoke-static {v11}, Lwe/d0;->u(Lwe/d0;)Ljava/util/Map;
    ...
    invoke-static {v11, v12}, Lwe/d0;->v(Lwe/d0;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {v0, v7}, Lwe/d0;->t(Lwe/d0;Ljava/util/Map;)Ljava/util/Map;
    ...
    iget-object v7, v1, Lwe/d0$e;->a:Lwe/d0;

    invoke-static {v7}, Lwe/d0;->u(Lwe/d0;)Ljava/util/Map;
    ...
    invoke-virtual {v4}, Lwe/w;->J()I

    move-result v8

    invoke-virtual {v4}, Lwe/w;->I()I

    move-result v11

    invoke-virtual {v4}, Lwe/w;->d()Landroid/graphics/Rect;

    move-result-object v12

    invoke-virtual {v4}, Lwe/w;->P()F

    move-result v4

    invoke-static {v7, v8, v11, v12, v4}, Lcom/android/camera/z5;->M(Landroid/graphics/Rect;IILandroid/graphics/Rect;F)Z
    ...
    invoke-static {v4}, Lwe/d0;->m(Lwe/d0;)Lcom/xiaomi/camera/imagecodec/ReprocessData$OnDataAvailableListener;
    ...
    invoke-static {v4}, Lwe/d0;->s(Lwe/d0;)Ljava/util/Map;
    ...
    invoke-static {v1}, Lwe/d0;->u(Lwe/d0;)Ljava/util/Map;
