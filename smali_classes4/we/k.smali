...
.method public constructor <init>(Lwe/k$a;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    iput-object v0, p0, Lwe/k;->b:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>(I)V

    iput-object v0, p0, Lwe/k;->c:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>(I)V

    iput-object v0, p0, Lwe/k;->d:Ljava/util/concurrent/atomic/AtomicInteger;

    const/4 v0, 0x4

    iput v0, p0, Lwe/k;->e:I

    new-instance v2, Ljava/lang/Object;

    invoke-direct {v2}, Ljava/lang/Object;-><init>()V

    iput-object v2, p0, Lwe/k;->g:Ljava/lang/Object;

    new-instance v2, Landroid/os/ConditionVariable;

    invoke-direct {v2}, Landroid/os/ConditionVariable;-><init>()V

    iput-object v2, p0, Lwe/k;->k:Landroid/os/ConditionVariable;

    new-instance v2, Ljava/lang/Object;

    invoke-direct {v2}, Ljava/lang/Object;-><init>()V

    iput-object v2, p0, Lwe/k;->o:Ljava/lang/Object;

    new-instance v2, Ljava/util/LinkedList;

    invoke-direct {v2}, Ljava/util/LinkedList;-><init>()V

    iput-object v2, p0, Lwe/k;->p:Ljava/util/LinkedList;

    new-instance v2, Ljava/lang/Object;

    invoke-direct {v2}, Ljava/lang/Object;-><init>()V

    iput-object v2, p0, Lwe/k;->q:Ljava/lang/Object;

    iput v1, p0, Lwe/k;->r:I
    ...
    iput-object p1, p0, Lwe/k;->j:Lwe/k$a;
    ...
    :goto_0
    iput-boolean p1, p0, Lwe/k;->n:Z

    sget-object p1, Ljava/util/Locale;->ENGLISH:Ljava/util/Locale;

    new-array v0, v0, [Ljava/lang/Object;

    invoke-virtual {p0}, Lwe/k;->i()Ljava/lang/String;
    ...
    iput-object p1, p0, Lwe/k;->m:Ljava/lang/String;
    ...
    iput-object v0, p0, Lwe/k;->h:Landroid/os/HandlerThread;

    new-instance p1, Lwe/h;

    invoke-direct {p1}, Lwe/h;-><init>()V

    iput-object p1, p0, Lwe/k;->l:Lwe/h;
    ...
    invoke-virtual {p1, p0}, Lwe/h;->d(Landroid/util/Size;)V
...
.method public D(I)V
    ...
    iget-object v0, p0, Lwe/k;->q:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iput p1, p0, Lwe/k;->r:I
...
.method public G()V
    ...
    iget-object v0, p0, Lwe/k;->h:Landroid/os/HandlerThread;
    ...
    :try_start_0
    new-instance v1, Lwe/k$b;

    iget-object v3, p0, Lwe/k;->h:Landroid/os/HandlerThread;

    invoke-virtual {v3}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v3

    invoke-direct {v1, v3, p0}, Lwe/k$b;-><init>(Landroid/os/Looper;Lwe/k;)V

    iput-object v1, p0, Lwe/k;->i:Landroid/os/Handler;
    ...
    invoke-virtual {p0, v0}, Lwe/k;->D(I)V
...
.method public H()V
    ...
    iput-object v3, p0, Lwe/k;->i:Landroid/os/Handler;
...
.method public J()Z
    ...
    invoke-virtual {p0, v2}, Lwe/k;->D(I)V
...
.method public K()V
    ...
    invoke-virtual {p0}, Lwe/k;->s()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lwe/k;->p()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lwe/k;->H()V
...
.method public abstract e(Lwe/h0;)I
    .param p1    # Lwe/h0;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
...
.method public f(Lwe/i;)V
    ...
    iget-object v0, p1, Lwe/i;->a:Landroid/media/Image;

    invoke-virtual {v0}, Landroid/media/Image;->getTimestamp()J

    move-result-wide v1

    iget v3, p1, Lwe/i;->b:I

    iget-object v4, p0, Lwe/k;->j:Lwe/k$a;
    ...
    invoke-interface {v4, v1, v2}, Lwe/k$a;->d(J)Lwe/w;
    ...
    :cond_0
    sget-boolean v8, Lwe/d0;->V:Z

    if-nez v8, :cond_1

    invoke-virtual {v4}, Lwe/w;->e()I

    move-result v8

    invoke-static {v8}, Lse/c;->d(I)Z
    ...
    iget-object v1, p0, Lwe/k;->l:Lwe/h;

    invoke-virtual {v1, v4, v0, v3}, Lwe/h;->a(Lwe/w;Landroid/media/Image;I)V
    ...
    :goto_1
    iget-object v2, p0, Lwe/k;->j:Lwe/k$a;

    iget-boolean p1, p1, Lwe/i;->c:Z

    invoke-interface {v2, v0, v3, p1}, Lwe/k$a;->f(Landroid/media/Image;IZ)V
    ...
    :cond_6
    iget-object p1, p0, Lwe/k;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_7
    iget-object p1, p0, Lwe/k;->c:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_8
    iget-object p1, p0, Lwe/k;->b:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public y(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;)Landroid/media/Image;
    ...
    invoke-static {p1, p2, p0}, Lse/d;->l(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;I)Landroid/media/Image;
...
.method public z()V
    ...
    iput-object v0, p0, Lwe/k;->l:Lwe/h;
