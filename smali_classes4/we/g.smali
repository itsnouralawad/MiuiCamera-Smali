...
.method public constructor <init>(Lwe/k$a;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    invoke-direct {p0, p1, p2}, Lwe/c;-><init>(Lwe/k$a;Lcom/xiaomi/engine/BufferFormat;)V
...
.method public X(Lwe/h0;)V
    ...
    invoke-virtual {p1}, Lwe/h0;->f()Lfm/c;
    ...
    :cond_1
    invoke-virtual {p0, p1}, Lwe/g;->g0(Lwe/h0;)V

    goto :goto_1

    :cond_2
    :goto_0
    invoke-virtual {p0, p1}, Lwe/g;->h0(Lwe/h0;)V
...
.method public b(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/List;
    ...
    iput-object v1, p0, Lwe/c;->K:Landroid/media/ImageReader;

    new-instance v2, Lwe/g$a;

    invoke-direct {v2, p0}, Lwe/g$a;-><init>(Lwe/g;)V
    ...
    iget-object v2, p0, Lwe/c;->K:Landroid/media/ImageReader;
    ...
    iput-object v1, p0, Lwe/c;->L:Landroid/media/ImageReader;
    ...
    iget-object v2, p0, Lwe/c;->L:Landroid/media/ImageReader;
    ...
    iput-object p1, p0, Lwe/c;->M:Landroid/media/ImageReader;

    new-instance v1, Lwe/g$c;

    invoke-direct {v1, p0}, Lwe/g$c;-><init>(Lwe/g;)V
    ...
    iget-object p0, p0, Lwe/c;->M:Landroid/media/ImageReader;
...
.method public final f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    sget-object v0, Lkb/jp;->V1:Lkb/kp;

    invoke-virtual {v0}, Lkb/kp;->b()Ljava/lang/Object;
    ...
    :cond_2
    new-instance p1, Lwe/g$d;

    invoke-direct {p1, p0}, Lwe/g$d;-><init>(Lwe/g;)V
    ...
    iget-object p1, p0, Lwe/c;->O:Ljava/lang/Object;
    ...
    :try_start_1
    iget-object p2, p0, Lwe/c;->I:Lcom/xiaomi/engine/TaskSession;

    goto :goto_2

    :cond_3
    iget-object p2, p0, Lwe/c;->J:Lwe/j0;

    invoke-virtual {p2}, Lwe/j0;->b()Lcom/xiaomi/engine/TaskSession;
    ...
    :cond_4
    new-instance p1, Lwe/g$e;

    invoke-direct {p1, p0}, Lwe/g$e;-><init>(Lwe/g;)V
...
.method public final g0(Lwe/h0;)V
    .locals 9
    .param p1    # Lwe/h0;
    ...
    invoke-virtual {p0, v2}, Lwe/k;->q(Landroid/media/Image;)Z

    move-result v4

    invoke-virtual {p0, v3}, Lwe/k;->q(Landroid/media/Image;)Z
    ...
    invoke-static {v8, v7}, Lse/e;->b(Ljava/lang/String;I)V
    ...
    invoke-virtual {p1}, Lwe/h0;->e()I

    move-result v4

    invoke-virtual {p0, v1, v2, v7, v4}, Lwe/g;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    invoke-virtual {p0, v1, v3, v2, v4}, Lwe/g;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
...
.method public final h0(Lwe/h0;)V
    .locals 7
    .param p1    # Lwe/h0;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-static {v4, v5}, Lse/e;->b(Ljava/lang/String;I)V
    ...
    invoke-virtual {p0, v1, v2, v5, v4}, Lwe/g;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
...
.method public p()Z
    ...
    iget-object v1, p0, Lwe/k;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v0, p0, Lwe/k;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v0, p0, Lwe/k;->c:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object p0, p0, Lwe/k;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-interface {v0, p0}, Lwe/k$a;->a(Lwe/k;)Z
    ...
    iget-object p0, p0, Lwe/k;->b:Ljava/util/concurrent/atomic/AtomicInteger;
