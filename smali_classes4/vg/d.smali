...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lvg/d;->D:[F

    const/4 v0, 0x1

    iput-boolean v0, p0, Lvg/d;->E:Z

    const/4 v0, 0x0

    iput v0, p0, Lvg/d;->N:I

    iput v0, p0, Lvg/d;->O:I

    iput v0, p0, Lvg/d;->P:I

    iput v0, p0, Lvg/d;->Q:I
...
.method public static w()V
    ...
    invoke-static {v1, v0}, Lvg/d;->u(ZLjava/lang/String;)V
...
.method public j(II)V
    ...
    iget-boolean v0, p0, Lvg/d;->E:Z

    invoke-static {p1, p2, v0}, Lvg/c;->i(IIZ)I

    move-result p1

    iput p1, p0, Lvg/d;->C:I
    ...
    iput p1, p0, Lvg/d;->F:I

    invoke-static {}, Lvg/d;->w()V
...
.method public l(IIIIII)V
    ...
    iput p3, p0, Lvg/d;->N:I

    iput p4, p0, Lvg/d;->O:I

    iput p5, p0, Lvg/d;->P:I

    iput p6, p0, Lvg/d;->Q:I

    iput p1, p0, Lvg/d;->M:I

    iput p2, p0, Lvg/d;->L:I
...
.method public m()V
    ...
    iget v0, p0, Lvg/d;->B:I

    if-eqz v0, :cond_1

    iget v0, p0, Lvg/d;->C:I
    ...
    :cond_0
    iget-object v0, p0, Lvg/d;->D:[F

    const/4 v1, 0x0

    invoke-static {v0, v1}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    iget-object v2, p0, Lvg/d;->D:[F
    ...
    iget v2, p0, Lvg/d;->O:I

    invoke-static {v0, v2}, Landroid/opengl/GLES20;->glUniform1i(II)V

    invoke-static {}, Lvg/d;->w()V

    iget v0, p0, Lvg/d;->J:I

    iget v2, p0, Lvg/d;->P:I

    invoke-static {v0, v2}, Landroid/opengl/GLES20;->glUniform1i(II)V

    invoke-static {}, Lvg/d;->w()V

    iget v0, p0, Lvg/d;->K:I

    iget v2, p0, Lvg/d;->Q:I

    invoke-static {v0, v2}, Landroid/opengl/GLES20;->glUniform1i(II)V

    invoke-static {}, Lvg/d;->w()V

    iget v0, p0, Lvg/d;->F:I

    iget v2, p0, Lvg/d;->M:I

    invoke-static {v0, v2}, Landroid/opengl/GLES20;->glUniform1i(II)V

    invoke-static {}, Lvg/d;->w()V

    iget v0, p0, Lvg/d;->G:I

    iget v2, p0, Lvg/d;->L:I

    invoke-static {v0, v2}, Landroid/opengl/GLES20;->glUniform1i(II)V

    invoke-static {}, Lvg/d;->w()V

    iget v0, p0, Lvg/d;->x:I

    invoke-static {v0}, Landroid/opengl/GLES20;->glEnableVertexAttribArray(I)V

    invoke-static {}, Lvg/d;->w()V

    iget v0, p0, Lvg/d;->y:I
    ...
    iget v0, p0, Lvg/a;->m:I

    invoke-static {v2, v0}, Landroid/opengl/GLES20;->glBindBuffer(II)V

    invoke-static {}, Lvg/d;->w()V

    iget v3, p0, Lvg/d;->y:I
    ...
    invoke-virtual {p0, v0}, Lvg/d;->v(I)V

    invoke-static {}, Lvg/d;->w()V

    const/4 v0, 0x5

    iget v2, p0, Lvg/a;->t:I
