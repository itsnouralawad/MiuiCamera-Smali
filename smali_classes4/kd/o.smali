...
.method public static constructor <clinit>()V
    ...
    invoke-interface {v0, v1, v2}, Ld/j;->e(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v1, Lkd/o;->a:Ljava/lang/String;
...
.method public static a()Ld/g;
    .locals 1

    invoke-static {}, Ld/h;->b()Ld/g;
...
.method public static b(Ljava/lang/String;)Ld/g;
    .locals 0

    invoke-static {p0}, Lkd/o;->d(Ljava/lang/String;)Ld/g;

    move-result-object p0

    if-nez p0, :cond_0

    invoke-static {}, Lkd/o;->a()Ld/g;
...
.method public static c(Ljava/io/InputStream;)Ld/g;
    .locals 5

    const/4 v0, 0x1

    invoke-static {p0, v0}, Lkd/o;->h(Ljava/io/InputStream;Z)Ljava/util/List;
    ...
    check-cast v1, Lkd/o$b;

    iget-object v2, v1, Lkd/o$b;->c:[B

    invoke-static {v2}, Lkd/o;->f([B)Z

    move-result v2

    if-eqz v2, :cond_1

    iget-object p0, v1, Lkd/o$b;->c:[B

    invoke-static {p0}, Lkd/o;->e([B)I
    ...
    :try_start_0
    invoke-static {v3}, Ld/h;->g([B)Ld/g;
...
.method public static d(Ljava/lang/String;)Ld/g;
    .locals 5
    ...
    sget-object p0, Lkd/o;->a:Ljava/lang/String;
    ...
    invoke-static {v0}, Lkd/o;->c(Ljava/io/InputStream;)Ld/g;
    ...
    sget-object v2, Lkd/o;->a:Ljava/lang/String;
...
.method public static g(Ljava/util/List;Ld/g;)Ljava/util/List;
    .locals 7
    ...
    invoke-virtual {v1, v2}, Lg/f;->O(Z)Lg/f;

    invoke-virtual {v1, v2}, Lg/f;->K(Z)Lg/f;

    invoke-static {p1, v1}, Ld/h;->n(Ld/g;Lg/f;)[B
    ...
    new-instance p1, Lkd/o$b;

    invoke-direct {p1, v0}, Lkd/o$b;-><init>(Lkd/o$a;)V

    const/16 v0, 0xe1

    iput v0, p1, Lkd/o$b;->a:I

    add-int/lit8 v1, v1, 0x2

    iput v1, p1, Lkd/o$b;->b:I

    iput-object v4, p1, Lkd/o$b;->c:[B
    ...
    check-cast v3, Lkd/o$b;

    iget v3, v3, Lkd/o$b;->a:I
    ...
    iget-object v3, v3, Lkd/o$b;->c:[B

    invoke-static {v3}, Lkd/o;->f([B)Z
    ...
    sget-object p1, Lkd/o;->a:Ljava/lang/String;
...
.method public static h(Ljava/io/InputStream;Z)Ljava/util/List;
    ...
    iput v3, p1, Lkd/o$b;->a:I

    iput v4, p1, Lkd/o$b;->b:I
    ...
    :cond_8
    :goto_2
    new-instance v5, Lkd/o$b;

    invoke-direct {v5, v0}, Lkd/o$b;-><init>(Lkd/o$a;)V

    iput v3, v5, Lkd/o$b;->a:I

    iput v4, v5, Lkd/o$b;->b:I

    add-int/lit8 v4, v4, -0x2

    new-array v3, v4, [B

    iput-object v3, v5, Lkd/o$b;->c:[B
...
.method public static i(Ljava/lang/String;)J
    ...
    :try_start_1
    invoke-static {p0}, Lkd/o;->c(Ljava/io/InputStream;)Ld/g;
    ...
    invoke-static {p0}, Lkd/f;->c(Ljava/io/Closeable;)V
    ...
    invoke-interface {v1, v0, v7}, Ld/g;->s0(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/Integer;
...
.method public static j(Ljava/io/OutputStream;Ljava/util/List;)V
    ...
    iget v2, v1, Lkd/o$b;->a:I

    invoke-virtual {p0, v2}, Ljava/io/OutputStream;->write(I)V

    iget v2, v1, Lkd/o$b;->b:I
...
.method public static k(Ljava/io/InputStream;Ljava/io/OutputStream;Ld/g;)Z
    .locals 3
    ...
    invoke-static {p0, p2}, Lkd/o;->g(Ljava/util/List;Ld/g;)Ljava/util/List;
    ...
    :cond_0
    :try_start_0
    invoke-static {p1, p0}, Lkd/o;->j(Ljava/io/OutputStream;Ljava/util/List;)V
    :try_end_0
    ...
    :try_start_2
    sget-object p2, Lkd/o;->a:Ljava/lang/String;
...
.method public static l(Ljava/lang/String;Ld/g;)Z
    .locals 6
    ...
    invoke-static {v1, v2}, Lkd/o;->h(Ljava/io/InputStream;Z)Ljava/util/List;

    move-result-object v1

    invoke-static {v1, p1}, Lkd/o;->g(Ljava/util/List;Ld/g;)Ljava/util/List;
    ...
    :try_start_2
    invoke-static {v3, p1}, Lkd/o;->j(Ljava/io/OutputStream;Ljava/util/List;)V
    :try_end_2
    ...
    :goto_0
    :try_start_3
    sget-object v3, Lkd/o;->a:Ljava/lang/String;
