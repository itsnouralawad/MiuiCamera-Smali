...
.method public constructor <init>(Lzd/e;Landroid/os/Looper;)V
    ...
    iput-object p2, p0, Lzd/k;->f:Ljava/util/LinkedList;
    ...
    iput-object v0, p0, Lzd/k;->e:Ljava/lang/String;
    ...
    iget-object v0, p0, Lzd/k;->e:Ljava/lang/String;
    ...
    invoke-direct {v0, p1}, Lcom/xiaomi/ai/android/codec/AudioEncoder;-><init>(Lzd/a;)V

    iput-object v0, p0, Lzd/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;
    ...
    iget-object p1, p0, Lzd/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;

    invoke-virtual {p1}, Lcom/xiaomi/ai/android/codec/AudioEncoder;->d()V

    const/4 p1, 0x0

    iput-object p1, p0, Lzd/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;
    ...
    iput-object p1, p0, Lzd/k;->c:Lfe/a;
...
.method public a()V
    ...
    :try_start_0
    iget-object v0, p0, Lzd/k;->f:Ljava/util/LinkedList;
    ...
    iget-object v2, p0, Lzd/k;->f:Ljava/util/LinkedList;
...
.method public b(Landroid/os/Message;)V
    ...
    invoke-virtual {v0}, Lzd/e;->R()Lzd/h;
    ...
    invoke-virtual {v0, v1}, Lzd/h;->c(Lhe/f;)V
...
.method public final c([BZ)V
    ...
    :cond_2
    iget-object v1, p0, Lzd/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;

    invoke-virtual {v1, p1, p2}, Lcom/xiaomi/ai/android/codec/AudioEncoder;->a([BZ)I

    move-result p1

    iget-object p2, p0, Lzd/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;
    ...
    invoke-virtual {v1}, Lzd/e;->O()Lcom/xiaomi/ai/core/b;
    ...
    iget-object p0, p0, Lzd/k;->a:Lzd/e;
    ...
    invoke-virtual {v0, p0}, Lzd/j;->h(Ljava/lang/String;)V
...
.method public final f()V
    ...
    iget-object v1, p0, Lzd/k;->f:Ljava/util/LinkedList;
    ...
    :cond_0
    iget-object p0, p0, Lzd/k;->f:Ljava/util/LinkedList;
...
.method public final g()V
    ...
    invoke-virtual {v0}, Lhe/m;->a()Ljava/lang/String;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    :cond_1
    iget-object p1, p0, Lzd/k;->a:Lzd/e;
    ...
    invoke-virtual {p1, v0}, Lzd/e;->G(Lke/a;)V
    ...
    invoke-virtual {p0}, Lzd/e;->P()Lzd/b;

    move-result-object p0

    const/4 p1, 0x0

    invoke-virtual {p0, p1}, Lzd/b;->z(Z)V
    ...
    iget-object v5, p0, Lzd/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;
    ...
    invoke-virtual {p0, v2, p1}, Lzd/k;->c([BZ)V
    ...
    iget-object v4, p0, Lzd/k;->a:Lzd/e;

    invoke-virtual {v4}, Lzd/e;->M()Lzd/f;

    move-result-object v4

    invoke-virtual {v4}, Lzd/f;->g()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {p1, v4}, Lzd/j;->h(Ljava/lang/String;)V
    ...
    :goto_1
    iget-object p1, p0, Lzd/k;->c:Lfe/a;

    if-eqz p1, :cond_c

    if-eqz v2, :cond_c

    invoke-interface {p1, v2}, Lfe/a;->a([B)Z
    ...
    invoke-static {p1}, Lhe/a;->e(Lhe/l;)Lhe/i;
    ...
    invoke-virtual {v1}, Lzd/f;->g()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lhe/k;->l(Ljava/lang/String;)Lhe/k;
    ...
    invoke-virtual {v0, p1}, Lzd/j;->y(Lhe/i;)V

    iget-object v0, p0, Lzd/k;->a:Lzd/e;

    invoke-virtual {v0}, Lzd/e;->L()Lzd/d;
    ...
    iget-object p0, p0, Lzd/k;->c:Lfe/a;

    invoke-interface {p0}, Lfe/a;->release()V
    ...
    iget-object v2, p0, Lzd/k;->c:Lfe/a;

    invoke-interface {v2}, Lfe/a;->release()V

    iget-object v2, p0, Lzd/k;->c:Lfe/a;

    invoke-interface {v2}, Lfe/a;->init()Z

    :cond_8
    iget-object v2, p0, Lzd/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;

    const-string v4, "SpeechRecognizer.RecognizeStreamFinished"

    if-eqz v2, :cond_a

    iget-object v2, p0, Lzd/k;->e:Ljava/lang/String;
    ...
    invoke-virtual {p0, v1, v3}, Lzd/k;->c([BZ)V
    ...
    invoke-virtual {v1, p1}, Lzd/j;->r(Lhe/f;)V
    ...
    invoke-virtual {p0, v1}, Lzd/e;->D(Ljava/lang/Class;)Lyd/b;
    ...
    invoke-virtual {p0, v1}, Lyd/c;->d(Ljava/lang/String;)V

    :cond_b
    invoke-virtual {v0, p1}, Lcom/xiaomi/ai/core/b;->w(Lhe/f;)Z
