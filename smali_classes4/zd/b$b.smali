...
.method public constructor <init>(Lzd/b;)V
    ...
    iput-object p1, p0, Lzd/b$b;->c:Lzd/b;

    invoke-direct {p0}, Ljava/lang/Thread;-><init>()V

    const/4 p1, 0x0

    iput-boolean p1, p0, Lzd/b$b;->a:Z

    iput-boolean p1, p0, Lzd/b$b;->b:Z

    return-void
.end method

.method public synthetic constructor <init>(Lzd/b;Lzd/b$a;)V
    .locals 0

    invoke-direct {p0, p1}, Lzd/b$b;-><init>(Lzd/b;)V

    return-void
.end method

.method public static synthetic d(Lzd/b$b;)Z
    .locals 0

    invoke-virtual {p0}, Lzd/b$b;->e()Z
...
.method public final a(I)I
    ...
    :cond_1
    iget-object p0, p0, Lzd/b$b;->c:Lzd/b;

    invoke-static {p0}, Lzd/b;->w(Lzd/b;)Lzd/e;
    ...
    invoke-static {p0, v1}, Lle/a;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public declared-synchronized c()Z
    ...
    :try_start_0
    iget-boolean v0, p0, Lzd/b$b;->b:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final e()Z
    ...
    :try_start_0
    iget-boolean v0, p0, Lzd/b$b;->a:Z
...
.method public run()V
    ...
    iget-object v0, p0, Lzd/b$b;->c:Lzd/b;

    invoke-static {v0}, Lzd/b;->w(Lzd/b;)Lzd/e;
    ...
    invoke-static {p0, v1}, Lzd/b;->v(Lzd/b;Lzd/b$b;)Lzd/b$b;

    return-void

    :cond_0
    iget-object v2, p0, Lzd/b$b;->c:Lzd/b;

    invoke-static {v2}, Lzd/b;->w(Lzd/b;)Lzd/e;

    move-result-object v2

    invoke-virtual {v2}, Lzd/e;->Q()I
    ...
    invoke-static {v4, v5}, Lle/a;->e(Ljava/lang/String;Ljava/lang/String;)V

    if-eq v2, v3, :cond_1

    iget-object v3, p0, Lzd/b$b;->c:Lzd/b;

    invoke-virtual {v3, v0, v2}, Lzd/b;->e(Lcom/xiaomi/ai/core/b;I)V
    ...
    invoke-static {v0}, Lzd/b;->A(Lzd/b;)Z
    ...
    :try_start_2
    iput-boolean v0, p0, Lzd/b$b;->a:Z
    ...
    invoke-static {v2}, Lzd/b;->B(Lzd/b;)I

    move-result v2

    invoke-virtual {p0, v2}, Lzd/b$b;->a(I)I
    ...
    invoke-static {v3, v4}, Lle/a;->h(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_5
    iput-boolean v2, p0, Lzd/b$b;->a:Z
    ...
    invoke-static {v3}, Lzd/b;->w(Lzd/b;)Lzd/e;

    move-result-object v3

    invoke-virtual {v3}, Lzd/e;->C()Landroid/content/Context;
    ...
    invoke-virtual {v3}, Lzd/e;->O()Lcom/xiaomi/ai/core/b;
    ...
    iget-object v5, p0, Lzd/b$b;->c:Lzd/b;

    invoke-static {v5}, Lzd/b;->w(Lzd/b;)Lzd/e;

    move-result-object v5

    invoke-virtual {v5}, Lzd/e;->C()Landroid/content/Context;
    ...
    iget-object v4, p0, Lzd/b$b;->c:Lzd/b;

    invoke-static {v4}, Lzd/b;->w(Lzd/b;)Lzd/e;

    move-result-object v4

    invoke-virtual {v4}, Lzd/e;->J()Lcom/xiaomi/ai/core/a;
    ...
    invoke-virtual {v4, v3, v2}, Lzd/b;->e(Lcom/xiaomi/ai/core/b;I)V
    ...
    invoke-virtual {v2}, Lzd/e;->O()Lcom/xiaomi/ai/core/b;
    ...
    invoke-static {v4}, Lzd/b;->C(Lzd/b;)I
    ...
    invoke-static {v2}, Lzd/b;->A(Lzd/b;)Z
    ...
    invoke-virtual {v2}, Lzd/e;->J()Lcom/xiaomi/ai/core/a;
    ...
    :try_start_7
    iput-boolean v0, p0, Lzd/b$b;->b:Z
