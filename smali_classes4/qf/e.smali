...
# virtual methods
.method public a(Lwe/e;Lqf/d;Lcom/xiaomi/engine/TaskSession;)V
    .locals 30
    .param p1    # Lwe/e;
    ...
    new-instance v14, Lwe/e$a;

    invoke-virtual/range {p1 .. p1}, Lwe/e;->q()I

    move-result v9

    invoke-virtual/range {p1 .. p1}, Lwe/e;->z()Z

    move-result v10

    invoke-virtual/range {p1 .. p1}, Lwe/e;->p()Lfm/c;

    move-result-object v11

    const/4 v12, 0x1

    invoke-virtual/range {p1 .. p1}, Lwe/e;->v()Z

    move-result v13

    move-object v8, v14

    invoke-direct/range {v8 .. v13}, Lwe/e$a;-><init>(IZLfm/c;ZZ)V
    ...
    invoke-static {v9, v5}, Lse/e;->b(Ljava/lang/String;I)V
    ...
    check-cast v15, Lwe/e$a;

    invoke-virtual {v15}, Lwe/e$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    sget-object v16, Lkb/jp;->V1:Lkb/kp;

    invoke-virtual/range {v16 .. v16}, Lkb/kp;->b()Ljava/lang/Object;
    ...
    invoke-virtual {v15}, Lwe/e$a;->e()Landroid/media/Image;
    ...
    invoke-static {v9, v10}, Lse/e;->b(Ljava/lang/String;I)V
    ...
    invoke-virtual {v1}, Lwe/e$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-static {v9, v8}, Lse/e;->b(Ljava/lang/String;I)V
    ...
    check-cast v20, Lwe/e$a;

    invoke-virtual/range {v20 .. v20}, Lwe/e$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    sget-object v21, Lkb/jp;->V1:Lkb/kp;

    invoke-virtual/range {v21 .. v21}, Lkb/kp;->b()Ljava/lang/Object;
    ...
    invoke-virtual/range {v20 .. v20}, Lwe/e$a;->k()Landroid/media/Image;
    ...
    invoke-virtual {v0}, Lwe/e$a;->k()Landroid/media/Image;
    ...
    invoke-virtual {v14, v0, v2, v4}, Lwe/e$a;->B(Landroid/media/Image;IZ)V
    ...
    :goto_e
    invoke-virtual {v14, v3, v2}, Lwe/e$a;->x(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
    ...
    invoke-virtual {v1}, Lwe/e$a;->m()Landroid/media/Image;

    move-result-object v0

    const/4 v2, 0x2

    invoke-virtual {v1}, Lwe/e$a;->v()Z

    move-result v3

    invoke-virtual {v14, v0, v2, v3}, Lwe/e$a;->B(Landroid/media/Image;IZ)V
    ...
    invoke-virtual {v14, v0, v2, v2}, Lwe/e$a;->B(Landroid/media/Image;IZ)V
    ...
    invoke-virtual/range {p1 .. p1}, Lwe/e;->g()Lwe/f;
    ...
    :cond_10
    invoke-virtual {v3}, Lwe/e$a;->e()Landroid/media/Image;

    move-result-object v5

    invoke-virtual {v5}, Landroid/media/Image;->close()V

    invoke-interface {v0, v5}, Lwe/f;->b(Landroid/media/Image;)V

    invoke-virtual {v3}, Lwe/e$a;->k()Landroid/media/Image;
    ...
    :cond_11
    invoke-virtual {v3}, Lwe/e$a;->m()Landroid/media/Image;
    ...
    invoke-interface {v0, v3}, Lwe/f;->b(Landroid/media/Image;)V
    ...
    invoke-interface {v0, v2}, Lwe/f;->b(Landroid/media/Image;)V

    invoke-virtual {v1}, Lwe/e$a;->k()Landroid/media/Image;
    ...
    invoke-interface {v0, v1}, Lwe/f;->b(Landroid/media/Image;)V
    ...
    invoke-virtual {v14, v1, v2, v3}, Lwe/e$a;->B(Landroid/media/Image;IZ)V
    ...
    :goto_13
    invoke-virtual {v14}, Lwe/e$a;->o()Z
    ...
    invoke-virtual {v1, v3}, Lwe/e$a;->D(Z)V
    ...
    invoke-virtual {v1, v2, v4, v5}, Lqf/e;->b(Lwe/e;Ljava/util/List;Lqf/d;)V
    ...
    invoke-virtual {v1, v2, v14, v5}, Lqf/e;->c(Lwe/e;Lwe/e$a;Lqf/d;)V
...
.method public final b(Lwe/e;Ljava/util/List;Lqf/d;)V
    .locals 0
    ...
    invoke-virtual {p1, p0}, Lwe/e;->O(Lwe/e$a;)V

    invoke-virtual {p1, p2}, Lwe/e;->I(Ljava/util/List;)V

    invoke-virtual {p1}, Lwe/e;->w()Z

    move-result p0

    xor-int/lit8 p0, p0, 0x1

    invoke-interface {p3, p1, p0}, Lqf/d;->a(Lwe/e;Z)V

    return-void
.end method

.method public final c(Lwe/e;Lwe/e$a;Lqf/d;)V
    .locals 0

    invoke-virtual {p1, p2}, Lwe/e;->O(Lwe/e$a;)V
