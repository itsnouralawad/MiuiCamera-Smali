...
.method public a(Lwe/e;Lqf/d;Lcom/xiaomi/engine/TaskSession;)V
    ...
    invoke-direct/range {v4 .. v9}, Lwe/e$a;-><init>(IZLfm/c;ZZ)V
    ...
    invoke-static {v4, v0}, Lse/e;->b(Ljava/lang/String;I)V
    ...
    invoke-virtual {v7}, Lwe/e$a;->e()Landroid/media/Image;
    ...
    :cond_3
    invoke-static {v4, v10}, Lse/e;->b(Ljava/lang/String;I)V
    ...
    :goto_2
    invoke-virtual {v3, v6, v0, v0}, Lwe/e$a;->B(Landroid/media/Image;IZ)V
    ...
    invoke-interface {v6, v11}, Lwe/f;->b(Landroid/media/Image;)V

    invoke-virtual {v8}, Lwe/e$a;->k()Landroid/media/Image;
    ...
    invoke-interface {v6, v8}, Lwe/f;->b(Landroid/media/Image;)V
    ...
    invoke-interface {v6, v1}, Lwe/f;->b(Landroid/media/Image;)V

    invoke-virtual {v3, v5, v10}, Lwe/e$a;->x(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
    ...
    invoke-virtual {v4}, Lwe/e$a;->m()Landroid/media/Image;

    move-result-object v1

    invoke-virtual {v4}, Lwe/e$a;->v()Z

    move-result v5

    invoke-virtual {v3, v1, v9, v5}, Lwe/e$a;->B(Landroid/media/Image;IZ)V
    ...
    invoke-virtual {v3, v1, v10, v0}, Lwe/e$a;->B(Landroid/media/Image;IZ)V

    :cond_9
    invoke-virtual {v3}, Lwe/e$a;->o()Z
    ...
    invoke-virtual {v1, v4, v3, v5}, Lqf/b;->b(Lwe/e;Lwe/e$a;Lqf/d;)V
...
.method public final b(Lwe/e;Lwe/e$a;Lqf/d;)V
    .locals 0
