...
# instance fields
.field public final synthetic f:Lwf/p;


# direct methods
.method public constructor <init>(Lwf/p;Ljava/lang/String;)V
    .locals 1

    iput-object p1, p0, Lwf/p$b;->f:Lwf/p;

    const-string p1, "10000000-0000-1000-8000-00805f9b34fq"

    const-string v0, "JSON-RPC-SERVICE"

    invoke-direct {p0, p1, v0, p2}, Lxf/c$b;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public onAdvertisingResult(Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;)V
    ...
    iget-object p0, p0, Lwf/p$b;->f:Lwf/p;

    iget-object p0, p0, Lwf/c;->J:Lwf/c$i;

    invoke-virtual {p0, p1}, Lwf/c$i;->f(Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;)V
...
.method public onServiceConnectStatus(ILjava/lang/String;Lcom/xiaomi/idm/bean/EndPoint;Lcom/xiaomi/idm/bean/ConnParam;)Z
    ...
    iget-object p1, p0, Lwf/p$b;->f:Lwf/p;

    invoke-static {p1, p2}, Lwf/p;->D1(Lwf/p;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput p2, p1, Lwf/c;->T:I

    iget-object p0, p0, Lwf/p$b;->f:Lwf/p;

    iget-object p1, p0, Lwf/c;->J:Lwf/c$i;

    invoke-static {p0}, Lwf/p;->C1(Lwf/p;)Ljava/lang/String;

    move-result-object p0

    invoke-virtual {p1, p0, p3, p4}, Lwf/c$i;->d(Ljava/lang/String;Lcom/xiaomi/idm/bean/EndPoint;Lcom/xiaomi/idm/bean/ConnParam;)V
    ...
    invoke-virtual {p0, p2, p3, p4, p1}, Lwf/c$i;->i(Ljava/lang/String;Lcom/xiaomi/idm/bean/EndPoint;Lcom/xiaomi/idm/bean/ConnParam;Lcom/xiaomi/idm/constant/ResponseCode$ConnectCode;)V
